...
const String kanaRegexString = "([\u3040-\u309f]|[\u3040-\u30ff])";
/// Regex that matches any Kana character
final RegExp kanaRegex = RegExp(kanaRegexString);
/// String that can be used for Regex that matches any Kanji character
const String kanjiRegexString = "([\u4e00-\u9faf]|[\u3400-\u4dbf]|々)";
/// Regex that matches any Kanji character
final RegExp kanjiRegex = RegExp(kanjiRegexString);
