...
class DaKanjiDrawerState extends State<DaKanjiDrawer> 
  ...
  List<DrawerEntry> drawerEntries = [
    ...
    DrawerEntry(Icons.text_snippet, LocaleKeys.TextScreen_title.tr(), "/text", Screens.text,
      null, null,
      true, null),
    DrawerEntry(const IconData(0x30AB, fontFamily: "$g_japaneseFontFamily-Black"), LocaleKeys.KanjiTableScreen.tr(), "/kanji_table", Screens.kanji_table,
      null, null,
      true, null),
    DrawerEntry(const IconData(0x30AB, fontFamily: "$g_japaneseFontFamily-Black"), LocaleKeys.KanjiTrainerScreen_title.tr(), "/kanji_trainer", Screens.kanji_trainer,
      null, null,
      true, null),
