...
class _WordListsState extends State<WordLists> {
            ...
            children: [
              Column(
                children: [
                  ...
                  StreamBuilder<List<WordListsSQLData>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<TreeNode<WordListsData>> childrenDFS = currentRoot.dfs().toList();
  ...
  void addNewWordListNode(WordListNodeType nodeType){
    ...
    widget.wordLists.select(widget.wordLists.wordListsSQL).get();

    widget.wordLists.addEntry(newNode);
    //});
