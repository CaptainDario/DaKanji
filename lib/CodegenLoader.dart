...
class CodegenLoader extends AssetLoader{
  ...
  "ManualScreen": {
    "anki_connection_test": "要测试 DaKanji 和 Anki 设置是否正确，请按下面的按钮。",
...
static const Map<String,dynamic> ja = {
  ...
  "ManualScreen": {
    "anki_connection_test": "大漢字と杏樹が正しく設定されているかどうかをテストするには、下のボタンを押してください。",
...
static const Map<String,dynamic> de = {
  ...
  "ManualScreen": {
    "anki_connection_test": "Um zu testen, ob DaKanji und Anki richtig eingestellt sind, drücken Sie auf die Schaltfläche unten.",
...
static const Map<String,dynamic> ru = {
  ...
  "ManualScreen": {
    "anki_connection_test": "Чтобы проверить, правильно ли настроены DaKanji и Anki, нажмите кнопку ниже.",
...
static const Map<String,dynamic> pl = {
  ...
  "ManualScreen": {
    "anki_connection_test": "Aby sprawdzić, czy DaKanji i Anki są poprawnie skonfigurowane, naciśnij poniższy przycisk.",
...
static const Map<String,dynamic> en = {
  ...
  "ManualScreen": {
    "anki_connection_test": "To test if DaKanji and Anki are setup correctly, press the button below.",
...
static const Map<String,dynamic> it = {
  ...
  "ManualScreen": {
    "anki_connection_test": "Per verificare se DaKanji e Anki sono impostati correttamente, premere il pulsante sottostante.",
...
static const Map<String,dynamic> fr = {
  ...
  "ManualScreen": {
    "anki_connection_test": "Pour tester si DaKanji et Anki sont correctement configurés, cliquez sur le bouton ci-dessous.",
...
static const Map<String,dynamic> es = {
  ...
  "ManualScreen": {
    "anki_connection_test": "Para comprobar si DaKanji y Anki están configurados correctamente, pulsa el botón de abajo.",
