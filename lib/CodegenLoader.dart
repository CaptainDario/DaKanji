...
class CodegenLoader extends AssetLoader{
  ...
  "ManualScreen": {
    "anki_connection_test": "要测试 DaKanji 是否能连接到 Anki，请按下面的按钮。",
...
static const Map<String,dynamic> ja = {
  ...
  "ManualScreen": {
    "anki_connection_test": "大漢字が杏樹に届くかをテストするには、下のボタンを押してください。",
    ...
    "anki_setup_ios_text": "AnkiMobileでは、Androidやデスクトップでは可能なノートタイプの追加ができないため、iOSでは下記手順が必要です。設定にはAnkiとDakanjiがインストールされたiOS以外のデバイス(Android/デスクトップ)が必要です。\n\n### 大漢字のノートタイプを取得する(iOS以外のデバイス)\n1. お使いのデバイスの大漢字のセットアップに従ってください。\n2. お使いの端末にAnkiをインストールし、ankiアカウントでサインインします。\n3. 端末のankiに大漢字の辞書項目を1つ送信します。これにより、大漢字のノートタイプが自動的にankiに追加されます。\n4. Ankiをお使いの端末のAnkiWebと同期します。\n\n### AnkiMobileとの連携で大漢字を設定する(iOSデバイス)\n1. AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)をインストールします。\n2. ankiアカウントでログインし、データを同期します。\n3. 大漢字にAnkiMobileとの通信とクリップボードの読み取りを許可してください。",
    "anki_setup_ios_title": "iOS",
    "anki_setup_title": "セットアップ",
    "anki_test_connection": "### 大漢字のノートタイプを取得する(iOS以外のデバイス)",
    "anki_test_connection_fail": "2. お使いの端末にAnkiをインストールし、ankiアカウントでサインインします。",
    "anki_test_connection_success": "1. お使いのデバイスの大漢字のセットアップに従ってください。",
    "anki_title": "Anki",
    ...
    "dict_search_history_delete_text": "3. 大漢字にAnkiMobileとの通信とクリップボードの読み取りを許可してください。",
    "dict_search_history_delete_title": "2. ankiアカウントでログインし、データを同期します。",
    "dict_search_history_title": "1. AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)をインストールします。",
    "dict_search_results_navigate_text": "### AnkiMobileとの連携で大漢字を設定する(iOSデバイス)",
    "dict_search_results_title": "4. Ankiをお使いの端末のAnkiWebと同期します。",
    "dict_text_examples_analyze_text": "辞書の例文は、ダブルタップしてテキスト画面で開くことができます。",
    "dict_text_examples_analyze_title": "テキスト画面で例を開く",
    "dict_title": "3. 端末のankiに大漢字の辞書項目を1つ送信します。これにより、大漢字のノートタイプが自動的にankiに追加されます。",
...
static const Map<String,dynamic> de = {
  ...
  "ManualScreen": {
    "anki_connection_test": "Um zu testen, ob DaKanji Anki erreichen kann, kannst du den untenstehenden Knopf drücken.",
    ...
    "anki_setup_ios_text": "Die Einrichtung auf iOS ist etwas umständlich, da AnkiMobile das Hinzufügen von Notiztypen nicht erlaubt, was auf Android und Desktop möglich ist. Daher müssen Sie ein anderes Nicht-iOS-Gerät (Android/Desktop) mit Anki und DaKanji installiert haben.\n\n### Holen Sie sich den DaKanji-Notiztyp (Nicht-iOS-Gerät)\n1. Folgen Sie den Anweisungen zur Einrichtung von DaKanji auf Ihrem Gerät\n2. Installieren Sie Anki auf Ihrem Gerät und melden Sie sich mit Ihrem Anki-Account an.\n3. Senden Sie einen Wörterbucheintrag von DaKanji an anki auf Ihrem Gerät. Dadurch wird der DaKanji-Notiztyp automatisch zu anki hinzugefügt.\n4. Synchronisiere Anki mit AnkiWeb auf deinem Gerät.\n\n### DaKanji mit AnkiMobile Integration einrichten (iOS Gerät)\n1. Installiere [AnkiMobile] (https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Melde dich mit deinem Anki Konto an und synchronisiere deine Daten\n3. Gib DaKanji die Erlaubnis, mit AnkiMobile zu kommunizieren und deine Zwischenablage zu lesen.",
    "anki_setup_ios_title": "iOS",
    "anki_setup_title": "Einrichtung",
    "anki_test_connection": "### Holen Sie sich den DaKanji-Notiztyp (Nicht-iOS-Gerät)",
    "anki_test_connection_fail": "2. Installieren Sie Anki auf Ihrem Gerät und melden Sie sich mit Ihrem Anki-Account an.",
    "anki_test_connection_success": "1. Folgen Sie den Anweisungen zur Einrichtung von DaKanji auf Ihrem Gerät",
    "anki_title": "Anki",
    ...
    "dict_kanji_search_kanji_group_title": "Übersetzt mit DeepL.com (kostenlose Version)",
    ...
    "dict_search_history_delete_text": "3. Gib DaKanji die Erlaubnis, mit AnkiMobile zu kommunizieren und deine Zwischenablage zu lesen.",
    "dict_search_history_delete_title": "2. Melde dich mit deinem Anki Konto an und synchronisiere deine Daten",
    "dict_search_history_title": "1. Installiere [AnkiMobile] (https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)",
    "dict_search_results_navigate_text": "### DaKanji mit AnkiMobile Integration einrichten (iOS Gerät)",
    "dict_search_results_title": "4. Synchronisiere Anki mit AnkiWeb auf deinem Gerät.",
    ...
    "dict_title": "3. Senden Sie einen Wörterbucheintrag von DaKanji an anki auf Ihrem Gerät. Dadurch wird der DaKanji-Notiztyp automatisch zu anki hinzugefügt.",
...
static const Map<String,dynamic> ru = {
  ...
  "ManualScreen": {
    "anki_connection_test": "Чтобы проверить, может ли DaKanji достичь Anki, нажмите кнопку ниже.",
    ...
    "dict_kanji_search_kanji_group_title": "Переведено с помощью DeepL.com (бесплатная версия)",
    ...
    "dict_search_history_delete_text": "3. В ответ на запрос дайте DaKanji разрешение на связь с AnkiMobile и чтение вашего буфера обмена",
    "dict_search_history_delete_title": "2. Войдите в свой аккаунт Anki и синхронизируйте данные.",
    "dict_search_history_title": "1. Установите [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)",
    "dict_search_results_navigate_text": "### Настройка DaKanji с интеграцией AnkiMobile (устройство iOS)",
    "dict_search_results_title": "4. Синхронизируйте Anki с AnkiWeb на вашем устройстве.",
    ...
    "dict_title": "3. Отправьте одну словарную статью DaKanji в Anki на вашем устройстве. Это автоматически добавит нотный тип DaKanji в anki.",
...
static const Map<String,dynamic> pl = {
  ...
  "ManualScreen": {
    "anki_connection_test": "Aby sprawdzić, czy DaKanji może dotrzeć do Anki, możesz nacisnąć poniższy przycisk.",
