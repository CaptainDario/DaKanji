...
static const Map<String,dynamic> ja = {
  ...
  "ManualScreen": {
    ...
    "anki_title": "Anki",
    "deep_links_text": "ディープリンクは、アプリ内のコンテンツに直接リンクする方法です。大漢字ではdakanji://とhttp(s)://dakanji.app/app。例えば、dakanji://dictionary?search=食べるというリンクをタップすると、辞書検索を開くことができます。すべてのリンクについては[dakanji.app/deep-links](https://dakanji.app/deep-links)をご覧ください。",
    "deep_links_title": "Deep Links",
    ...
    "dict_title": "辞書",
    "dojg_import_text": "日本語文法辞典(DoJG)は、日本語文法に関する書籍のシリーズです。大漢字は、その[Ankiデッキ(ここからダウンロードできます)](https://dojgdeck.neocities.org/)をインポートして、内容を検索することができます。  \n大漢字には、画像付きと画像なしの2つのバージョンがあります。ダウンロードした後、DoJGの画面で.apkgファイルを選択してインポートしてください。",
    "dojg_import_title": "DoJGの設定方法",
    "dojg_title": "DoJG",
    "text_selection_grow_text": "このボタンを押すと、現在のテキストの選択範囲が大きくなります。このボタンを1回押すと、現在の選択範囲が1トークン（単語）分大きくなります。長押しすると、現在の選択範囲が1文字分大きくなります。",
    "text_selection_grow_title": "グロウ・セレクション",
    "text_selection_left_text": "このボタンを押すと、現在選択されているテキストを変更することができます。このボタンを押すと、前のトークン（単語）が選択されます。長押しすると前の文字が選択されます。",
    "text_selection_left_title": "前を選択",
    "text_selection_right_text": "このボタンで現在のテキスト選択を変更できます。このボタンを押すと、次のトークン（単語）が選択されます。長押しすると次の文字が選択されます。",
    "text_selection_right_title": "次を選択",
    "text_selection_shrink_text": "このボタンを押すと、現在の選択テキストを縮小することができます。このボタンを1回押すと、現在の選択範囲が1トークン（単語）分縮小されます。長押しすると、選択範囲が1文字分縮小されます。",
