...
static const Map<String,dynamic> ja = {
  ...
  "ManualScreen": {
    ...
    "anki_setup_android_text": "[AnkidDroid](https://play.google.com/store/apps/details?id=com.ichi2.anki&hl=en&gl=US)をインストールし、大漢字にAnkiとの対話の許可を求めるメッセージが表示されたら、許可する必要があります。",
    "anki_setup_android_title": "アンドロイド",
    "anki_setup_desktop_text": "MacOS、Windows、Linuxでは、[Anki](https://apps.ankiweb.net/)がインストールされ、[AnkiConnect](https://ankiweb.net/shared/info/2055492159)が[インストールおよび実行](https://foosoft.net/projects/anki-connect/)されている必要があります。",
    "anki_setup_desktop_title": "デスクトップ",
    "anki_setup_intro": "大漢字は、Ankiにノートを送信するために使用することができます。そのためには、各プラットフォームで異なる設定が必要です。",
    "anki_setup_ios_text": "iOSでの設定は、Androidと同様に[AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)をインストールし、求められたら大漢字を許可するだけで、超簡単に設定できます。",
    "anki_setup_ios_title": "アイオーエス",
