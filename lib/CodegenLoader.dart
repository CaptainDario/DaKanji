...
static const Map<String,dynamic> ja = {
  ...
  "SettingsScreen": {
    ...
    "dict_deconjugate": "検索内容を基本形に変換する",
    "dict_deconjugate_body": "この設定は、動詞、形容詞、助動詞の「非活用」を有効にします。これが有効になると、DaKanjiは検索語を基本形に変換しようとします。例えば、「食べます」、「食べられる」、「食べない」はすべて「食べる」に変換されます。\n\n中級者には、この設定をオフにすることをお勧めします。",
    "dict_disable_english_info": "辞書の大部分は、英語でしか利用できません。無効にすると、それらの項目がすべて非表示になります。",
    "dict_kanaize": "検索内容をかなに変換する",
    "dict_kanaize_body": "この設定を有効にすると、DaKanjiは検索語を統一された仮名表記に変換してから検索を行います。たとえば、検索語「taberu」は「たべる」に変換され、「食べる」を見つけることができますが、意図しないマッチを引き起こす可能性もあります。\n\n例えば、「man」を検索すると「まん」に変換されるため、「万」や英単語「man」などにマッチすることがあります。\n\n注意: この設定はグローバル設定であり、辞書が使用されるすべての場所に適用されます。",
...
static const Map<String,dynamic> de = {
  ...
  "SettingsScreen": {
    ...
    "dict_add_to_list_from_search_results": "Zur Liste aus Suchergebnissen hinzufügen",
