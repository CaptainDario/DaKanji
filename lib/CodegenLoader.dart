...
class CodegenLoader extends AssetLoader{
  ...
  "ManualScreen": {
    "anki_connection_test_text": "要测试 DaKanji 和 Anki 设置是否正确，请按下面的按钮。",
    ...
    "anki_setup_general_text": "完成平台特定设置后，请按照以下步骤操作。\n\n1.DaKanji 不会向 Anki 添加任何卡组，因此您需要前往设置并选择一个卡组。\n\n恭喜你，你已经完成了，可以开始向 Anki 发送笔记了！",
    "anki_setup_general_title": "一般设置",
    "anki_setup_intro": "DaKanji可以用来向Anki发送笔记。为此，每个平台需要不同的设置。",
    "anki_setup_ios_text": "iOS 上的设置有点麻烦，因为 AnkiMobile 不允许添加注释类型，而在 Android 和桌面上则可以。因此，你需要有另一个安装了 Anki 和 DaKanji 的非 iOS 设备（安卓/桌面）。\n\n### 获取 DaKanji 笔记类型（非 iOS 设备）\n1. 在你的设备上按照 DaKanji 的设置进行操作\n2. 在设备上安装 Anki 并用 Anki 帐户登录\n3. 发送一个 DaKanji 词典条目到你设备上的 Anki。这将自动把 DaKanji 笔记类型添加到 Anki 中。\n4. 在你的设备上同步 Anki 和 AnkiWeb\n\n### 使用 AnkiMobile 整合设置 DaKanji（iOS 设备）\n1. 安装 [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. 用你的 Anki 帐户登录并同步你的数据\n3. 当被要求允许 DaKanji 与 AnkiMobile 通信并读取你的剪贴板时",
...
static const Map<String,dynamic> ja = {
  ...
  "FeedbackScreen": {
    ...
    "feedback_description_text": "問題がありますか？以下に詳細をご入力ください。",
    "navigate": "操作",
    "submit": "送信",
    "title": "フィードバック"
  },
  ...
  "ManualScreen": {
    "anki_connection_test_text": "大漢字と杏樹が正しく設定されているかどうかをテストするには、下のボタンを押してください。",
    "anki_connection_test_title": "テストセットアップ",
    ...
    "anki_setup_general_text": "プラットフォーム固有のセットアップを行った後、以下の手順に従ってください。\n\n1.大漢字はAnkiにデッキを追加しませんので、設定からデッキを選択してください。\n\nこれでAnkiにノートを送信できるようになります！",
    "anki_setup_general_title": "一般設定",
    "anki_setup_intro": "Dakanjiは、Ankiにノートを送信することが可能です。端末によって設定方法が異なりますのでご注意ください。",
    "anki_setup_ios_text": "AnkiMobileでは、Androidやデスクトップでは可能なノートタイプの追加ができないため、iOSでは下記手順が必要です。設定にはAnkiとDakanjiがインストールされたiOS以外のデバイス(Android/デスクトップ)が必要です。\n\n### Dakanjiのノートタイプを取得する(iOS以外の端末)\n1. お使いの端末でDakanjiのAnkiセットアップを行う（マニュアルを参照）\n2. お使いの端末にAnkiをインストールし、サインインする\n3. Dakanjiからお使いの端末のAnkiに辞書にある任意の単語を1つ送信すると、Dakanjiのノートタイプが自動的にankiに追加される\n4. Ankiをお使いの端末のAnkiWebと同期する\n\n### AnkiMobileとDakanjiの接続設定(iOS端末)\n1. iOS端末で[AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)をインストール\n2. 同端末でAnkiアカウントにログインし、データを同期する\n3. DaKanjiでAnkiMobileとの通信およびクリップボードの読み取りを許可",
    ...
    "anki_test_connection_note_type_not_available": "大漢字のノートタイプはAnkiでは使用できません！",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_optimize_latency": "待ち時間 (ms)",
    ...
    "dict_custom_query_format_title": "カスタム画像クエリーフォーマット",
  ...
  "WordListsScreen": {
    ...
    "export_csv_progress": "CSVを作成しています。",
    "export_images": "画像のエクスポート",
    "export_images_progress": "画像をレンダリングしています。",
    "export_pdf": "PDFエクスポート",
    "export_pdf_progress": "PDFを作成しています。",
    "new_folder": "新規フォルダ",
    "new_list": "新規リスト",
    ...
    "send_to_anki_progress": "Ankiに送信中です、少々お待ちください。",
    "title": "単語リスト",
    "tutorial_begin_text": "簡単なチュートリアルをお見せします",
...
static const Map<String,dynamic> de = {
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Um zu testen, ob DaKanji und Anki richtig eingestellt sind, drücken Sie auf die Schaltfläche unten.",
    ...
    "anki_setup_general_text": "Nachdem Sie die plattformspezifische Einrichtung vorgenommen haben, führen Sie bitte die folgenden Schritte aus.\n\n1. DaKanji fügt keine Decks zu Anki hinzu. Daher müssen Sie in den Einstellungen ein Deck auswählen.\n\nHerzlichen Glückwunsch, Sie sind fertig und können anfangen, Notizen an Anki zu senden!",
    ...
    "anki_setup_ios_text": "Die Einrichtung unter iOS ist etwas umständlich, da AnkiMobile das Hinzufügen von Notiztypen nicht erlaubt, was auf Android und Desktop möglich ist. Daher müssen Sie ein anderes Nicht-iOS-Gerät (Android/Desktop) mit Anki und DaKanji installiert haben.\n\n### Holen Sie sich den DaKanji-Notiztyp (Nicht-iOS-Gerät)\n1. Folgen Sie den Anweisungen zur Einrichtung von DaKanji auf Ihrem Gerät\n2. Installieren Sie Anki auf Ihrem Gerät und melden Sie sich mit Ihrem Anki-Konto an.\n3. Senden Sie einen Wörterbucheintrag von DaKanji an Anki auf Ihrem Gerät. Dadurch wird der DaKanji-Notiztyp automatisch zu Anki hinzugefügt.\n4. Synchronisiere Anki mit AnkiWeb auf deinem Gerät.\n\n### DaKanji mit AnkiMobile Integration einrichten (iOS Gerät)\n1. Installiere [AnkiMobile] (https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Melde dich mit deinem Anki Konto an und synchronisiere deine Daten\n3. Wenn du gefragt wirst, erlaube DaKanji, mit AnkiMobile zu kommunizieren und deine Zwischenablage zu lesen",
    "anki_setup_ios_title": "iOS",
...
static const Map<String,dynamic> ru = {
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Чтобы проверить, правильно ли настроены DaKanji и Anki, нажмите кнопку ниже.",
    ...
    "anki_setup_general_text": "После того как вы выполнили настройку платформы, выполните следующие действия.\n\n1. DaKanji не добавляет колоды в Anki, поэтому вам нужно перейти к настройкам и выбрать колоду.\n\nПоздравляем, все готово, и вы можете начать отправлять заметки в Anki!",
    ...
    "anki_setup_ios_text": "Настройка на iOS немного затруднена, так как AnkiMobile не позволяет добавлять типы заметок, что возможно на Android и настольном компьютере. Поэтому вам необходимо иметь другое устройство, не связанное с iOS (Android/десктоп), на котором установлены Anki и DaKanji.\n\n### Получение типа нот DaKanji (устройство без ОС)\n1. Выполните настройку DaKanji на вашем устройстве.\n2. Установите Anki на устройство и войдите в свою учетную запись Anki.\n3. Отправьте одну словарную статью DaKanji в Anki на вашем устройстве. Это автоматически добавит тип заметок DaKanji в Anki.\n4. Синхронизируйте Anki с AnkiWeb на вашем устройстве.\n\n### Настройка DaKanji с интеграцией AnkiMobile (устройство iOS)\n1. Установите [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Войдите в свой аккаунт Anki и синхронизируйте данные.\n3. В ответ на запрос разрешите DaKanji взаимодействовать с AnkiMobile и читать ваш буфер обмена",
    "anki_setup_ios_title": "iOS",
...
static const Map<String,dynamic> pl = {
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Aby sprawdzić, czy DaKanji i Anki są poprawnie skonfigurowane, naciśnij poniższy przycisk.",
    ...
    "anki_setup_general_text": "Po przeprowadzeniu konfiguracji specyficznej dla platformy wykonaj poniższe czynności.\n\n1. DaKanji nie dodaje żadnych talii do Anki, dlatego musisz przejść do ustawień i wybrać talię.\n\nGratulacje, skończyłeś i możesz zacząć wysyłać notatki do Anki!",
    ...
    "anki_setup_ios_text": "Konfiguracja na iOS jest nieco kłopotliwa, ponieważ AnkiMobile nie pozwala na dodawanie typów notatek, co jest możliwe na Androidzie i komputerze. Dlatego musisz mieć inne urządzenie bez systemu iOS (Android/pulpit) z zainstalowaną aplikacją Anki i DaKanji.\n\n### Pobierz typ notatki DaKanji (urządzenie bez systemu iOS)\n1. Postępuj zgodnie z konfiguracją DaKanji na swoim urządzeniu\n2. Zainstaluj aplikację Anki na swoim urządzeniu i zaloguj się na swoje konto Anki.\n3. Wyślij jedno hasło słownikowe DaKanji do Anki na swoim urządzeniu. Spowoduje to automatyczne dodanie typu notatki DaKanji do Anki.\n4. Zsynchronizuj Anki z AnkiWeb na swoim urządzeniu\n\n### Konfiguracja DaKanji z integracją AnkiMobile (urządzenie iOS)\n1. Zainstaluj [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Zaloguj się na swoje konto Anki i zsynchronizuj dane\n3. Po zapytaniu zezwól DaKanji na komunikację z AnkiMobile i odczyt schowka",
    "anki_setup_ios_title": "iOS",
...
static const Map<String,dynamic> en = {
  ...
  "ManualScreen": {
    "anki_connection_test_text": "To test if DaKanji and Anki are setup correctly, press the button below.",
    "anki_connection_test_title": "Test setup",
    ...
    "anki_setup_desktop_title": "Desktop",
    "anki_setup_general_text": "After you have done the platform specific setup, please follow the steps below.\n\n1. DaKanji does not add any decks to Anki therefore, you need to head over to the settings and select a deck.\n\nCongratulations, you are done and you can start sending notes to Anki!",
    ...
    "anki_setup_ios_text": "Setup on iOS is a bit cumbersome as AnkiMobile does not allow adding note types, which is possible on Android and desktop. Therefore you need to have another non-iOS device (Android/desktop) with Anki and DaKanji installed.\n\n### Get the DaKanji note-type (non-iOS device)\n1. Follow the setup of DaKanji on your device\n2. Install Anki on your device and sign in with your Anki account\n3. Send one dictionary entry of DaKanji to Anki on your device. This will automatically add the DaKanji note type to Anki.\n4. Sync Anki with AnkiWeb on your device\n\n### Setup DaKanji with AnkiMobile integration (iOS device)\n1. Install [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Sign in with your Anki account and sync your data\n3. When asked permit DaKanji to communicate with AnkiMobile and to read your clipboard",
    "anki_setup_ios_title": "iOS",
...
static const Map<String,dynamic> it = {
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Per verificare se DaKanji e Anki sono impostati correttamente, premere il pulsante sottostante.",
    ...
    "anki_setup_desktop_title": "Desktop",
    "anki_setup_general_text": "Dopo aver eseguito l'impostazione specifica della piattaforma, seguire i passaggi indicati di seguito.\n\n1. DaKanji non aggiunge alcun mazzo ad Anki, pertanto è necessario andare nelle impostazioni e selezionare un mazzo.\n\nCongratulazioni, avete finito e potete iniziare a inviare note ad Anki!",
    ...
    "anki_setup_ios_text": "L'installazione su iOS è un po' complicata perché AnkiMobile non consente di aggiungere tipi di note, cosa che invece è possibile su Android e desktop. È quindi necessario avere un altro dispositivo non iOS (Android/desktop) con Anki e DaKanji installati.\n\n### Ottenere il tipo di nota DaKanji (dispositivo non iOS)\n1. Seguire l'impostazione di DaKanji sul proprio dispositivo.\n2. Installare Anki sul dispositivo e accedere con il proprio account Anki.\n3. Inviate una voce del dizionario DaKanji ad Anki sul vostro dispositivo. Questo aggiungerà automaticamente il tipo di nota DaKanji ad Anki.\n4. Sincronizzare Anki con AnkiWeb sul dispositivo.\n\n### Impostazione di DaKanji con l'integrazione di AnkiMobile (dispositivo iOS)\n1. Installare [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Accedere con il proprio account Anki e sincronizzare i dati.\n3. Quando vi viene richiesto, permettete a DaKanji di comunicare con AnkiMobile e di leggere i vostri appunti.",
    "anki_setup_ios_title": "iOS",
...
static const Map<String,dynamic> fr = {
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Pour tester si DaKanji et Anki sont correctement configurés, cliquez sur le bouton ci-dessous.",
    ...
    "anki_setup_general_text": "Après avoir effectué la configuration spécifique à la plate-forme, veuillez suivre les étapes ci-dessous.\n\n1. DaKanji n'ajoute pas de jeux à Anki, vous devez donc vous rendre dans les paramètres et sélectionner un jeu.\n\nFélicitations, vous avez terminé et vous pouvez commencer à envoyer des notes à Anki !",
    ...
    "anki_setup_ios_text": "L'installation sur iOS est un peu compliquée car AnkiMobile ne permet pas d'ajouter des types de notes, ce qui est possible sur Android et desktop. Vous devez donc avoir un autre appareil non-iOS (Android/ordinateur) avec Anki et DaKanji installés.\n\n### Obtenir le type de note DaKanji (appareil non-iOS)\n1. Suivez la procédure d'installation de DaKanji sur votre appareil.\n2. Installez Anki sur votre appareil et connectez-vous avec votre compte Anki.\n3. Envoyez une entrée du dictionnaire DaKanji à Anki sur votre appareil. Cela ajoutera automatiquement le type de note DaKanji à Anki.\n4. Synchronisez Anki avec AnkiWeb sur votre appareil.\n\n### Configurer DaKanji avec l'intégration AnkiMobile (appareil iOS)\n1. Installer [AnkiMobile] (https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Connectez-vous avec votre compte Anki et synchronisez vos données.\n3. Lorsque cela vous est demandé, autorisez DaKanji à communiquer avec AnkiMobile et à lire votre presse-papiers.",
    "anki_setup_ios_title": "iOS",
...
static const Map<String,dynamic> es = {
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Para comprobar si DaKanji y Anki están configurados correctamente, pulsa el botón de abajo.",
    ...
    "anki_setup_general_text": "Una vez realizada la configuración específica de la plataforma, siga los pasos que se indican a continuación.\n\n1. DaKanji no añade ningún mazo a Anki, por lo tanto, tienes que ir a la configuración y seleccionar un mazo.\n\n¡Enhorabuena, ya has terminado y puedes empezar a enviar notas a Anki!",
    ...
    "anki_setup_ios_text": "La configuración en iOS es un poco engorrosa ya que AnkiMobile no permite añadir tipos de notas, lo que sí es posible en Android y escritorio. Por lo tanto necesitas tener otro dispositivo que no sea iOS (Android/escritorio) con Anki y DaKanji instalados.\n\n### Obtener el tipo de nota DaKanji (dispositivo no-iOS)\n1. Sigue las instrucciones de configuración de DaKanji en tu dispositivo\n2. Instala Anki en tu dispositivo e inicia sesión con tu cuenta de Anki\n3. Envía una entrada del diccionario de DaKanji a Anki en tu dispositivo. Esto añadirá automáticamente el tipo de nota DaKanji a Anki.\n4. Sincroniza Anki con AnkiWeb en tu dispositivo\n\n### Configurar DaKanji con integración AnkiMobile (dispositivo iOS)\n1. Instalar [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Inicia sesión con tu cuenta Anki y sincroniza tus datos\n3. Cuando se te pida permite a DaKanji comunicarse con AnkiMobile y leer tu portapapeles",
    "anki_setup_ios_title": "iOS",
