...
class CodegenLoader extends AssetLoader{
  ...
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list_no_lists_selected": "未选择快速选择列表。请在设置中进行选择。",
...
static const Map<String,dynamic> ja = {
  ...
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list": "リストに追加",
    "word_tab_menu_quick_add_to_list_no_lists_selected": "クイックセレクトのリストが選択されていません。設定で行ってください。",
    "word_tab_menu_quick_send_to_anki": "Ankiへのクイック送信",
  ...
  "ManualScreen": {
    ...
    "anki_setup_general_text": "プラットフォーム固有の設定が完了したら、新しいカードを追加するAnkiデッキも選択する必要があります。設定 → Ankiで行います。",
    "anki_setup_general_title": "一般設定",
    "anki_setup_intro": "大漢字は、Ankiにノートを送信するために使用することができます。これには、プラットフォームごとに異なる設定が必要です。",
    "anki_setup_ios_text": "AnkiMobileでは、Androidやデスクトップでは可能なノートタイプの追加ができないため、iOSでのセットアップは少々面倒です。そのため、大漢字のノートタイプを持つAnkiデッキをインポートする必要があります（他のデバイスで大漢字からankiにカードをエクスポートしている場合は、この必要はありません）。\n\n1.AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)をインストールする。\n2.こちら](https://github.com/CaptainDario/DaKanji-Dependencies/releases/download/v3.4.0/DaKanji.apkg)から、作成済みの杏樹デッキをダウンロードする。\n3.ダウンロードしたファイルをタップすると、AnkiMobileのインポートダイアログが開きます。\n4.デッキをインポートします。\n5.大漢字がAnkiMobileと通信し、クリップボードを読み取ることを許可してください。",
    ...
    "anki_test_connection_note_type_not_available": "大漢字のノートタイプはAnkiでは利用できません！iOSセットアップガイドに記載されているプレメイドデッキをインポートすることで、手動で追加できます。",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_matrix": "私はマトリックスの中にいる",
    ...
    "word_lists_quick_add_lists": "単語リストの追加",
    "word_lists_readd_defaults": "デフォルトフォルダの追加",
    "word_lists_screensaver_auto_show": "スクリーンセーバー自動起動スクリーンセーバー",
...
static const Map<String,dynamic> de = {
  ...
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list_no_lists_selected": "Es wurden keine Listen für das schnelle hinzuf[gen ausgewählt. Bitte tun Sie dies in den Einstellungen.",
...
static const Map<String,dynamic> ru = {
  ...
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list_no_lists_selected": "Не выбраны списки для быстрого выбора. Пожалуйста, сделайте это в настройках.",
...
static const Map<String,dynamic> pl = {
  ...
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list_no_lists_selected": "Nie wybrano żadnych list do szybkiego wyboru. Należy to zrobić w ustawieniach.",
...
static const Map<String,dynamic> en = {
  ...
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list_no_lists_selected": "No lists for quick select have been selected. Please do so in the settings.",
...
static const Map<String,dynamic> it = {
  ...
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list_no_lists_selected": "Non sono state selezionate liste per la selezione rapida. Si prega di farlo nelle impostazioni.",
...
static const Map<String,dynamic> fr = {
  ...
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list_no_lists_selected": "Aucune liste n'a été sélectionnée pour la sélection rapide. Veuillez le faire dans les paramètres.",
...
static const Map<String,dynamic> es = {
  ...
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list_no_lists_selected": "No se han seleccionado listas para la selección rápida. Por favor, hágalo en los ajustes.",
