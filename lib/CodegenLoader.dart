...
class CodegenLoader extends AssetLoader{
  ...
  "FeedbackScreen": {
    "draw": "绘制",
    "feedback_description_text": "什么是错的（在下面输入你的文字）？",
    "navigate": "导航",
    "submit": "提交",
    "title": "反馈信息"
  },
...
static const Map<String,dynamic> localizations = {
  ...
  "OnBoarding": {
    ...
    "Onboarding_1_text": {
      ...
      "ja": "漢字を書くだけで「DaKanji」があなたの知りたい文字を表示します",
  ...
  "FeedbackScreen": {
    ...
    "feedback_description_text": {
      ...
      "es": "¿Qué ocurre (escriba su texto a continuación)?",
      "pl": "Co jest nie tak (wpisz swój tekst poniżej)?"
    },
    "navigate": {
      "en": "navigate",
      "de": "Navigieren",
  ...
  "TextScreen": {
    ...
    "tutorial_text_input_text": {
      ...
      "ja": "ここに文章を入力してください。かなを振ったり、品詞別に表示したりできます",
...
static const Map<String,dynamic> de = {
  ...
  "FeedbackScreen": {
    "draw": "zeichnen",
    "feedback_description_text": "Was stimmt nicht (schreibe deine Antwort unten)?",
    "navigate": "Navigieren",
    "submit": "Absenden",
    "title": "Feedback"
  },
...
static const Map<String,dynamic> ru = {
  ...
  "FeedbackScreen": {
    "draw": "нарисовать",
    "feedback_description_text": "Что не так (введите свой текст ниже)?",
...
static const Map<String,dynamic> pl = {
  ...
  "FeedbackScreen": {
    "draw": "rysować",
    "feedback_description_text": "Co jest nie tak (wpisz swój tekst poniżej)?",
...
static const Map<String,dynamic> en = {
  ...
  "FeedbackScreen": {
    "draw": "draw",
    "feedback_description_text": "What's wrong? Annotate the view above and then press \"submit\".",
    "navigate": "navigate",
    "submit": "submit",
    "title": "Feedback"
  },
...
static const Map<String,dynamic> it = {
  ...
  "FeedbackScreen": {
    "draw": "sorteggio",
    "feedback_description_text": "Cosa c'è che non va (scrivere il testo qui sotto)?",
    "navigate": "navigare",
    "submit": "Invia",
    "title": "Feedback"
  },
...
static const Map<String,dynamic> fr = {
  ...
  "FeedbackScreen": {
    "draw": "dessiner",
    "feedback_description_text": "Qu'est-ce qui ne va pas (tapez votre texte ci-dessous) ?",
...
static const Map<String,dynamic> es = {
  ...
  "FeedbackScreen": {
    "draw": "dibujar",
    "feedback_description_text": "¿Qué ocurre (escriba su texto a continuación)?",
