...
static const Map<String,dynamic> localizations = {
  ...
  "SettingsScreen": {
    ...
    "dict_disable_english_info": {
      ...
      "ja": "辞書のかなりの部分は、英語でしか利用できません。無効にすると、それらの項目がすべて非表示になります。",
    ...
    "advanced_settings_number_search_procs": {
      ...
      "ja": "検索プロセスの数 (@:SettingsScreen.requires_restart)",
  ...
  "ManualScreen": {
    ...
    "dict_radicals_paste_text": {
      ...
      "ja": "右下の貼り付けボタンを押すと、システムのクリップボードからラジカルを検索し、現在の選択範囲として使用します。",
...
static const Map<String,dynamic> ja = {
  ...
  "DictionaryScreen": {
    ...
    "search_filter_ok": "オッケー",
    "search_radical_close": "閉じる",
    "search_radical_ok": "オッケー",
    ...
    "word_tab_menu_send_to_anki": "杏樹に送る",
  ...
  "ManualScreen": {
    ...
    "dict_kanji_title": "漢字",
    "dict_radicals_paste_text": "右下の貼り付けボタンを押すと、システムのクリップボードからラジカルを検索し、現在の選択範囲として使用します。",
    "dict_radicals_paste_title": "ラジカルの貼り付け",
    "dict_radicals_title": "ラディカルズ",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_number_search_procs": "検索プロセスの数 (@:SettingsScreen.requires_restart)",
    ...
    "dict_disable_english_info": "辞書のかなりの部分は、英語でしか利用できません。無効にすると、それらの項目がすべて非表示になります。",
