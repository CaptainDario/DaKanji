...
/// The kanji character of this entry
 ...
 List<TagBankV3Entry>? get tags;/// The meanings of this entry
 List<String>? get meanings;/// The stats of this entry
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is KanjiBankV3Entry&&(identical(other.kanji, kanji) || other.kanji == kanji)&&const DeepCollectionEquality().equals(other.onyomis, onyomis)&&const DeepCollectionEquality().equals(other.kunyomis, kunyomis)&&const DeepCollectionEquality().equals(other.tags, tags)&&const DeepCollectionEquality().equals(other.meanings, meanings)&&const DeepCollectionEquality().equals(other.stats, stats));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,kanji,const DeepCollectionEquality().hash(onyomis),const DeepCollectionEquality().hash(kunyomis),const DeepCollectionEquality().hash(tags),const DeepCollectionEquality().hash(meanings),const DeepCollectionEquality().hash(stats));
...
@useResult
$Res call({
 String kanji, List<String>? onyomis, List<String>? kunyomis, List<TagBankV3Entry>? tags, List<String>? meanings, List<KanjiBankV3EntryStat>? stats
});
...
/// Create a copy of KanjiBankV3Entry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? kanji = null,Object? onyomis = freezed,Object? kunyomis = freezed,Object? tags = freezed,Object? meanings = freezed,Object? stats = freezed,}) {
...
as List<TagBankV3Entry>?,meanings: freezed == meanings ? _self.meanings : meanings // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String kanji,  List<String>? onyomis,  List<String>? kunyomis,  List<TagBankV3Entry>? tags,  List<String>? meanings,  List<KanjiBankV3EntryStat>? stats)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _KanjiBankV3Entry() when $default != null:
return $default(_that.kanji,_that.onyomis,_that.kunyomis,_that.tags,_that.meanings,_that.stats);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String kanji,  List<String>? onyomis,  List<String>? kunyomis,  List<TagBankV3Entry>? tags,  List<String>? meanings,  List<KanjiBankV3EntryStat>? stats)  $default,) {final _that = this;
switch (_that) {
case _KanjiBankV3Entry():
return $default(_that.kanji,_that.onyomis,_that.kunyomis,_that.tags,_that.meanings,_that.stats);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String kanji,  List<String>? onyomis,  List<String>? kunyomis,  List<TagBankV3Entry>? tags,  List<String>? meanings,  List<KanjiBankV3EntryStat>? stats)?  $default,) {final _that = this;
switch (_that) {
case _KanjiBankV3Entry() when $default != null:
return $default(_that.kanji,_that.onyomis,_that.kunyomis,_that.tags,_that.meanings,_that.stats);case _:
  return null;
...
class _KanjiBankV3Entry implements KanjiBankV3Entry {
  const _KanjiBankV3Entry({required this.kanji, required this.onyomis, required this.kunyomis, required this.tags, required this.meanings, required this.stats});
...
@override final  List<String>? meanings;
...
/// Create a copy of KanjiBankV3Entry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? kanji = null,Object? onyomis = freezed,Object? kunyomis = freezed,Object? tags = freezed,Object? meanings = freezed,Object? stats = freezed,}) {
