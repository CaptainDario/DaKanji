...
class $KanjiBankV3KunyomiReadingRelationsTableTable
    ...
    with
        TableInfo<$KanjiBankV3KunyomiReadingRelationsTableTable,
            KanjiBankV3KunyomiReadingRelationsTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $KanjiBankV3KunyomiReadingRelationsTableTable(this.attachedDatabase,
      [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('PRIMARY KEY AUTOINCREMENT'));
  static const VerificationMeta _kunyomiReadingIdMeta =
      const VerificationMeta('kunyomiReadingId');
  @override
  late final GeneratedColumn<int> kunyomiReadingId = GeneratedColumn<int>(
      'kunyomi_reading_id', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: true,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('REFERENCES reading_table (id)'));
  static const VerificationMeta _kanjiIdMeta =
      const VerificationMeta('kanjiId');
  @override
  late final GeneratedColumn<int> kanjiId = GeneratedColumn<int>(
    ...
    if (data.containsKey('kunyomi_reading_id')) {
      context.handle(
          ...
          kunyomiReadingId.isAcceptableOrUnknown(
              data['kunyomi_reading_id']!, _kunyomiReadingIdMeta));
    } else if (isInserting) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  KanjiBankV3KunyomiReadingRelationsTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return KanjiBankV3KunyomiReadingRelationsTableData(
      ...
      kunyomiReadingId: attachedDatabase.typeMapping.read(
          DriftSqlType.int, data['${effectivePrefix}kunyomi_reading_id'])!,
      kanjiId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}kanji_id'])!,
    );
  }
...
class KanjiBankV3KunyomiReadingRelationsTableData extends DataClass
  ...
  KanjiBankV3KunyomiReadingRelationsTableData copyWith(
          {int? id, int? kunyomiReadingId, int? kanjiId}) =>
      KanjiBankV3KunyomiReadingRelationsTableData(
        id: id ?? this.id,
...
class KanjiBankV3KunyomiReadingRelationsTableCompanion
  ...
  KanjiBankV3KunyomiReadingRelationsTableCompanion copyWith(
      {Value<int>? id, Value<int>? kunyomiReadingId, Value<int>? kanjiId}) {
    return KanjiBankV3KunyomiReadingRelationsTableCompanion(
      id: id ?? this.id,
      kunyomiReadingId: kunyomiReadingId ?? this.kunyomiReadingId,
      kanjiId: kanjiId ?? this.kanjiId,
...
class $KanjiBankV3OnyomiReadingRelationsTableTable
    ...
    with
        TableInfo<$KanjiBankV3OnyomiReadingRelationsTableTable,
            KanjiBankV3OnyomiReadingRelationsTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $KanjiBankV3OnyomiReadingRelationsTableTable(this.attachedDatabase,
      [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('PRIMARY KEY AUTOINCREMENT'));
  static const VerificationMeta _onyomiReadingIdMeta =
      const VerificationMeta('onyomiReadingId');
  @override
  late final GeneratedColumn<int> onyomiReadingId = GeneratedColumn<int>(
      'onyomi_reading_id', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: true,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('REFERENCES reading_table (id)'));
  ...
  late final GeneratedColumn<int> kanjiId = GeneratedColumn<int>(
      ...
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES kanji_bank_v3_table (id)'));
  @override
  List<GeneratedColumn> get $columns => [id, onyomiReadingId, kanjiId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('onyomi_reading_id')) {
      context.handle(
          _onyomiReadingIdMeta,
          onyomiReadingId.isAcceptableOrUnknown(
              data['onyomi_reading_id']!, _onyomiReadingIdMeta));
    } else if (isInserting) {
      context.missing(_onyomiReadingIdMeta);
    }
    if (data.containsKey('kanji_id')) {
      context.handle(_kanjiIdMeta,
          kanjiId.isAcceptableOrUnknown(data['kanji_id']!, _kanjiIdMeta));
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  KanjiBankV3OnyomiReadingRelationsTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return KanjiBankV3OnyomiReadingRelationsTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      onyomiReadingId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}onyomi_reading_id'])!,
      kanjiId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}kanji_id'])!,
    );
  }
...
class KanjiBankV3OnyomiReadingRelationsTableData extends DataClass
  ...
  final int onyomiReadingId;

  /// the id of the associated kanji
  final int kanjiId;
  const KanjiBankV3OnyomiReadingRelationsTableData(
      {required this.id, required this.onyomiReadingId, required this.kanjiId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['onyomi_reading_id'] = Variable<int>(onyomiReadingId);
    map['kanji_id'] = Variable<int>(kanjiId);
    return map;
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'onyomiReadingId': serializer.toJson<int>(onyomiReadingId),
      'kanjiId': serializer.toJson<int>(kanjiId),
    };
  }

  KanjiBankV3OnyomiReadingRelationsTableData copyWith(
          {int? id, int? onyomiReadingId, int? kanjiId}) =>
      KanjiBankV3OnyomiReadingRelationsTableData(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, onyomiReadingId, kanjiId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class KanjiBankV3OnyomiReadingRelationsTableCompanion
  ...
  static Insertable<KanjiBankV3OnyomiReadingRelationsTableData> custom({
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (onyomiReadingId != null) 'onyomi_reading_id': onyomiReadingId,
      if (kanjiId != null) 'kanji_id': kanjiId,
    });
  }

  KanjiBankV3OnyomiReadingRelationsTableCompanion copyWith(
      {Value<int>? id, Value<int>? onyomiReadingId, Value<int>? kanjiId}) {
    return KanjiBankV3OnyomiReadingRelationsTableCompanion(
      id: id ?? this.id,
      onyomiReadingId: onyomiReadingId ?? this.onyomiReadingId,
      kanjiId: kanjiId ?? this.kanjiId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (onyomiReadingId.present) {
      map['onyomi_reading_id'] = Variable<int>(onyomiReadingId.value);
    }
    if (kanjiId.present) {
      map['kanji_id'] = Variable<int>(kanjiId.value);
    }
...
class $TermMetaBankV3TableTable extends TermMetaBankV3Table
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, dictId, termId, readingId, typeId, freqValue, freqDisplayValue];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $TermBankV3DefinitionTagsTableTable extends TermBankV3DefinitionTagsTable
    with
        TableInfo<$TermBankV3DefinitionTagsTableTable,
  ...
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
      type: DriftSqlType.int, requiredDuringInsert: false);
  static const VerificationMeta _definitionTagMeta =
      const VerificationMeta('definitionTag');
  @override
  late final GeneratedColumn<String> definitionTag = GeneratedColumn<String>(
      'definition_tag', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  @override
    ...
    if (data.containsKey('definition_tag')) {
      context.handle(
          ...
          definitionTag.isAcceptableOrUnknown(
              data['definition_tag']!, _definitionTagMeta));
    } else if (isInserting) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermBankV3DefinitionTagsTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TermBankV3DefinitionTagsTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      definitionTag: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}definition_tag'])!,
    );
  }
...
class TermBankV3DefinitionTagsTableData extends DataClass
  ...
  const TermBankV3DefinitionTagsTableData(
      {required this.id, required this.definitionTag});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  factory TermBankV3DefinitionTagsTableData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TermBankV3DefinitionTagsTableData(
      id: serializer.fromJson<int>(json['id']),
...
class TermBankV3DefinitionTagsTableCompanion
  ...
  TermBankV3DefinitionTagsTableCompanion copyWith(
      {Value<int>? id, Value<String>? definitionTag}) {
    return TermBankV3DefinitionTagsTableCompanion(
      id: id ?? this.id,
      definitionTag: definitionTag ?? this.definitionTag,
    );
...
class $TermBankV3TableTable extends TermBankV3Table
    with TableInfo<$TermBankV3TableTable, TermBankV3TableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TermBankV3TableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, termId, readingId, popularity, sequenceNumber];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'term_bank_v3_table';
  @override
  VerificationContext validateIntegrity(
      Insertable<TermBankV3TableData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermBankV3TableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class TermBankV3TableData extends DataClass
    implements Insertable<TermBankV3TableData> {
  /// id of this entry
  final int id;
  ...
  TermBankV3TableCompanion toCompanion(bool nullToAbsent) {
  ...
  factory TermBankV3TableData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TermBankV3TableData(
      id: serializer.fromJson<int>(json['id']),
  ...
  TermBankV3TableData copyWithCompanion(TermBankV3TableCompanion data) {
    return TermBankV3TableData(
      id: data.id.present ? data.id.value : this.id,
      termId: data.termId.present ? data.termId.value : this.termId,
      readingId: data.readingId.present ? data.readingId.value : this.readingId,
...
class $TermBankV3DefinitionTagRelationsTableTable
    ...
    with
        TableInfo<$TermBankV3DefinitionTagRelationsTableTable,
            TermBankV3DefinitionTagRelationsTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TermBankV3DefinitionTagRelationsTableTable(this.attachedDatabase,
      [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('PRIMARY KEY AUTOINCREMENT'));
  static const VerificationMeta _definitionTagIdMeta =
      const VerificationMeta('definitionTagId');
  @override
  late final GeneratedColumn<int> definitionTagId = GeneratedColumn<int>(
      'definition_tag_id', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: true,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
  ...
  @override
  List<GeneratedColumn> get $columns => [id, definitionTagId, termId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('definition_tag_id')) {
      context.handle(
          _definitionTagIdMeta,
          definitionTagId.isAcceptableOrUnknown(
              data['definition_tag_id']!, _definitionTagIdMeta));
    } else if (isInserting) {
      context.missing(_definitionTagIdMeta);
    }
    if (data.containsKey('term_id')) {
      context.handle(_termIdMeta,
          termId.isAcceptableOrUnknown(data['term_id']!, _termIdMeta));
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermBankV3DefinitionTagRelationsTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TermBankV3DefinitionTagRelationsTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      definitionTagId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}definition_tag_id'])!,
      termId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}term_id'])!,
    );
  }
...
class TermBankV3DefinitionTagRelationsTableData extends DataClass
  ...
  final int definitionTagId;

  /// the id of the associated term
  final int termId;
  const TermBankV3DefinitionTagRelationsTableData(
      {required this.id, required this.definitionTagId, required this.termId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['definition_tag_id'] = Variable<int>(definitionTagId);
    map['term_id'] = Variable<int>(termId);
    return map;
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'definitionTagId': serializer.toJson<int>(definitionTagId),
      'termId': serializer.toJson<int>(termId),
    };
  }

  TermBankV3DefinitionTagRelationsTableData copyWith(
          {int? id, int? definitionTagId, int? termId}) =>
      TermBankV3DefinitionTagRelationsTableData(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, definitionTagId, termId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class TermBankV3DefinitionTagRelationsTableCompanion
  ...
  static Insertable<TermBankV3DefinitionTagRelationsTableData> custom({
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (definitionTagId != null) 'definition_tag_id': definitionTagId,
      if (termId != null) 'term_id': termId,
    });
  }

  TermBankV3DefinitionTagRelationsTableCompanion copyWith(
      {Value<int>? id, Value<int>? definitionTagId, Value<int>? termId}) {
    return TermBankV3DefinitionTagRelationsTableCompanion(
      id: id ?? this.id,
      definitionTagId: definitionTagId ?? this.definitionTagId,
      termId: termId ?? this.termId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (definitionTagId.present) {
      map['definition_tag_id'] = Variable<int>(definitionTagId.value);
    }
    if (termId.present) {
      map['term_id'] = Variable<int>(termId.value);
    }
...
class $TermBankV3RuleIdentifierTableTable extends TermBankV3RuleIdentifierTable
    with
        TableInfo<$TermBankV3RuleIdentifierTableTable,
  ...
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
      type: DriftSqlType.int, requiredDuringInsert: false);
  static const VerificationMeta _ruleIdentifierMeta =
      const VerificationMeta('ruleIdentifier');
  @override
  late final GeneratedColumn<String> ruleIdentifier = GeneratedColumn<String>(
      'rule_identifier', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  @override
    ...
    if (data.containsKey('rule_identifier')) {
      context.handle(
          ...
          ruleIdentifier.isAcceptableOrUnknown(
              data['rule_identifier']!, _ruleIdentifierMeta));
    } else if (isInserting) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermBankV3RuleIdentifierTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TermBankV3RuleIdentifierTableData(
      ...
      ruleIdentifier: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}rule_identifier'])!,
    );
  }
...
class TermBankV3RuleIdentifierTableData extends DataClass
  ...
  const TermBankV3RuleIdentifierTableData(
      {required this.id, required this.ruleIdentifier});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  factory TermBankV3RuleIdentifierTableData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TermBankV3RuleIdentifierTableData(
      id: serializer.fromJson<int>(json['id']),
...
class TermBankV3RuleIdentifierTableCompanion
  ...
  TermBankV3RuleIdentifierTableCompanion copyWith(
      {Value<int>? id, Value<String>? ruleIdentifier}) {
    return TermBankV3RuleIdentifierTableCompanion(
      id: id ?? this.id,
      ruleIdentifier: ruleIdentifier ?? this.ruleIdentifier,
    );
...
class $TermBankV3RuleIdentifiersRelationsTableTable
    extends TermBankV3RuleIdentifiersRelationsTable
    with
        TableInfo<$TermBankV3RuleIdentifiersRelationsTableTable,
            TermBankV3RuleIdentifiersRelationsTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TermBankV3RuleIdentifiersRelationsTableTable(this.attachedDatabase,
      [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('PRIMARY KEY AUTOINCREMENT'));
  static const VerificationMeta _ruleIdentifierIdMeta =
      const VerificationMeta('ruleIdentifierId');
  @override
  late final GeneratedColumn<int> ruleIdentifierId = GeneratedColumn<int>(
      'rule_identifier_id', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: true,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
  ...
  late final GeneratedColumn<int> termId = GeneratedColumn<int>(
      ...
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES term_bank_v3_table (id)'));
  @override
  List<GeneratedColumn> get $columns => [id, ruleIdentifierId, termId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'term_bank_v3_rule_identifiers_relations_table';
  @override
  VerificationContext validateIntegrity(
      Insertable<TermBankV3RuleIdentifiersRelationsTableData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
    ...
    if (data.containsKey('rule_identifier_id')) {
      context.handle(
          ...
          ruleIdentifierId.isAcceptableOrUnknown(
              data['rule_identifier_id']!, _ruleIdentifierIdMeta));
    } else if (isInserting) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermBankV3RuleIdentifiersRelationsTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TermBankV3RuleIdentifiersRelationsTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      ruleIdentifierId: attachedDatabase.typeMapping.read(
          DriftSqlType.int, data['${effectivePrefix}rule_identifier_id'])!,
      termId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}term_id'])!,
    );
  }
  ...
  @override
  $TermBankV3RuleIdentifiersRelationsTableTable createAlias(String alias) {
    return $TermBankV3RuleIdentifiersRelationsTableTable(
        attachedDatabase, alias);
  }
}

class TermBankV3RuleIdentifiersRelationsTableData extends DataClass
    implements Insertable<TermBankV3RuleIdentifiersRelationsTableData> {
  /// id of this relation
  final int id;
  ...
  /// the id of the associated term
  final int termId;
  const TermBankV3RuleIdentifiersRelationsTableData(
      {required this.id, required this.ruleIdentifierId, required this.termId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  TermBankV3RuleIdentifiersRelationsTableCompanion toCompanion(
      bool nullToAbsent) {
    return TermBankV3RuleIdentifiersRelationsTableCompanion(
      id: Value(id),
  ...
  factory TermBankV3RuleIdentifiersRelationsTableData.fromJson(
      Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TermBankV3RuleIdentifiersRelationsTableData(
  ...
  TermBankV3RuleIdentifiersRelationsTableData copyWith(
          {int? id, int? ruleIdentifierId, int? termId}) =>
      TermBankV3RuleIdentifiersRelationsTableData(
        id: id ?? this.id,
        ruleIdentifierId: ruleIdentifierId ?? this.ruleIdentifierId,
        termId: termId ?? this.termId,
      );
  TermBankV3RuleIdentifiersRelationsTableData copyWithCompanion(
      TermBankV3RuleIdentifiersRelationsTableCompanion data) {
    return TermBankV3RuleIdentifiersRelationsTableData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('TermBankV3RuleIdentifiersRelationsTableData(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode => Object.hash(id, ruleIdentifierId, termId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TermBankV3RuleIdentifiersRelationsTableData &&
          other.id == this.id &&
          other.ruleIdentifierId == this.ruleIdentifierId &&
          other.termId == this.termId);
}

class TermBankV3RuleIdentifiersRelationsTableCompanion
    extends UpdateCompanion<TermBankV3RuleIdentifiersRelationsTableData> {
  final Value<int> id;
  final Value<int> ruleIdentifierId;
  final Value<int> termId;
  const TermBankV3RuleIdentifiersRelationsTableCompanion({
    this.id = const Value.absent(),
    this.ruleIdentifierId = const Value.absent(),
    this.termId = const Value.absent(),
  });
  TermBankV3RuleIdentifiersRelationsTableCompanion.insert({
    this.id = const Value.absent(),
    required int ruleIdentifierId,
    required int termId,
  })  : ruleIdentifierId = Value(ruleIdentifierId),
        termId = Value(termId);
  static Insertable<TermBankV3RuleIdentifiersRelationsTableData> custom({
    Expression<int>? id,
  ...
  TermBankV3RuleIdentifiersRelationsTableCompanion copyWith(
      {Value<int>? id, Value<int>? ruleIdentifierId, Value<int>? termId}) {
    return TermBankV3RuleIdentifiersRelationsTableCompanion(
      id: id ?? this.id,
      ruleIdentifierId: ruleIdentifierId ?? this.ruleIdentifierId,
      termId: termId ?? this.termId,
  ...
  @override
  String toString() {
    return (StringBuffer('TermBankV3RuleIdentifiersRelationsTableCompanion(')
          ..write('id: $id, ')
          ..write('ruleIdentifierId: $ruleIdentifierId, ')
          ..write('termId: $termId')
          ..write(')'))
...
class $TermBankV3TagBankRelationsTableTable
    ...
    with
        TableInfo<$TermBankV3TagBankRelationsTableTable,
  ...
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('PRIMARY KEY AUTOINCREMENT'));
  static const VerificationMeta _tagBankIdMeta =
      const VerificationMeta('tagBankId');
  @override
  late final GeneratedColumn<int> tagBankId = GeneratedColumn<int>(
      'tag_bank_id', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: true,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES tag_bank_v3_table (id)'));
  ...
  late final GeneratedColumn<int> termId = GeneratedColumn<int>(
      ...
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES term_bank_v3_table (id)'));
  @override
  List<GeneratedColumn> get $columns => [id, tagBankId, termId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('tag_bank_id')) {
      context.handle(
          _tagBankIdMeta,
          tagBankId.isAcceptableOrUnknown(
              data['tag_bank_id']!, _tagBankIdMeta));
    } else if (isInserting) {
      context.missing(_tagBankIdMeta);
    }
    if (data.containsKey('term_id')) {
      context.handle(_termIdMeta,
          termId.isAcceptableOrUnknown(data['term_id']!, _termIdMeta));
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermBankV3TagBankRelationsTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TermBankV3TagBankRelationsTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      tagBankId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}tag_bank_id'])!,
      termId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}term_id'])!,
    );
  }
...
class TermBankV3TagBankRelationsTableData extends DataClass
  ...
  const TermBankV3TagBankRelationsTableData(
      {required this.id, required this.tagBankId, required this.termId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['tag_bank_id'] = Variable<int>(tagBankId);
    map['term_id'] = Variable<int>(termId);
    return map;
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'tagBankId': serializer.toJson<int>(tagBankId),
      'termId': serializer.toJson<int>(termId),
    };
  }

  TermBankV3TagBankRelationsTableData copyWith(
          {int? id, int? tagBankId, int? termId}) =>
      TermBankV3TagBankRelationsTableData(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, tagBankId, termId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class TermBankV3TagBankRelationsTableCompanion
  ...
  static Insertable<TermBankV3TagBankRelationsTableData> custom({
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (tagBankId != null) 'tag_bank_id': tagBankId,
      if (termId != null) 'term_id': termId,
    });
  }

  TermBankV3TagBankRelationsTableCompanion copyWith(
      {Value<int>? id, Value<int>? tagBankId, Value<int>? termId}) {
    return TermBankV3TagBankRelationsTableCompanion(
      id: id ?? this.id,
      tagBankId: tagBankId ?? this.tagBankId,
      termId: termId ?? this.termId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (tagBankId.present) {
      map['tag_bank_id'] = Variable<int>(tagBankId.value);
    }
    if (termId.present) {
      map['term_id'] = Variable<int>(termId.value);
    }
...
class TermMetaBankV3PitchTableData extends DataClass
  ...
  const TermMetaBankV3PitchTableData(
      {required this.id, required this.position, this.nasal, this.devoice});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
...
class $TermMetaBankV3PitchRelationsTableTable
    ...
    with
        TableInfo<$TermMetaBankV3PitchRelationsTableTable,
  ...
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('PRIMARY KEY AUTOINCREMENT'));
  static const VerificationMeta _pitchIdMeta =
      const VerificationMeta('pitchId');
  @override
  late final GeneratedColumn<int> pitchId = GeneratedColumn<int>(
      'pitch_id', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: true,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES term_meta_bank_v3_pitch_table (id)'));
  static const VerificationMeta _termMetaIdMeta =
      const VerificationMeta('termMetaId');
  @override
  late final GeneratedColumn<int> termMetaId = GeneratedColumn<int>(
      'term_meta_id', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: true,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES term_meta_bank_v3_table (id)'));
  @override
  List<GeneratedColumn> get $columns => [id, pitchId, termMetaId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('pitch_id')) {
      context.handle(_pitchIdMeta,
          pitchId.isAcceptableOrUnknown(data['pitch_id']!, _pitchIdMeta));
    } else if (isInserting) {
      context.missing(_pitchIdMeta);
    }
    if (data.containsKey('term_meta_id')) {
      context.handle(
          _termMetaIdMeta,
          termMetaId.isAcceptableOrUnknown(
              data['term_meta_id']!, _termMetaIdMeta));
    } else if (isInserting) {
      context.missing(_termMetaIdMeta);
    }
    return context;
  }
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermMetaBankV3PitchRelationsTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TermMetaBankV3PitchRelationsTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      pitchId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}pitch_id'])!,
      termMetaId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}term_meta_id'])!,
    );
  }
...
class TermMetaBankV3PitchRelationsTableData extends DataClass
  ...
  const TermMetaBankV3PitchRelationsTableData(
      {required this.id, required this.pitchId, required this.termMetaId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['pitch_id'] = Variable<int>(pitchId);
    map['term_meta_id'] = Variable<int>(termMetaId);
    return map;
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'pitchId': serializer.toJson<int>(pitchId),
      'termMetaId': serializer.toJson<int>(termMetaId),
    };
  }

  TermMetaBankV3PitchRelationsTableData copyWith(
          {int? id, int? pitchId, int? termMetaId}) =>
      TermMetaBankV3PitchRelationsTableData(
        id: id ?? this.id,
  ...
  TermMetaBankV3PitchRelationsTableData copyWithCompanion(
    ...
    return TermMetaBankV3PitchRelationsTableData(
      ...
      termMetaId:
          data.termMetaId.present ? data.termMetaId.value : this.termMetaId,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(id, pitchId, termMetaId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class TermMetaBankV3PitchRelationsTableCompanion
  ...
  static Insertable<TermMetaBankV3PitchRelationsTableData> custom({
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (pitchId != null) 'pitch_id': pitchId,
      if (termMetaId != null) 'term_meta_id': termMetaId,
    });
  }

  TermMetaBankV3PitchRelationsTableCompanion copyWith(
      {Value<int>? id, Value<int>? pitchId, Value<int>? termMetaId}) {
    return TermMetaBankV3PitchRelationsTableCompanion(
      id: id ?? this.id,
      pitchId: pitchId ?? this.pitchId,
      termMetaId: termMetaId ?? this.termMetaId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (pitchId.present) {
      map['pitch_id'] = Variable<int>(pitchId.value);
    }
    if (termMetaId.present) {
      map['term_meta_id'] = Variable<int>(termMetaId.value);
    }
    return map;
  }
...
class $TermMetaBankV3TagTableTable extends TermMetaBankV3TagTable
    with TableInfo<$TermMetaBankV3TagTableTable, TermMetaBankV3TagTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TermMetaBankV3TagTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'term_meta_bank_v3_tag_table';
  @override
  VerificationContext validateIntegrity(
      Insertable<TermMetaBankV3TagTableData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermMetaBankV3TagTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TermMetaBankV3TagTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
  ...
  @override
  $TermMetaBankV3TagTableTable createAlias(String alias) {
    return $TermMetaBankV3TagTableTable(attachedDatabase, alias);
  }
}

class TermMetaBankV3TagTableData extends DataClass
    implements Insertable<TermMetaBankV3TagTableData> {
  /// id of this entry
  final int id;

  /// The tag of this table transcription
  final String tag;
  const TermMetaBankV3TagTableData({required this.id, required this.tag});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  TermMetaBankV3TagTableCompanion toCompanion(bool nullToAbsent) {
    return TermMetaBankV3TagTableCompanion(
      id: Value(id),
      tag: Value(tag),
    );
  }

  factory TermMetaBankV3TagTableData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TermMetaBankV3TagTableData(
      id: serializer.fromJson<int>(json['id']),
  ...
  TermMetaBankV3TagTableData copyWith({int? id, String? tag}) =>
      TermMetaBankV3TagTableData(
        id: id ?? this.id,
        tag: tag ?? this.tag,
      );
  TermMetaBankV3TagTableData copyWithCompanion(
      TermMetaBankV3TagTableCompanion data) {
    return TermMetaBankV3TagTableData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('TermMetaBankV3TagTableData(')
          ..write('id: $id, ')
          ..write('tag: $tag')
          ..write(')'))
        .toString();
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TermMetaBankV3TagTableData &&
          other.id == this.id &&
          other.tag == this.tag);
}

class TermMetaBankV3TagTableCompanion
    extends UpdateCompanion<TermMetaBankV3TagTableData> {
  final Value<int> id;
  final Value<String> tag;
  const TermMetaBankV3TagTableCompanion({
    this.id = const Value.absent(),
    this.tag = const Value.absent(),
  });
  TermMetaBankV3TagTableCompanion.insert({
    this.id = const Value.absent(),
    required String tag,
  }) : tag = Value(tag);
  static Insertable<TermMetaBankV3TagTableData> custom({
    Expression<int>? id,
  ...
  TermMetaBankV3TagTableCompanion copyWith(
  ...
  @override
  String toString() {
    return (StringBuffer('TermMetaBankV3TagTableCompanion(')
          ..write('id: $id, ')
          ..write('tag: $tag')
          ..write(')'))
        .toString();
...
class $TermMetaBankV3PitchTagRelationsTableTable
    ...
    with
        TableInfo<$TermMetaBankV3PitchTagRelationsTableTable,
            TermMetaBankV3PitchTagRelationsTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TermMetaBankV3PitchTagRelationsTableTable(this.attachedDatabase,
      [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> tagId = GeneratedColumn<int>(
      ...
      requiredDuringInsert: true,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES term_meta_bank_v3_tag_table (id)'));
  @override
  List<GeneratedColumn> get $columns => [id, pitchId, tagId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermMetaBankV3PitchTagRelationsTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class TermMetaBankV3PitchTagRelationsTableData extends DataClass
  ...
  const TermMetaBankV3PitchTagRelationsTableData(
      {required this.id, required this.pitchId, required this.tagId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  @override
  int get hashCode => Object.hash(id, pitchId, tagId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class TermMetaBankV3PitchTagRelationsTableCompanion
  ...
  TermMetaBankV3PitchTagRelationsTableCompanion copyWith(
      {Value<int>? id, Value<int>? pitchId, Value<int>? tagId}) {
    return TermMetaBankV3PitchTagRelationsTableCompanion(
      id: id ?? this.id,
      pitchId: pitchId ?? this.pitchId,
      tagId: tagId ?? this.tagId,
...
class $TermMetaBankV3IpaRelationsTableTable
    ...
    with
        TableInfo<$TermMetaBankV3IpaRelationsTableTable,
  ...
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('PRIMARY KEY AUTOINCREMENT'));
  static const VerificationMeta _ipaIdMeta = const VerificationMeta('ipaId');
  @override
  late final GeneratedColumn<int> ipaId = GeneratedColumn<int>(
      'ipa_id', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: true,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
  ...
  late final GeneratedColumn<int> termMetaId = GeneratedColumn<int>(
      ...
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES term_meta_bank_v3_table (id)'));
  @override
  List<GeneratedColumn> get $columns => [id, ipaId, termMetaId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('ipa_id')) {
      context.handle(
          _ipaIdMeta, ipaId.isAcceptableOrUnknown(data['ipa_id']!, _ipaIdMeta));
    } else if (isInserting) {
      context.missing(_ipaIdMeta);
    }
    if (data.containsKey('term_meta_id')) {
      context.handle(
          _termMetaIdMeta,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermMetaBankV3IpaRelationsTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TermMetaBankV3IpaRelationsTableData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      ipaId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}ipa_id'])!,
      termMetaId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}term_meta_id'])!,
    );
  }
...
class TermMetaBankV3IpaRelationsTableData extends DataClass
  ...
  const TermMetaBankV3IpaRelationsTableData(
      {required this.id, required this.ipaId, required this.termMetaId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['ipa_id'] = Variable<int>(ipaId);
    map['term_meta_id'] = Variable<int>(termMetaId);
    return map;
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'ipaId': serializer.toJson<int>(ipaId),
      'termMetaId': serializer.toJson<int>(termMetaId),
    };
  }

  TermMetaBankV3IpaRelationsTableData copyWith(
          {int? id, int? ipaId, int? termMetaId}) =>
      TermMetaBankV3IpaRelationsTableData(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, ipaId, termMetaId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class TermMetaBankV3IpaRelationsTableCompanion
  ...
  static Insertable<TermMetaBankV3IpaRelationsTableData> custom({
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (ipaId != null) 'ipa_id': ipaId,
      if (termMetaId != null) 'term_meta_id': termMetaId,
    });
  }

  TermMetaBankV3IpaRelationsTableCompanion copyWith(
      {Value<int>? id, Value<int>? ipaId, Value<int>? termMetaId}) {
    return TermMetaBankV3IpaRelationsTableCompanion(
      id: id ?? this.id,
      ipaId: ipaId ?? this.ipaId,
      termMetaId: termMetaId ?? this.termMetaId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (ipaId.present) {
      map['ipa_id'] = Variable<int>(ipaId.value);
    }
    if (termMetaId.present) {
      map['term_meta_id'] = Variable<int>(termMetaId.value);
    }
...
class $TermMetaBankV3IpaTagRelationsTableTable
    ...
    with
        TableInfo<$TermMetaBankV3IpaTagRelationsTableTable,
            TermMetaBankV3IpaTagRelationsTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TermMetaBankV3IpaTagRelationsTableTable(this.attachedDatabase,
      [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> tagId = GeneratedColumn<int>(
      ...
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'REFERENCES term_meta_bank_v3_tag_table (id)'));
  @override
  List<GeneratedColumn> get $columns => [id, ipaId, tagId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TermMetaBankV3IpaTagRelationsTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class TermMetaBankV3IpaTagRelationsTableData extends DataClass
  ...
  const TermMetaBankV3IpaTagRelationsTableData(
      {required this.id, required this.ipaId, required this.tagId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  @override
  int get hashCode => Object.hash(id, ipaId, tagId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class TermMetaBankV3IpaTagRelationsTableCompanion
  ...
  TermMetaBankV3IpaTagRelationsTableCompanion copyWith(
      {Value<int>? id, Value<int>? ipaId, Value<int>? tagId}) {
    return TermMetaBankV3IpaTagRelationsTableCompanion(
      id: id ?? this.id,
      ipaId: ipaId ?? this.ipaId,
      tagId: tagId ?? this.tagId,
...
abstract class _$DaKanjiDB extends GeneratedDatabase {
  ...
  late final $TermBankV3TableTable termBankV3Table =
      $TermBankV3TableTable(this);
  ...
  late final $TermBankV3RuleIdentifiersRelationsTableTable
      termBankV3RuleIdentifiersRelationsTable =
      $TermBankV3RuleIdentifiersRelationsTableTable(this);
  late final $TermBankV3TagBankRelationsTableTable
      termBankV3TagBankRelationsTable =
      $TermBankV3TagBankRelationsTableTable(this);
  ...
  late final $TermMetaBankV3PitchRelationsTableTable
      ...
      $TermMetaBankV3PitchRelationsTableTable(this);
  ...
  late final $TermMetaBankV3IpaRelationsTableTable
      ...
      $TermMetaBankV3IpaRelationsTableTable(this);
...
final class $$KanjiTableTableReferences
      ...
      _radicalKanjiRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.radicalKanjiRelationsTable,
              aliasName: $_aliasNameGenerator(
                  db.kanjiTable.id, db.radicalKanjiRelationsTable.kanjiId));
  ...
  static MultiTypedResultKey<$KanjiMetaBankV3TableTable,
      ...
      MultiTypedResultKey.fromTable(db.kanjiMetaBankV3Table,
          aliasName: $_aliasNameGenerator(
              db.kanjiTable.id, db.kanjiMetaBankV3Table.kanjiId));
...
final class $$TermTableTableReferences
  ...
  static MultiTypedResultKey<$TermMetaBankV3TableTable,
      ...
      MultiTypedResultKey.fromTable(db.termMetaBankV3Table,
          aliasName: $_aliasNameGenerator(
              db.termTable.id, db.termMetaBankV3Table.termId));
  ...
  static MultiTypedResultKey<$TermBankV3TableTable, List<TermBankV3TableData>>
      _termBankV3TableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termBankV3Table,
              aliasName: $_aliasNameGenerator(
                  db.termTable.id, db.termBankV3Table.termId));
...
class $$TermTableTableTableManager extends RootTableManager<
    ...
    TermTableData,
    PrefetchHooks Function(
        {bool termMetaBankV3TableRefs, bool termBankV3TableRefs})> {
  $$TermTableTableTableManager(_$DaKanjiDB db, $TermTableTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$TermTableTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
              {termMetaBankV3TableRefs = false, termBankV3TableRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
...
final class $$ReadingTableTableReferences
  ...
  static MultiTypedResultKey<$KanjiBankV3KunyomiReadingRelationsTableTable,
      ...
      _kanjiBankV3KunyomiReadingRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(
              ...
              aliasName: $_aliasNameGenerator(db.readingTable.id,
  ...
  static MultiTypedResultKey<$KanjiBankV3OnyomiReadingRelationsTableTable,
  ...
  static MultiTypedResultKey<$TermMetaBankV3TableTable,
      ...
      MultiTypedResultKey.fromTable(db.termMetaBankV3Table,
          aliasName: $_aliasNameGenerator(
              db.readingTable.id, db.termMetaBankV3Table.readingId));
  ...
  static MultiTypedResultKey<$TermBankV3TableTable, List<TermBankV3TableData>>
      _termBankV3TableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termBankV3Table,
              aliasName: $_aliasNameGenerator(
                  db.readingTable.id, db.termBankV3Table.readingId));
...
class $$ReadingTableTableTableManager extends RootTableManager<
    ...
    (ReadingTableData, $$ReadingTableTableReferences),
    ReadingTableData,
    PrefetchHooks Function(
  ...
  $$ReadingTableTableTableManager(_$DaKanjiDB db, $ReadingTableTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$ReadingTableTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
                    ...
                    await $_getPrefetchedData(
                        ...
                        referencedTable: $$ReadingTableTableReferences
                            ._kanjiBankV3KunyomiReadingRelationsTableRefsTable(
                                db),
                        managerFromTypedResult: (p0) =>
                            $$ReadingTableTableReferences(db, table, p0)
...
final class $$IndexTableTableReferences
  ...
  static MultiTypedResultKey<$KanjiMetaBankV3TableTable,
      ...
      MultiTypedResultKey.fromTable(db.kanjiMetaBankV3Table,
          aliasName: $_aliasNameGenerator(
              db.indexTable.id, db.kanjiMetaBankV3Table.dictId));
  ...
  static MultiTypedResultKey<$TermMetaBankV3TableTable,
      ...
      MultiTypedResultKey.fromTable(db.termMetaBankV3Table,
          aliasName: $_aliasNameGenerator(
              db.indexTable.id, db.termMetaBankV3Table.dictId));
...
final class $$TagBankV3TableTableReferences extends BaseReferences<_$DaKanjiDB,
  ...
  static MultiTypedResultKey<$TermBankV3TagBankRelationsTableTable,
          List<TermBankV3TagBankRelationsTableData>>
      _termBankV3TagBankRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termBankV3TagBankRelationsTable,
              aliasName: $_aliasNameGenerator(db.tagBankV3Table.id,
...
class $$KanjiBankV3KunyomiReadingRelationsTableTableTableManager
  ...
  $$KanjiBankV3KunyomiReadingRelationsTableTableTableManager(
      _$DaKanjiDB db, $KanjiBankV3KunyomiReadingRelationsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $$KanjiBankV3OnyomiReadingRelationsTableTableFilterComposer
  ...
  $$ReadingTableTableFilterComposer get onyomiReadingId {
    final $$ReadingTableTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.onyomiReadingId,
        referencedTable: $db.readingTable,
        getReferencedColumn: (t) => t.id,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
...
class $$KanjiBankV3OnyomiReadingRelationsTableTableOrderingComposer
  ...
  $$ReadingTableTableOrderingComposer get onyomiReadingId {
    final $$ReadingTableTableOrderingComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.onyomiReadingId,
        referencedTable: $db.readingTable,
...
class $$KanjiBankV3OnyomiReadingRelationsTableTableAnnotationComposer
  ...
  $$ReadingTableTableAnnotationComposer get onyomiReadingId {
    final $$ReadingTableTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.onyomiReadingId,
        referencedTable: $db.readingTable,
...
class $$KanjiBankV3OnyomiReadingRelationsTableTableTableManager
  ...
  $$KanjiBankV3OnyomiReadingRelationsTableTableTableManager(
      _$DaKanjiDB db, $KanjiBankV3OnyomiReadingRelationsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({onyomiReadingId = false, kanjiId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
...
class $$KanjiMetaBankV3TableTableTableManager extends RootTableManager<
    ...
    KanjiMetaBankV3TableData,
    PrefetchHooks Function({bool dictId, bool kanjiId, bool typeId})> {
  $$KanjiMetaBankV3TableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: (
              {dictId = false, kanjiId = false, typeId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
                ...
                if (dictId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.dictId,
                    referencedTable:
                        $$KanjiMetaBankV3TableTableReferences._dictIdTable(db),
                ...
                if (kanjiId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.kanjiId,
                    referencedTable:
                        $$KanjiMetaBankV3TableTableReferences._kanjiIdTable(db),
                    referencedColumn: $$KanjiMetaBankV3TableTableReferences
                        ._kanjiIdTable(db)
                        .id,
                  ) as T;
...
final class $$TermMetaBankV3TableTableReferences extends BaseReferences<
  ...
  static MultiTypedResultKey<$TermMetaBankV3PitchRelationsTableTable,
          List<TermMetaBankV3PitchRelationsTableData>>
      _termMetaBankV3PitchRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termMetaBankV3PitchRelationsTable,
              aliasName: $_aliasNameGenerator(db.termMetaBankV3Table.id,
  ...
  static MultiTypedResultKey<$TermMetaBankV3IpaRelationsTableTable,
          List<TermMetaBankV3IpaRelationsTableData>>
      _termMetaBankV3IpaRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termMetaBankV3IpaRelationsTable,
              aliasName: $_aliasNameGenerator(db.termMetaBankV3Table.id,
              ...
              addJoins: <
                ...
                if (dictId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.dictId,
                    referencedTable:
                        $$TermMetaBankV3TableTableReferences._dictIdTable(db),
                ...
                if (termId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$TermMetaBankV3TableTableReferences._termIdTable(db),
                    referencedColumn: $$TermMetaBankV3TableTableReferences
                        ._termIdTable(db)
                        .id,
                  ) as T;
                ...
                return [
                  if (termMetaBankV3PitchRelationsTableRefs)
                    await $_getPrefetchedData(
                        ...
                        managerFromTypedResult: (p0) =>
                            $$TermMetaBankV3TableTableReferences(db, table, p0)
...
final class $$TermBankV3DefinitionTagsTableTableReferences
    extends BaseReferences<_$DaKanjiDB, $TermBankV3DefinitionTagsTableTable,
        TermBankV3DefinitionTagsTableData> {
  $$TermBankV3DefinitionTagsTableTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static MultiTypedResultKey<$TermBankV3DefinitionTagRelationsTableTable,
...
class $$TermBankV3DefinitionTagsTableTableFilterComposer
  ...
  ColumnFilters<String> get definitionTag => $composableBuilder(
      column: $table.definitionTag, builder: (column) => ColumnFilters(column));
...
class $$TermBankV3DefinitionTagsTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get definitionTag => $composableBuilder(
      column: $table.definitionTag, builder: (column) => column);
...
class $$TermBankV3DefinitionTagsTableTableTableManager extends RootTableManager<
    _$DaKanjiDB,
  ...
  $$TermBankV3DefinitionTagsTableTableTableManager(
      _$DaKanjiDB db, $TermBankV3DefinitionTagsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
                ...
                return [
                  if (termBankV3DefinitionTagRelationsTableRefs)
                    await $_getPrefetchedData(
                        ...
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.definitionTagId == item.id),
                        typedResults: items)
                ];
              },
            );
...
typedef $$TermBankV3TableTableCreateCompanionBuilder = TermBankV3TableCompanion
    Function({
  Value<int> id,
  required int termId,
  required int readingId,
...
typedef $$TermBankV3TableTableUpdateCompanionBuilder = TermBankV3TableCompanion
    Function({
  Value<int> id,
  Value<int> termId,
  Value<int> readingId,
...
final class $$TermBankV3TableTableReferences extends BaseReferences<_$DaKanjiDB,
    $TermBankV3TableTable, TermBankV3TableData> {
  ...
  static MultiTypedResultKey<$TermBankV3DefinitionTagRelationsTableTable,
      ...
      _termBankV3DefinitionTagRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(
              db.termBankV3DefinitionTagRelationsTable,
              aliasName: $_aliasNameGenerator(db.termBankV3Table.id,
                  db.termBankV3DefinitionTagRelationsTable.termId));
  ...
  static MultiTypedResultKey<$TermBankV3RuleIdentifiersRelationsTableTable,
          List<TermBankV3RuleIdentifiersRelationsTableData>>
      _termBankV3RuleIdentifiersRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(
              db.termBankV3RuleIdentifiersRelationsTable,
              aliasName: $_aliasNameGenerator(db.termBankV3Table.id,
                  db.termBankV3RuleIdentifiersRelationsTable.termId));

  $$TermBankV3RuleIdentifiersRelationsTableTableProcessedTableManager
      get termBankV3RuleIdentifiersRelationsTableRefs {
    final manager = $$TermBankV3RuleIdentifiersRelationsTableTableTableManager(
            $_db, $_db.termBankV3RuleIdentifiersRelationsTable)
        .filter((f) => f.termId.id($_item.id));

    final cache = $_typedResult.readTableOrNull(
        _termBankV3RuleIdentifiersRelationsTableRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }
  ...
  static MultiTypedResultKey<$TermBankV3TagBankRelationsTableTable,
      ...
      _termBankV3TagBankRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termBankV3TagBankRelationsTable,
              aliasName: $_aliasNameGenerator(db.termBankV3Table.id,
                  db.termBankV3TagBankRelationsTable.termId));
...
class $$TermBankV3TableTableFilterComposer
  ...
  Expression<bool> termBankV3RuleIdentifiersRelationsTableRefs(
      Expression<bool> Function(
              $$TermBankV3RuleIdentifiersRelationsTableTableFilterComposer f)
          f) {
    final $$TermBankV3RuleIdentifiersRelationsTableTableFilterComposer
        composer = $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.id,
            referencedTable: $db.termBankV3RuleIdentifiersRelationsTable,
            getReferencedColumn: (t) => t.termId,
            builder: (joinBuilder,
                    {$addJoinBuilderToRootComposer,
                    $removeJoinBuilderFromRootComposer}) =>
                $$TermBankV3RuleIdentifiersRelationsTableTableFilterComposer(
                  $db: $db,
                  $table: $db.termBankV3RuleIdentifiersRelationsTable,
                  $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                  joinBuilder: joinBuilder,
                  $removeJoinBuilderFromRootComposer:
                      $removeJoinBuilderFromRootComposer,
...
class $$TermBankV3TableTableAnnotationComposer
  ...
  Expression<T> termBankV3RuleIdentifiersRelationsTableRefs<T extends Object>(
      Expression<T> Function(
              $$TermBankV3RuleIdentifiersRelationsTableTableAnnotationComposer
                  a)
          f) {
    final $$TermBankV3RuleIdentifiersRelationsTableTableAnnotationComposer
        composer = $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.id,
            referencedTable: $db.termBankV3RuleIdentifiersRelationsTable,
...
class $$TermBankV3TableTableTableManager extends RootTableManager<
    _$DaKanjiDB,
    ...
    $$TermBankV3TableTableOrderingComposer,
    $$TermBankV3TableTableAnnotationComposer,
    $$TermBankV3TableTableCreateCompanionBuilder,
    $$TermBankV3TableTableUpdateCompanionBuilder,
    (TermBankV3TableData, $$TermBankV3TableTableReferences),
    TermBankV3TableData,
    PrefetchHooks Function(
        {bool termId,
        bool readingId,
        bool termBankV3DefinitionTagRelationsTableRefs,
        bool termBankV3RuleIdentifiersRelationsTableRefs,
        bool termBankV3TagBankRelationsTableRefs})> {
  $$TermBankV3TableTableTableManager(
      _$DaKanjiDB db, $TermBankV3TableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$TermBankV3TableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$TermBankV3TableTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$TermBankV3TableTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<int> id = const Value.absent(),
            Value<int> termId = const Value.absent(),
            Value<int> readingId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$TermBankV3TableTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
              {termId = false,
              readingId = false,
              termBankV3DefinitionTagRelationsTableRefs = false,
              termBankV3RuleIdentifiersRelationsTableRefs = false,
              termBankV3TagBankRelationsTableRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (termBankV3DefinitionTagRelationsTableRefs)
                  db.termBankV3DefinitionTagRelationsTable,
                if (termBankV3RuleIdentifiersRelationsTableRefs)
                  db.termBankV3RuleIdentifiersRelationsTable,
                if (termBankV3TagBankRelationsTableRefs)
                  db.termBankV3TagBankRelationsTable
              ],
              addJoins: <
                ...
                if (termId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.termId,
                    referencedTable:
                        $$TermBankV3TableTableReferences._termIdTable(db),
                    referencedColumn:
                        $$TermBankV3TableTableReferences._termIdTable(db).id,
                  ) as T;
                }
                if (readingId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.readingId,
                    referencedTable:
                        $$TermBankV3TableTableReferences._readingIdTable(db),
                    referencedColumn:
                        $$TermBankV3TableTableReferences._readingIdTable(db).id,
                  ) as T;
                }
                ...
                return [
                    ...
                    await $_getPrefetchedData(
                        ...
                        referencedTable: $$TermBankV3TableTableReferences
                            ._termBankV3DefinitionTagRelationsTableRefsTable(
                                db),
                        managerFromTypedResult: (p0) =>
                            $$TermBankV3TableTableReferences(db, table, p0)
                                .termBankV3DefinitionTagRelationsTableRefs,
                        referencedItemsForCurrentItem: (item,
                                referencedItems) =>
                            referencedItems.where((e) => e.termId == item.id),
                  ...
                  if (termBankV3RuleIdentifiersRelationsTableRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable: $$TermBankV3TableTableReferences
                            ._termBankV3RuleIdentifiersRelationsTableRefsTable(
                                db),
                        managerFromTypedResult: (p0) =>
                            $$TermBankV3TableTableReferences(db, table, p0)
                                .termBankV3RuleIdentifiersRelationsTableRefs,
                        referencedItemsForCurrentItem: (item,
                                referencedItems) =>
                            referencedItems.where((e) => e.termId == item.id),
                        typedResults: items),
...
typedef $$TermBankV3TableTableProcessedTableManager = ProcessedTableManager<
    _$DaKanjiDB,
    $TermBankV3TableTable,
    TermBankV3TableData,
    $$TermBankV3TableTableFilterComposer,
...
final class $$TermBankV3DefinitionTagRelationsTableTableReferences
  ...
  static $TermBankV3DefinitionTagsTableTable _definitionTagIdTable(
          _$DaKanjiDB db) =>
      db.termBankV3DefinitionTagsTable.createAlias($_aliasNameGenerator(
          db.termBankV3DefinitionTagRelationsTable.definitionTagId,
          db.termBankV3DefinitionTagsTable.id));
  ...
  static $TermBankV3TableTable _termIdTable(_$DaKanjiDB db) =>
      db.termBankV3Table.createAlias($_aliasNameGenerator(
          db.termBankV3DefinitionTagRelationsTable.termId,
          db.termBankV3Table.id));

  $$TermBankV3TableTableProcessedTableManager? get termId {
    if ($_item.termId == null) return null;
    final manager =
        $$TermBankV3TableTableTableManager($_db, $_db.termBankV3Table)
            .filter((f) => f.id($_item.termId!));
...
class $$TermBankV3DefinitionTagRelationsTableTableFilterComposer
  ...
  $$TermBankV3TableTableFilterComposer get termId {
    final $$TermBankV3TableTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.termId,
        referencedTable: $db.termBankV3Table,
...
class $$TermBankV3DefinitionTagRelationsTableTableOrderingComposer
  ...
  $$TermBankV3TableTableOrderingComposer get termId {
...
class $$TermBankV3DefinitionTagRelationsTableTableAnnotationComposer
  ...
  $$TermBankV3TableTableAnnotationComposer get termId {
    final $$TermBankV3TableTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.termId,
        referencedTable: $db.termBankV3Table,
...
class $$TermBankV3DefinitionTagRelationsTableTableTableManager
    extends RootTableManager<
        ...
        TermBankV3DefinitionTagRelationsTableData,
        PrefetchHooks Function({bool definitionTagId, bool termId})> {
  $$TermBankV3DefinitionTagRelationsTableTableTableManager(
      _$DaKanjiDB db, $TermBankV3DefinitionTagRelationsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({definitionTagId = false, termId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
...
final class $$TermBankV3RuleIdentifierTableTableReferences
    extends BaseReferences<_$DaKanjiDB, $TermBankV3RuleIdentifierTableTable,
        TermBankV3RuleIdentifierTableData> {
      ...
      _termBankV3RuleIdentifiersRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(
              ...
              aliasName: $_aliasNameGenerator(
                  ...
                  db.termBankV3RuleIdentifiersRelationsTable.ruleIdentifierId));
...
class $$TermBankV3RuleIdentifierTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get ruleIdentifier => $composableBuilder(
      column: $table.ruleIdentifier, builder: (column) => column);
...
class $$TermBankV3RuleIdentifierTableTableTableManager extends RootTableManager<
    _$DaKanjiDB,
  ...
  $$TermBankV3RuleIdentifierTableTableTableManager(
      _$DaKanjiDB db, $TermBankV3RuleIdentifierTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
                ...
                return [
                  if (termBankV3RuleIdentifiersRelationsTableRefs)
                    await $_getPrefetchedData(
                        ...
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.ruleIdentifierId == item.id),
                        typedResults: items)
                ];
              },
            );
...
typedef $$TermBankV3RuleIdentifierTableTableProcessedTableManager
    = ProcessedTableManager<
        ...
        PrefetchHooks Function(
            {bool termBankV3RuleIdentifiersRelationsTableRefs})>;
typedef $$TermBankV3RuleIdentifiersRelationsTableTableCreateCompanionBuilder
    = TermBankV3RuleIdentifiersRelationsTableCompanion Function({
  Value<int> id,
  required int ruleIdentifierId,
  required int termId,
});
typedef $$TermBankV3RuleIdentifiersRelationsTableTableUpdateCompanionBuilder
    = TermBankV3RuleIdentifiersRelationsTableCompanion Function({
  Value<int> id,
...
final class $$TermBankV3RuleIdentifiersRelationsTableTableReferences
    extends BaseReferences<
        _$DaKanjiDB,
        $TermBankV3RuleIdentifiersRelationsTableTable,
        TermBankV3RuleIdentifiersRelationsTableData> {
  $$TermBankV3RuleIdentifiersRelationsTableTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $TermBankV3RuleIdentifierTableTable _ruleIdentifierIdTable(
          _$DaKanjiDB db) =>
      db.termBankV3RuleIdentifierTable.createAlias($_aliasNameGenerator(
          db.termBankV3RuleIdentifiersRelationsTable.ruleIdentifierId,
          db.termBankV3RuleIdentifierTable.id));
...
class $$TermBankV3RuleIdentifiersRelationsTableTableFilterComposer
    extends Composer<_$DaKanjiDB,
        $TermBankV3RuleIdentifiersRelationsTableTable> {
  $$TermBankV3RuleIdentifiersRelationsTableTableFilterComposer({
    required super.$db,
...
class $$TermBankV3RuleIdentifiersRelationsTableTableOrderingComposer
    extends Composer<_$DaKanjiDB,
        $TermBankV3RuleIdentifiersRelationsTableTable> {
  $$TermBankV3RuleIdentifiersRelationsTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TermBankV3RuleIdentifiersRelationsTableTableAnnotationComposer
    extends Composer<_$DaKanjiDB,
        $TermBankV3RuleIdentifiersRelationsTableTable> {
  $$TermBankV3RuleIdentifiersRelationsTableTableAnnotationComposer({
    required super.$db,
...
class $$TermBankV3RuleIdentifiersRelationsTableTableTableManager
    extends RootTableManager<
        _$DaKanjiDB,
        $TermBankV3RuleIdentifiersRelationsTableTable,
        TermBankV3RuleIdentifiersRelationsTableData,
        ...
        $$TermBankV3RuleIdentifiersRelationsTableTableOrderingComposer,
        $$TermBankV3RuleIdentifiersRelationsTableTableAnnotationComposer,
        $$TermBankV3RuleIdentifiersRelationsTableTableCreateCompanionBuilder,
        $$TermBankV3RuleIdentifiersRelationsTableTableUpdateCompanionBuilder,
        (
          TermBankV3RuleIdentifiersRelationsTableData,
          $$TermBankV3RuleIdentifiersRelationsTableTableReferences
        ),
        TermBankV3RuleIdentifiersRelationsTableData,
        PrefetchHooks Function({bool ruleIdentifierId, bool termId})> {
  $$TermBankV3RuleIdentifiersRelationsTableTableTableManager(
      _$DaKanjiDB db, $TermBankV3RuleIdentifiersRelationsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            ...
            Value<int> termId = const Value.absent(),
              ...
              TermBankV3RuleIdentifiersRelationsTableCompanion(
            id: id,
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({ruleIdentifierId = false, termId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
...
typedef $$TermBankV3RuleIdentifiersRelationsTableTableProcessedTableManager
    = ProcessedTableManager<
        _$DaKanjiDB,
        $TermBankV3RuleIdentifiersRelationsTableTable,
        TermBankV3RuleIdentifiersRelationsTableData,
...
final class $$TermBankV3TagBankRelationsTableTableReferences
    extends BaseReferences<_$DaKanjiDB, $TermBankV3TagBankRelationsTableTable,
        TermBankV3TagBankRelationsTableData> {
  ...
  static $TermBankV3TableTable _termIdTable(_$DaKanjiDB db) =>
      db.termBankV3Table.createAlias($_aliasNameGenerator(
          db.termBankV3TagBankRelationsTable.termId, db.termBankV3Table.id));
...
class $$TermBankV3TagBankRelationsTableTableFilterComposer
  ...
  $$TagBankV3TableTableFilterComposer get tagBankId {
    final $$TagBankV3TableTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.tagBankId,
        referencedTable: $db.tagBankV3Table,
        getReferencedColumn: (t) => t.id,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
...
class $$TermBankV3TagBankRelationsTableTableOrderingComposer
  ...
  $$TagBankV3TableTableOrderingComposer get tagBankId {
    final $$TagBankV3TableTableOrderingComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.tagBankId,
        referencedTable: $db.tagBankV3Table,
...
class $$TermBankV3TagBankRelationsTableTableAnnotationComposer
  ...
  $$TagBankV3TableTableAnnotationComposer get tagBankId {
    final $$TagBankV3TableTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.tagBankId,
        referencedTable: $db.tagBankV3Table,
...
class $$TermBankV3TagBankRelationsTableTableTableManager
    extends RootTableManager<
        ...
        TermBankV3TagBankRelationsTableData,
        PrefetchHooks Function({bool tagBankId, bool termId})> {
  $$TermBankV3TagBankRelationsTableTableTableManager(
      _$DaKanjiDB db, $TermBankV3TagBankRelationsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({tagBankId = false, termId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
...
final class $$TermMetaBankV3PitchTableTableReferences extends BaseReferences<
    _$DaKanjiDB, $TermMetaBankV3PitchTableTable, TermMetaBankV3PitchTableData> {
  ...
  static MultiTypedResultKey<$TermMetaBankV3PitchRelationsTableTable,
      ...
      _termMetaBankV3PitchRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termMetaBankV3PitchRelationsTable,
              aliasName: $_aliasNameGenerator(db.termMetaBankV3PitchTable.id,
  ...
  static MultiTypedResultKey<$TermMetaBankV3PitchTagRelationsTableTable,
          List<TermMetaBankV3PitchTagRelationsTableData>>
      _termMetaBankV3PitchTagRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termMetaBankV3PitchTagRelationsTable,
              aliasName: $_aliasNameGenerator(db.termMetaBankV3PitchTable.id,
  ...
  $$TermMetaBankV3PitchTableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$TermMetaBankV3PitchTableTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
              {termMetaBankV3PitchRelationsTableRefs = false,
...
final class $$TermMetaBankV3PitchRelationsTableTableReferences
    extends BaseReferences<_$DaKanjiDB, $TermMetaBankV3PitchRelationsTableTable,
        TermMetaBankV3PitchRelationsTableData> {
  $$TermMetaBankV3PitchRelationsTableTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $TermMetaBankV3PitchTableTable _pitchIdTable(_$DaKanjiDB db) =>
      db.termMetaBankV3PitchTable.createAlias($_aliasNameGenerator(
          db.termMetaBankV3PitchRelationsTable.pitchId,
  ...
  static $TermMetaBankV3TableTable _termMetaIdTable(_$DaKanjiDB db) =>
      db.termMetaBankV3Table.createAlias($_aliasNameGenerator(
          db.termMetaBankV3PitchRelationsTable.termMetaId,
...
class $$TermMetaBankV3PitchRelationsTableTableFilterComposer
  ...
  $$TermMetaBankV3PitchTableTableFilterComposer get pitchId {
    final $$TermMetaBankV3PitchTableTableFilterComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.pitchId,
            referencedTable: $db.termMetaBankV3PitchTable,
            getReferencedColumn: (t) => t.id,
            builder: (joinBuilder,
                    {$addJoinBuilderToRootComposer,
                    $removeJoinBuilderFromRootComposer}) =>
                $$TermMetaBankV3PitchTableTableFilterComposer(
                  $db: $db,
                  $table: $db.termMetaBankV3PitchTable,
                  $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                  joinBuilder: joinBuilder,
                  $removeJoinBuilderFromRootComposer:
                      $removeJoinBuilderFromRootComposer,
  ...
  $$TermMetaBankV3TableTableFilterComposer get termMetaId {
    final $$TermMetaBankV3TableTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.termMetaId,
        referencedTable: $db.termMetaBankV3Table,
        getReferencedColumn: (t) => t.id,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
...
class $$TermMetaBankV3PitchRelationsTableTableOrderingComposer
  ...
  $$TermMetaBankV3PitchTableTableOrderingComposer get pitchId {
    final $$TermMetaBankV3PitchTableTableOrderingComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.pitchId,
            referencedTable: $db.termMetaBankV3PitchTable,
  ...
  $$TermMetaBankV3TableTableOrderingComposer get termMetaId {
    final $$TermMetaBankV3TableTableOrderingComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.termMetaId,
            referencedTable: $db.termMetaBankV3Table,
...
class $$TermMetaBankV3PitchRelationsTableTableAnnotationComposer
  ...
  $$TermMetaBankV3PitchTableTableAnnotationComposer get pitchId {
    final $$TermMetaBankV3PitchTableTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.pitchId,
            referencedTable: $db.termMetaBankV3PitchTable,
  ...
  $$TermMetaBankV3TableTableAnnotationComposer get termMetaId {
    final $$TermMetaBankV3TableTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.termMetaId,
...
class $$TermMetaBankV3PitchRelationsTableTableTableManager
  ...
  $$TermMetaBankV3PitchRelationsTableTableTableManager(
      _$DaKanjiDB db, $TermMetaBankV3PitchRelationsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({pitchId = false, termMetaId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
...
typedef $$TermMetaBankV3TagTableTableCreateCompanionBuilder
    = TermMetaBankV3TagTableCompanion Function({
  Value<int> id,
  required String tag,
});
typedef $$TermMetaBankV3TagTableTableUpdateCompanionBuilder
    = TermMetaBankV3TagTableCompanion Function({
  Value<int> id,
  Value<String> tag,
});

final class $$TermMetaBankV3TagTableTableReferences extends BaseReferences<
    _$DaKanjiDB, $TermMetaBankV3TagTableTable, TermMetaBankV3TagTableData> {
  ...
  static MultiTypedResultKey<$TermMetaBankV3PitchTagRelationsTableTable,
      ...
      _termMetaBankV3PitchTagRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termMetaBankV3PitchTagRelationsTable,
              aliasName: $_aliasNameGenerator(db.termMetaBankV3TagTable.id,
  ...
  static MultiTypedResultKey<$TermMetaBankV3IpaTagRelationsTableTable,
          List<TermMetaBankV3IpaTagRelationsTableData>>
      _termMetaBankV3IpaTagRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termMetaBankV3IpaTagRelationsTable,
              aliasName: $_aliasNameGenerator(db.termMetaBankV3TagTable.id,
...
class $$TermMetaBankV3TagTableTableFilterComposer
    extends Composer<_$DaKanjiDB, $TermMetaBankV3TagTableTable> {
  $$TermMetaBankV3TagTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TermMetaBankV3TagTableTableOrderingComposer
    extends Composer<_$DaKanjiDB, $TermMetaBankV3TagTableTable> {
  $$TermMetaBankV3TagTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TermMetaBankV3TagTableTableAnnotationComposer
    extends Composer<_$DaKanjiDB, $TermMetaBankV3TagTableTable> {
  $$TermMetaBankV3TagTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TermMetaBankV3TagTableTableTableManager extends RootTableManager<
    _$DaKanjiDB,
    ...
    $$TermMetaBankV3TagTableTableOrderingComposer,
    $$TermMetaBankV3TagTableTableAnnotationComposer,
    $$TermMetaBankV3TagTableTableCreateCompanionBuilder,
    $$TermMetaBankV3TagTableTableUpdateCompanionBuilder,
  ...
  $$TermMetaBankV3TagTableTableTableManager(
      _$DaKanjiDB db, $TermMetaBankV3TagTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            ...
            Value<String> tag = const Value.absent(),
              ...
              TermMetaBankV3TagTableCompanion(
            id: id,
            tag: tag,
          ),
          createCompanionCallback: ({
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$TermMetaBankV3TagTableTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
              {termMetaBankV3PitchTagRelationsTableRefs = false,
...
typedef $$TermMetaBankV3TagTableTableProcessedTableManager
    = ProcessedTableManager<
        _$DaKanjiDB,
        $TermMetaBankV3TagTableTable,
        TermMetaBankV3TagTableData,
...
final class $$TermMetaBankV3PitchTagRelationsTableTableReferences
  ...
  static $TermMetaBankV3TagTableTable _tagIdTable(_$DaKanjiDB db) =>
      db.termMetaBankV3TagTable.createAlias($_aliasNameGenerator(
          db.termMetaBankV3PitchTagRelationsTable.tagId,
...
class $$TermMetaBankV3PitchTagRelationsTableTableFilterComposer
  ...
  $$TermMetaBankV3TagTableTableFilterComposer get tagId {
    final $$TermMetaBankV3TagTableTableFilterComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.tagId,
            referencedTable: $db.termMetaBankV3TagTable,
            getReferencedColumn: (t) => t.id,
            builder: (joinBuilder,
                    {$addJoinBuilderToRootComposer,
                    $removeJoinBuilderFromRootComposer}) =>
                $$TermMetaBankV3TagTableTableFilterComposer(
                  $db: $db,
                  $table: $db.termMetaBankV3TagTable,
                  $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                  joinBuilder: joinBuilder,
                  $removeJoinBuilderFromRootComposer:
                      $removeJoinBuilderFromRootComposer,
...
class $$TermMetaBankV3PitchTagRelationsTableTableOrderingComposer
  ...
  $$TermMetaBankV3TagTableTableOrderingComposer get tagId {
    final $$TermMetaBankV3TagTableTableOrderingComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.tagId,
            referencedTable: $db.termMetaBankV3TagTable,
...
class $$TermMetaBankV3PitchTagRelationsTableTableAnnotationComposer
  ...
  $$TermMetaBankV3TagTableTableAnnotationComposer get tagId {
    final $$TermMetaBankV3TagTableTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.tagId,
            referencedTable: $db.termMetaBankV3TagTable,
...
class $$TermMetaBankV3PitchTagRelationsTableTableTableManager
  ...
  $$TermMetaBankV3PitchTagRelationsTableTableTableManager(
      _$DaKanjiDB db, $TermMetaBankV3PitchTagRelationsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({pitchId = false, tagId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
...
final class $$TermMetaBankV3IpaTableTableReferences extends BaseReferences<
    _$DaKanjiDB, $TermMetaBankV3IpaTableTable, TermMetaBankV3IpaTableData> {
  ...
  static MultiTypedResultKey<$TermMetaBankV3IpaRelationsTableTable,
      ...
      _termMetaBankV3IpaRelationsTableRefsTable(_$DaKanjiDB db) =>
          MultiTypedResultKey.fromTable(db.termMetaBankV3IpaRelationsTable,
              aliasName: $_aliasNameGenerator(db.termMetaBankV3IpaTable.id,
  ...
  $$TermMetaBankV3IpaTableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$TermMetaBankV3IpaTableTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: (
              {termMetaBankV3IpaRelationsTableRefs = false,
...
final class $$TermMetaBankV3IpaRelationsTableTableReferences
    extends BaseReferences<_$DaKanjiDB, $TermMetaBankV3IpaRelationsTableTable,
        TermMetaBankV3IpaRelationsTableData> {
  $$TermMetaBankV3IpaRelationsTableTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $TermMetaBankV3IpaTableTable _ipaIdTable(_$DaKanjiDB db) =>
      db.termMetaBankV3IpaTable.createAlias($_aliasNameGenerator(
          db.termMetaBankV3IpaRelationsTable.ipaId,
...
class $$TermMetaBankV3IpaRelationsTableTableFilterComposer
  ...
  $$TermMetaBankV3IpaTableTableFilterComposer get ipaId {
    final $$TermMetaBankV3IpaTableTableFilterComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.ipaId,
            referencedTable: $db.termMetaBankV3IpaTable,
            getReferencedColumn: (t) => t.id,
            builder: (joinBuilder,
                    {$addJoinBuilderToRootComposer,
                    $removeJoinBuilderFromRootComposer}) =>
                $$TermMetaBankV3IpaTableTableFilterComposer(
                  $db: $db,
                  $table: $db.termMetaBankV3IpaTable,
                  $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                  joinBuilder: joinBuilder,
                  $removeJoinBuilderFromRootComposer:
                      $removeJoinBuilderFromRootComposer,
...
class $$TermMetaBankV3IpaRelationsTableTableOrderingComposer
  ...
  $$TermMetaBankV3IpaTableTableOrderingComposer get ipaId {
    final $$TermMetaBankV3IpaTableTableOrderingComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.ipaId,
            referencedTable: $db.termMetaBankV3IpaTable,
...
class $$TermMetaBankV3IpaRelationsTableTableAnnotationComposer
  ...
  $$TermMetaBankV3IpaTableTableAnnotationComposer get ipaId {
    final $$TermMetaBankV3IpaTableTableAnnotationComposer composer =
        $composerBuilder(
            composer: this,
            getCurrentColumn: (t) => t.ipaId,
            referencedTable: $db.termMetaBankV3IpaTable,
...
class $$TermMetaBankV3IpaRelationsTableTableTableManager
  ...
  $$TermMetaBankV3IpaRelationsTableTableTableManager(
      _$DaKanjiDB db, $TermMetaBankV3IpaRelationsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({ipaId = false, termMetaId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
...
class $$TermMetaBankV3IpaTagRelationsTableTableTableManager
  ...
  $$TermMetaBankV3IpaTagRelationsTableTableTableManager(
      _$DaKanjiDB db, $TermMetaBankV3IpaTagRelationsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({ipaId = false, tagId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
  ...
  $$TermBankV3RuleIdentifierTableTableTableManager
      get termBankV3RuleIdentifierTable =>
          $$TermBankV3RuleIdentifierTableTableTableManager(
              _db, _db.termBankV3RuleIdentifierTable);
  $$TermBankV3RuleIdentifiersRelationsTableTableTableManager
      get termBankV3RuleIdentifiersRelationsTable =>
          $$TermBankV3RuleIdentifiersRelationsTableTableTableManager(
              _db, _db.termBankV3RuleIdentifiersRelationsTable);
  $$TermBankV3TagBankRelationsTableTableTableManager
