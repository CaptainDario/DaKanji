			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - DaKanji</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - DaKanji</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="/Users/darioklepoch/dev/DaKanji/DaKanjiApplication/docs//sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
...
Served from: dakanji.local @ 2023-09-16 18:36:48 by W3 Total Cache
-->