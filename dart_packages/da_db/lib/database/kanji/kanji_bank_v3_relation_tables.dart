...
class KanjiBankV3_X_OnyomiReadingTable extends Table {
  ...
  @override
  Set<Column> get primaryKey => {onyomiReadingId, kanjiId};
...
class KanjiBankV3_X_KunyomiReadingTable extends Table {
  ...
  @override
  Set<Column> get primaryKey => {kunyomiReadingId, kanjiId};
...
class KanjiBankV3_X_TagBankV3Table extends Table {
  ...
  @override
  Set<Column> get primaryKey => {tagId, kanjiId};
...
class KanjiBankV3_X_DefinitionTable extends Table {
  ...
  @override
  Set<Column> get primaryKey => {definitionId, kanjiId};
...
class KanjiBankV3_X_KanjiBankV3StatsTable extends Table {
  ...
  @override
  Set<Column> get primaryKey => {statId, kanjiId};
