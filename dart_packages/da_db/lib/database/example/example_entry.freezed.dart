...
mixin _$ExampleEntry {
 ...
 int get id; IndexEntry get indexEntry; int? get groupId; String get sentence; List<TagBankV3Entry> get tags; List<StatEntry> get stats; List<ExampleAudioEntry> get audios;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,indexEntry,groupId,sentence,const DeepCollectionEquality().hash(tags),const DeepCollectionEquality().hash(stats),const DeepCollectionEquality().hash(audios));

@override
String toString() {
  return 'ExampleEntry(id: $id, indexEntry: $indexEntry, groupId: $groupId, sentence: $sentence, tags: $tags, stats: $stats, audios: $audios)';
}
...
@useResult
$Res call({
 int id, IndexEntry indexEntry, int? groupId, String sentence, List<TagBankV3Entry> tags, List<StatEntry> stats, List<ExampleAudioEntry> audios
});
...
/// Create a copy of ExampleEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? indexEntry = null,Object? groupId = freezed,Object? sentence = null,Object? tags = null,Object? stats = null,Object? audios = null,}) {
...
as IndexEntry,groupId: freezed == groupId ? _self.groupId : groupId // ignore: cast_nullable_to_non_nullable
