...
├── example_text_metadata_1.json  # (Optional) metadata that is applied to all extracted sentences from example_text_bank_1
├── example_text_bank_2.txt       # Next Plain text file (UTF-8)
└── example_text_metadata_2.json  # (Optional) metadata that is applied to all extracted sentences from example_text_bank_2
```
...
[Click here for th example_text_metadata_ JSON schema definition.](../example_banks/example-bank-schema.json)
