...
SettingsDictionary _$SettingsDictionaryFromJson(
  ...
  ..selectedFallingWordsLevels =
      (json['selectedFallingWordsLevels'] as List<dynamic>?)
          ...
          .toList() ??
      ['N5', 'N4', 'N3']
  ..fallingWordsSpeed = (json['fallingWordsSpeed'] as num?)?.toDouble() ?? 1.0
  ..playKanjiAnimationWhenOpened =
      json['playKanjiAnimationWhenOpened'] as bool? ?? true
  ..limitSearchResults = (json['limitSearchResults'] as num?)?.toInt() ?? 100
  ...
  ..googleImageSearchQuery = json['googleImageSearchQuery'] as String? ?? '%X%';
