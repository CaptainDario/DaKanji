...
class $WordListNodesSQLTable extends WordListNodesSQL
  ...
  late final GeneratedColumnWithTypeConverter<List<int>, String> childrenIDs =
      GeneratedColumn<String>(
        ...
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<List<int>>($WordListNodesSQLTable.$converterchildrenIDs);
  @override
  late final GeneratedColumnWithTypeConverter<WordListNodeType, int> type =
      GeneratedColumn<int>(
        ...
        type: DriftSqlType.int,
        requiredDuringInsert: true,
      ).withConverter<WordListNodeType>($WordListNodesSQLTable.$convertertype);
  ...
  WordListNodesSQLData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return WordListNodesSQLData(
      ...
      type: $WordListNodesSQLTable.$convertertype.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.int,
...
class WordListNodesSQLData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    }
    {
      map['type'] = Variable<int>(
        $WordListNodesSQLTable.$convertertype.toSql(type),
      );
    }
  ...
  factory WordListNodesSQLData.fromJson(
    ...
    return WordListNodesSQLData(
      ...
      type: $WordListNodesSQLTable.$convertertype.fromJson(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'type': serializer.toJson<int>(
        $WordListNodesSQLTable.$convertertype.toJson(type),
      ),
...
class WordListNodesSQLCompanion extends UpdateCompanion<WordListNodesSQLData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (childrenIDs.present) {
      map['children_i_ds'] = Variable<String>(
        $WordListNodesSQLTable.$converterchildrenIDs.toSql(childrenIDs.value),
      );
    }
    if (type.present) {
      map['type'] = Variable<int>(
...
class WordListEntriesSQLData extends DataClass
  ...
  factory WordListEntriesSQLData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
abstract class _$WordListsSQLDatabase extends GeneratedDatabase {
  ...
  late final $WordListNodesSQLTable wordListNodesSQL = $WordListNodesSQLTable(
    this,
  );
...
class $$WordListNodesSQLTableTableManager
    extends
        RootTableManager<
  ...
  $$WordListNodesSQLTableTableManager(
    _$WordListsSQLDatabase db,
    $WordListNodesSQLTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$WordListNodesSQLTableProcessedTableManager =
...
class $$WordListEntriesSQLTableTableManager
    extends
        RootTableManager<
          _$WordListsSQLDatabase,
...
typedef $$WordListEntriesSQLTableProcessedTableManager =
    ProcessedTableManager<
      _$WordListsSQLDatabase,
      $WordListEntriesSQLTable,
      WordListEntriesSQLData,
