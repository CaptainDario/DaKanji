...
class CodegenLoader extends AssetLoader {
  ...
  "ClipboardScreen": {
    "title": "Schowek",
    "tutorial_android_limitation": "W systemie Android ekran ten nie może automatycznie odczytywać schowka w tle. Aplikacja musi być uruchomiona na pierwszym planie. W systemie iOS można zezwolić {{PRODUCT}} na odczytywanie schowka w ustawieniach. W ten sposób nie będzie zawsze pytać o zgodę na wklejanie. Przepraszamy za niedogodności.",
    "tutorial_begin_text": "Pokażemy Ci krótki poradnik jak korzystać z aplikacji",
    "tutorial_begin_title": "Witamy na ekranie schowka!",
    "tutorial_explanation": "Wystarczy skopiować tekst, a {{PRODUCT}} wyświetli hasła słownikowe i nie tylko!",
    "tutorial_pin_button": "Ten przycisk sprawia, że {{PRODUCT}} jest zawsze wyświetlane nad innymi oknami. Dodatkowo, rozmiar jest zmniejszony, a ramka i pasek aplikacji są ukryte. Dzięki temu {{PRODUCT}} może być używane jako pomoc w czytaniu nad dowolną inną aplikacją."
  },
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list": "Szybkie dodanie do listy",
    "word_tab_menu_quick_add_to_list_no_lists_selected": "Nie wybrano list do szybkiego wysyłania. Należy to zrobić w ustawieniach.",
    "word_tab_menu_quick_send_to_anki": "Szybkie wysyłanie do Anki",
  ...
  "HomeScreen": {
    "account_page_char_input_error": "Wprowadź dokładnie jeden japoński znak.",
    "account_page_char_updated_profile": "Udana aktualizacja profilu!",
    "account_page_error_loading": "Wystąpił błąd podczas ładowania profilu. Sprawdź połączenie internetowe i spróbuj ponownie.",
    "account_page_generic_error": "Wystąpił nieoczekiwany błąd",
    "account_page_link_sent": "Sprawdź swój e-mail, aby uzyskać link do logowania!",
    "account_page_link_to_sponsor": "Połączenie z kontem sponsora",
    ...
    "account_page_user_name_input_error": "Nazwa użytkownika musi zawierać od 1 do 10 znaków.",
  ...
  "InitScreen": {
    ...
    "RatePopup_text": "Lubisz {{PRODUCT}}?\nJeżeli tak, to ocenienie aplikacji znacznie pomogłoby projektowi!",
    "complete_log": "pełny rejestr",
    "downgrade_warning": "{{PRODUCT}} zostało obniżone! To nie jest obsługiwane działanie i jest bardzo prawdopodobne, że uszkodzi zapisane dane lub nawet sprawi, że {{PRODUCT}} będzie całkowicie bezużyteczne! Zresetuj wszystkie dane w \"Ustawienia -> Ustawienia zaawansowane\" i uruchom ponownie aplikację.",
    ...
    "download_popup_permission": "Musimy pobrać kilka plików, zanim będzie można rozpocząć (~{DOWNLOAD_SIZE}MB). Zdarzy się to tylko raz. Upewnij się, że masz stabilne połączenie internetowe i nie zamykaj aplikacji podczas pobierania.",
    "new_version_available_heading": "Nowa wersja dostępna!",
    "new_version_available_text": "Dostępna jest nowa wersja {{PRODUCT}}!",
    "new_version_comparison": "Uruchamiasz {VERSION_NUMBER}, najnowsza wersja to {NEW_VERSION_NUMBER}.",
    "new_versions_available_text": "Dostępne są {NEW_VERSIONS} nowe wersje {{PRODUCT}}!",
    "rate_this_app": "Oceń",
    "whats_new": "co nowego"
  },
  "KanaTableScreen": {
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Aby rozpocząć korzystanie z {{PRODUCT}} i Anki, należy nacisnąć poniższy przycisk. Sprawdzi on, czy konfiguracja jest prawidłowa.\n\nJeśli pojawi się komunikat o powodzeniu, {{PRODUCT}} i Anki są połączone i można rozpocząć korzystanie z {{PRODUCT}} z Anki.\nJeśli pojawi się komunikat o błędzie, należy postępować zgodnie z instrukcjami podanymi w komunikacie, a następnie ponownie nacisnąć przycisk.\nBez komunikatu o powodzeniu {{PRODUCT}} nie będzie w stanie wysyłać kart do Anki. Dlatego upewnij się, że naciśniesz poniższy przycisk i otrzymasz komunikat o powodzeniu. Możesz również sprawdzić, czy konfiguracja przebiegła pomyślnie w ustawieniach → Anki.",
    "anki_connection_test_title": "Konfiguracja testowa",
    "anki_setup_android_text": "Musisz mieć zainstalowany [AnkidDroid](https://play.google.com/store/apps/details?id=com.ichi2.anki) i kiedy zostaniesz o to poproszony, daj {{PRODUCT}} pozwolenie na interakcję z Anki.",
    ...
    "anki_setup_intro": "{{PRODUCT}} może być używane do wysyłania notatek do Anki. W tym celu każda platforma wymaga innej konfiguracji.",
    "anki_setup_ios_text": "Konfiguracja na iOS jest nieco kłopotliwa, ponieważ AnkiMobile nie pozwala na dodawanie typów notatek, co jest możliwe na Androidzie i komputerze. Dlatego musisz zaimportować talię Anki z typem notatek {{PRODUCT}} (nie musisz tego robić, jeśli wyeksportowałeś karty z {{PRODUCT}} do Anki na innym urządzeniu).\n\n1. Zainstaluj [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Pobierz gotową talię Anki z [tutaj](https://github.com/CaptainDario/{{PRODUCT}}-Dependencies/releases/download/v3.4.6/{{PRODUCT}}.apkg).\n3. Dotknij pobranego pliku, co spowoduje otwarcie okna dialogowego importu AnkiMobile.\n4. Zaimportuj talię\n5. Po wyświetleniu pytania zezwól {{PRODUCT}} na komunikację z AnkiMobile i odczytanie schowka.",
    ...
    "anki_test_connection_note_type_not_available": "Typ notatki {{PRODUCT}} nie jest dostępny w Anki! Możesz dodać go ręcznie, importując gotową talię wspomnianą w przewodniku konfiguracji iOS.",
    "anki_test_connection_success": "Jesteś podłączony do Anki! 🎉",
    "anki_title": "Anki",
    "deep_links_text": "Głębokie linki to sposób na bezpośrednie linkowanie do treści w aplikacji. {{PRODUCT}} zapewnia dwa schematy dla tego {{PRODUCT}}:// i http(s)://{{PRODUCT}}.app/app. Korzystając z tej funkcji, możesz na przykład otworzyć wyszukiwanie słownika po dotknięciu tego linku {{PRODUCT}}://dictionary?search=食べる. Wszystkie obsługiwane linki można znaleźć na stronie [{{PRODUCT}}.app/deep-links](https://{{PRODUCT}}.app/deep-links).",
    "deep_links_title": "Deep Links",
    "dict_examples_title": "Przykłady",
    "dict_kanji_animation_text": "{{PRODUCT}} może wyświetlać animowane diagramy kolejności uderzeń większości dołączonych Kanji / Kana. Animacjami tymi można sterować na różne sposoby.\nPodwójne stuknięcie ma różne skutki w zależności od bieżącego stanu animacji. Jeśli animacja jest aktualnie odtwarzana, zostanie wstrzymana. Podobnie, jeśli animacja jest aktualnie wstrzymana, będzie ona kontynuowana. Wreszcie, jeśli animacja została zakończona, dwukrotne dotknięcie spowoduje ponowne uruchomienie animacji od początku.\nPrzesuwając palcem po kanji można kontrolować postęp animacji. Przesunięcie w lewo spowoduje przewinięcie animacji do tyłu, a przesunięcie w prawo spowoduje jej przyspieszenie.",
    ...
    "misc_drawer_reorder_text": "Aby jak najlepiej dopasować się do każdego użytkownika, {{PRODUCT}} umożliwia zmianę kolejności elementów w głównym menu nawigacyjnym. Wystarczy nacisnąć dowolną pozycję menu, aby przeciągnąć ją w żądane miejsce.",
    "misc_title": "Różne",
    "text_paste_button_text": "Naciśnięcie tego przycisku powoduje wklejenie zawartości schowka.\nDługie naciśnięcie tego przycisku przełącza na automatyczne wklejanie i zawsze wkleja zawartość schowka, gdy się zmieni.",
    "text_paste_button_title": "Przycisk Wklej",
  ...
  "OcrScreen": {
    "title": "OCR",
    "tutorial_begin_text": "Pokażemy Ci krótki poradnik jak korzystać z aplikacji",
    "tutorial_begin_title": "Witamy na ekranie tabeli OCR!"
  },
  "OnBoarding": {
    "Onboarding_1_text": "Po prostu go narysuj i {{PRODUCT}} pokaże Ci znak którego potrzebujesz",
    "Onboarding_1_title": "Nie znasz Kanji?",
    "Onboarding_2_text": "Z \"{{PRODUCT}}\" możesz szybko wyszukać słowa używając wbudowanego słownika lub użyj skrótu do słownika Internetowego.",
    "Onboarding_2_title": "Podejrzyj znaki i wyrazy",
    "Onboarding_3_text": "Użyj narzędzi analizy tekstu {{PRODUCT}}, aby dodać furiganę, spacje i inne, lub przetłumacz całe zdanie.",
    "Onboarding_3_title": "Nie wiesz jak przeczytać zdanie?",
    "Onboarding_4_text": "{{PRODUCT}} zawiera tabele Kanji i Kana, które pozwalają na efektywną naukę.",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_matrix": "Jestem w matrycy",
    "advanced_settings_number_search_procs": "Liczba procesów wyszukiwania (@:SettingsScreen.requires_restart)",
    "advanced_settings_number_search_procs_body": "Kiedy {{PRODUCT}} przeszukuje swoją bazę danych, używa wielu procesów. Zazwyczaj 2 to dobra wartość dla standardowej bazy danych dołączonej do {{PRODUCT}}. Jednak jeżeli doświadczasz spowolnienia podczas wyszukiwania w bazie danych, spróbuj użyć więcej procesów.",
    "advanced_settings_optimize_backend": "Backend",
    "advanced_settings_optimize_cancel": "Anuluj",
    "advanced_settings_optimize_latency": "Opóźnienie (ms)",
    "advanced_settings_optimize_nn": "Optymalizuj sieć neuronową",
    "advanced_settings_optimize_ok": "Ok",
    "advanced_settings_optimize_results": "Wyniki optymalizacji",
    ...
    "anki_allow_duplicates": "Zezwalaj na dodawanie duplikatów",
    "anki_allow_duplicates_explanation": "Duplikaty są sprawdzane poprzez porównanie pierwszego pola typu notatki {{PRODUCT}}. Dopasowaniem jest każda inna karta, która ma dokładnie taką samą zawartość w tym polu.\nDomyślnie jest to pole tłumaczenia. Dlatego jeśli zmodyfikujesz tłumaczenie, dodanie tej samej karty będzie możliwe ponownie. Można jednak zmienić kolejność pól w Anki. Każdy wpis słownika jest jednoznacznie identyfikowany przy użyciu pola \"{{PRODUCT}} link\" jako pierwszego pola.",
    ...
    "anki_include_example_translations": "Dołącz przykładowe tłumaczenia",
    ...
    "anki_number_of_examples": "Liczba przykładów do dodania",
    ...
    "dict_add_to_anki_from_search_results": "Dodaj do anki z wyników wyszukiwania",
    "dict_add_to_list_from_search_results": "Dodaj do listy z wyników wyszukiwania",
    "dict_base_form": "Forma bazowa terminu",
    "dict_base_form_description": "To ustawienie umożliwia 'dekonjugację' czasowników, przymiotników i copula. Kiedy jest włączone, {{PRODUCT}} próbuje przekonwertować szukany termin na jego formę podstawową. Na przykład, 食べます、食べられる、食べない wszystkie są konwertowane na 食べる.\nDla średnio zaawansowanych zalecane jest wyłączenie tego ustawienia.",
    "dict_convert_to_kana": "Termin przekonwertowany na kana",
    "dict_convert_to_kana_description": "Po włączeniu tego ustawienia, {{PRODUCT}} konwertuje każde wyszukiwane słowo na jednolitą reprezentację kana przed wyszukaniem go. Oznacza to, że zapytanie 'taberu' zostanie przekonwertowane na たべる i znajdzie 食べる, ale może to również prowadzić do niezamierzonych dopasowań.\n\nNa przykład wyszukiwanie 'man' zostanie przekonwertowane na まん i dlatego dopasuje 万 i angielskie słowo 'man'.\n\nUwaga: jest to ustawienie globalne i jest stosowane wszędzie tam, gdzie słownik jest używany",
    ...
    "dict_custom_query_format_title": "Niestandardowy format zapytania o obraz",
    ...
    "dict_matrix_word_speed": "Prędkość słowa matrycy",
    ...
    "dict_search_sorting_information": "Jak sortowane są wyniki wyszukiwania?",
    "dict_search_sorting_information_description_1": "To ustawienie pozwala dostosować sposób, w jaki {{PRODUCT}} sortuje wyniki wyszukiwania słownika, zmieniając priorytet sortowania (przeciągnij, aby zmienić kolejność) lub wyłączając modyfikację wyszukiwanego hasła (dotknij, aby wyłączyć).\nAby w pełni zrozumieć to ustawienie, przyjrzyjmy się, jak {{PRODUCT}} sortuje wyniki wyszukiwania przy użyciu przykładowego wyszukiwanego hasła \"shikunshi\" (zwróć uwagę, że jest ono zapisane w romaji). {{PRODUCT}} wyświetli wyniki wyszukiwania w oparciu o następujące kryteria, gdzie głębiej zagnieżdżone kryteria są mniej ważne niż wyższe.",
    "dict_search_sorting_information_description_2": "1. @:SettingsScreen.dict_term: wszystkie wpisy, które pasują do \"Wyszukiwanego hasła\", tj.: \"shikunshi\".\n    1. hasło słownikowe i wyszukiwane hasło są dokładnie takie same\n        1. kanji hasła są zgodne\n        2. pasuje odczyt\n        3. pasuje każde tłumaczenie / znaczenie\n    2. hasło słownikowe zaczyna się od wyszukiwanej frazy\n        1. kanji hasła pasuje\n        2. dopasowania czytania\n        3. pasuje dowolne tłumaczenie / znaczenie\n    3. hasło słownikowe zawiera wyszukiwany termin (na przykład: wyszukiwanie \"kun\" i pokazuje mi \"shi*kun*shi\")\n        1. dopasowanie kanji hasła\n        2. dopasowanie czytania\n        3. dopasowanie tłumaczenia / znaczenia\n2. @:SettingsScreen.dict_convert_to_kana: wszystkie wpisy pasujące do しくんし (przekonwertuj wyszukiwane hasło na kana, jeśli to możliwe)\n    1. podkryteria takie same jak powyżej\n    2. ...\n3. @:SettingsScreen.dict_base_form: wszystkie wpisy pasujące do しくむ (spróbuj znaleźć podstawową formę )\n    1. podkryteria takie same jak powyżej\n    2. ...",
    "dict_search_sorting_information_description_3": "To ustawienie pozwala ustawić priorytet sortowania kryteriów sortowania najwyższego poziomu.\nSzczegółowy opis ich znaczenia znajduje się w poniższych definicjach.",
    "dict_separate_search_results": "Kolejność sortowania wyników wyszukiwania (przeciągnij, aby zmienić kolejność, dotknij, aby wyłączyć)",
    "dict_show_wikipedia_definitions": "Pokaż definicje z wikipedii",
    "dict_show_word_freq": "Pokaż częstość występowania słów",
    "dict_show_word_freq_body": "{{PRODUCT}} używa częstotliwości słów, aby uszeregować swoje hasła słownikowe. Ta częstotliwość jest szacunkową oceną użycia słowa i jest oparta na różnych źródłach danych:\n\n* Wikipedia, reprezentująca tekst encyklopedyczny\n* Napisy, z OPUS OpenSubtitles 2018 i SUBTLEX\n* Tekst internetowy, z OSCAR\n* Twitter, reprezentujący media społecznościowe o krótkiej formie\n* Reddit, reprezentujący potencjalnie dłuższe komentarze internetowe\n\nLiczba pokazana w {{PRODUCT}} jest wariacją na temat rzeczywistej częstotliwości słów zwaną [Częstotliwość Zipfa](https://en.wikipedia.org/wiki/Zipf%27s_law), która ma na celu zwrócenie częstotliwości słów w przyjaznej dla człowieka skali logarytmicznej. Częstotliwość Zipfa dla danego słowa jest logarytmem podstawy 10 z liczby jego wystąpień na miliard słów. Na przykład słowo o wartości Zipf 6 pojawia się raz na tysiąc słów, a słowo o wartości Zipf 3 pojawia się raz na milion słów.\nRozsądne wartości Zipf są pomiędzy 0 a 8, ale minimalna wartość Zipf występująca w {{PRODUCT}} to 1.0. Używamy 0 jako domyślnej wartości Zipf dla słów, które nie pojawiają się w źródłach danych, chociaż powinno to oznaczać jedno wystąpienie na miliard słów.\n[Czytaj więcej...](https://github.com/rspeer/wordfreq)",
    "dict_term": "Wyszukiwane hasło",
    "dict_term_description": "Wyszukiwane hasło jest dokładnie takie, jak wpisał je użytkownik.",
    ...
    "misc_font_size_scale": "Współczynnik skalowania rozmiaru czcionki",
    "misc_language": "język (@:SettingsScreen.restarts_app)",
    "misc_settings_always_save_window_position": "Zapisywanie pozycji okna podczas przenoszenia",
    "misc_settings_always_save_window_size": "Zapisywanie rozmiaru okna przy zmianie rozmiaru",
    "misc_settings_window_size": "Zapisywanie bieżącego rozmiaru i położenia okna",
    "misc_sharing_pattern": "Schemat używany podczas udostępniania treści.",
    ...
    "time_tracking_current_ratio_text": "Zarabia ~{CURRENT_RATIO} min przerwy / godzinę",
    "time_tracking_enabled": "Śledzenie czasu włączone",
    "time_tracking_session_legnth": "Długość jednej sesji",
    "time_tracking_session_length_description": "Długość jednej sesji",
    ...
    "word_lists_languages_to_include_in_export": "Języki uwzględniane podczas eksportowania",
    ...
    "word_lists_quick_add_lists": "Lista słów do szybkiego dodania:",
    "word_lists_readd_defaults": "Dodaj folder domyślny",
    "word_lists_screensaver_auto_show": "Wygaszacz ekranu: Automatyczny start wygaszacza ekranu",
  ...
  "TimeTrackingScreen": {
    ...
    "add_category_hint": "Wprowadź nazwę kategorii (np. Kanji).",
    "add_tag": "Dodaj tag",
    "add_tag_hint": "Wprowadź nazwę tagu (np. N2)",
    "break_caps": "BREAK",
    "cancel": "Anuluj",
    "categories": "Kategoria",
    "end_session": "Koniec sesji",
    "pause": "Pauza",
    "ready_caps": "GOTOWY",
    "resume": "Wznowienie",
  ...
  "WordListsScreen": {
    ...
    "export_csv_progress": "Tworzenie CSV, proszę czekać...",
    "export_images": "Eksport obrazów",
    "export_images_progress": "Renderowanie obrazów, proszę czekać...",
    "export_pdf": "Eksportuj PDF",
    "export_pdf_progress": "Tworzenie pliku PDF, proszę czekać...",
...
static const Map<String,dynamic> _rus = {
  ...
  "ClipboardScreen": {
    "title": "Буфер обмена",
    "tutorial_android_limitation": "На Android этот экран не может автоматически считывать буфер обмена в фоновом режиме. Необходимо, чтобы приложение находилось на переднем плане. На iOS можно разрешить {{PRODUCT}} считывать буфер обмена в настройках. В этом случае приложение не будет постоянно запрашивать разрешение на вставку. Приносим извинения за доставленные неудобства.",
    ...
    "tutorial_explanation": "Просто скопируйте текст, и {{PRODUCT}} покажет словарные статьи и многое другое!",
    "tutorial_pin_button": "Эта кнопка заставляет {{PRODUCT}} отображаться всегда поверх других окон. Кроме того, размер уменьшается, а рамка и панель приложений скрываются. Благодаря этому {{PRODUCT}} можно использовать в качестве помощника для чтения поверх любого другого приложения."
  },
  "DictionaryScreen": {
    "example_tab": "Пример",
    ...
    "word_tab_menu_quick_add_to_list": "Быстрое добавление в список",
    "word_tab_menu_quick_add_to_list_no_lists_selected": "Не выбраны списки для быстрой отправки. Пожалуйста, сделайте это в настройках.",
    "word_tab_menu_quick_send_to_anki": "Быстрая отправка в Anki",
  ...
  "HomeScreen": {
    "account_page_char_input_error": "Введите ровно один японский символ.",
    "account_page_char_updated_profile": "Успешно обновленный профиль!",
    ...
    "account_page_generic_error": "Возникла непредвиденная ошибка",
    "account_page_link_sent": "Проверьте свою электронную почту, чтобы получить ссылку для входа!",
    "account_page_link_to_sponsor": "Связь с учетной записью спонсора",
    ...
    "account_page_user_name_input_error": "Имя пользователя должно содержать от 1 до 10 символов.",
  ...
  "InitScreen": {
    ...
    "RatePopup_text": "Вам нравится \"{{PRODUCT}}\"?\nЕсли это так, то оценка была бы замечательной и очень помогла бы этому проекту!",
    "complete_log": "полный журнал",
    "downgrade_warning": "Вы понизили рейтинг {{PRODUCT}}! Это действие не поддерживается и с большой вероятностью приведет к повреждению сохраненных данных или даже к полному отказу от использования {{PRODUCT}}! Пожалуйста, сбросьте все данные в разделе \"настройки -> расширенные настройки\" и перезапустите приложение.",
    ...
    "download_popup_permission": "Прежде чем вы сможете приступить к работе, нам необходимо загрузить несколько файлов (~{DOWNLOAD_SIZE}MB). Это произойдет только один раз. Пожалуйста, убедитесь, что у вас стабильное интернет-соединение, и не закрывайте приложение, пока идет загрузка.",
    "new_version_available_heading": "Доступна новая версия!",
    "new_version_available_text": "Вышла новая версия {{PRODUCT}}!",
    "new_version_comparison": "Вы используете {VERSION_NUMBER}, самая новая версия - {NEW_VERSION_NUMBER}.",
    "new_versions_available_text": "Доступны {NEW_VERSIONS} новые версии {{PRODUCT}}!",
    "rate_this_app": "Тариф",
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Чтобы начать использовать {{PRODUCT}} и Anki, вам нужно нажать кнопку ниже. Она проверит правильность ваших настроек.\n\nЕсли вы получите сообщение об успехе, {{PRODUCT}} и Anki подключены, и вы можете начать использовать {{PRODUCT}} с Anki.\nЕсли вы получите сообщение об ошибке, пожалуйста, следуйте инструкциям, приведенным в сообщении, и нажмите кнопку снова.\nБез сообщения об ошибке {{PRODUCT}} не сможет отправлять карточки в Anki. Поэтому убедитесь, что вы нажали кнопку ниже и получили сообщение об успехе. Вы также можете проверить, успешно ли прошла настройка, в разделе Настройки → Anki.",
    "anki_connection_test_title": "Испытательная установка",
    "anki_setup_android_text": "Вам необходимо установить [AnkidDroid](https://play.google.com/store/apps/details?id=com.ichi2.anki&hl=en&gl=US) и при запросе предоставить {{PRODUCT}} разрешение на взаимодействие с Anki.",
    "anki_setup_android_title": "Android",
    ...
    "anki_setup_intro": "{{PRODUCT}} можно использовать для отправки заметок в Anki. Для этого каждая платформа требует различных настроек.",
    "anki_setup_ios_text": "Настройка на iOS немного затруднена, поскольку AnkiMobile не позволяет добавлять типы нот, что возможно на Android и настольных компьютерах. Поэтому вам нужно импортировать колоду Anki с типом нот {{PRODUCT}} (вам не нужно делать этого, если вы экспортировали карты из {{PRODUCT}} в Anki на другом устройстве).\n\n1. Установите [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Скачайте готовые колоды Anki отсюда [https://github.com/CaptainDario/{{PRODUCT}}-Dependencies/releases/download/v3.4.6/{{PRODUCT}}.apkg].\n3. Нажмите на загруженный файл, откроется диалог импорта AnkiMobile\n4. Импортируйте колоду\n5. В ответ на запрос разрешите {{PRODUCT}} взаимодействовать с AnkiMobile и читать ваш буфер обмена",
    "anki_setup_ios_title": "iOS",
    ...
    "anki_test_connection_note_type_not_available": "Тип нот {{PRODUCT}} недоступен в Anki! Вы можете добавить его вручную, импортировав готовую колоду, о которой говорится в руководстве по настройке iOS.",
    "anki_test_connection_success": "Вы подключены к Anki! 🎉",
    "anki_title": "Anki",
    "deep_links_text": "Глубокие ссылки - это способ прямой ссылки на содержимое приложения. {{PRODUCT}} предоставляет для этого две схемы {{PRODUCT}}:// и http(s)://{{PRODUCT}}.app/app. Используя эту возможность, можно, например, открыть поиск по словарю при нажатии на эту ссылку {{PRODUCT}}://dictionary?search=食べる. Все поддерживаемые ссылки см. в разделе [{{PRODUCT}}.app/deep-links](https://{{PRODUCT}}.app/deep-links)",
    "deep_links_title": "Deep Links",
    "dict_examples_title": "Примеры",
    "dict_kanji_animation_text": "{{PRODUCT}} может показывать анимированные диаграммы порядка следования штрихов для большинства кандзи/кана. Этими анимациями можно управлять различными способами.\nДвойное нажатие приводит к различным результатам в зависимости от текущего состояния анимации. Если анимация воспроизводится в данный момент, это приведет к ее приостановке. Аналогично, если анимация в данный момент приостановлена, она продолжит воспроизведение. Наконец, если анимация завершилась, двойное нажатие перезапустит ее с самого начала.\nПроводя пальцем по кандзи, можно управлять ходом анимации. Пролистывание влево приводит к перемотке анимации назад, а пролистывание вправо - к ее продвижению вперед.",
    ...
    "misc_drawer_reorder_text": "Чтобы наилучшим образом удовлетворить потребности каждого пользователя, {{PRODUCT}} позволяет изменять порядок элементов в главном навигационном меню. Просто нажмите на любой пункт меню, чтобы перетащить его в нужное место.",
    "misc_title": "Разное",
    "text_paste_button_text": "Нажатие этой кнопки вставляет содержимое буфера обмена.\nДлительное нажатие этой кнопки переключает режим автоматической вставки и всегда вставляет содержимое буфера обмена при его изменении.",
    "text_paste_button_title": "Кнопка \"Вставить",
  ...
  "OcrScreen": {
    "title": "OCR",
    "tutorial_begin_text": "Мы покажем вам краткое руководство, чтобы вы могли начать.",
    "tutorial_begin_title": "Добро пожаловать на экран таблицы OCR!"
  },
  "OnBoarding": {
    "Onboarding_1_text": "Просто нарисуйте его, и \"{{PRODUCT}}\" покажет нужный вам иероглиф.",
    "Onboarding_1_title": "Вы не знаете ни одного кандзи?",
    "Onboarding_2_text": "С помощью \"{{PRODUCT}}\" вы можете быстро искать слова по встроенному словарю или в Интернете.",
    "Onboarding_2_title": "Поиск символов и слов",
    "Onboarding_3_text": "Используйте инструменты анализа текста {{PRODUCT}} для добавления фуриганы, пробелов и прочего или переведите предложение целиком.",
    "Onboarding_3_title": "Не умеете читать предложения?",
    "Onboarding_4_text": "{{PRODUCT}} содержит таблицы кандзи и кана, позволяющие эффективно их изучать.",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_number_search_procs_body": "Когда {{PRODUCT}} ищет в своей базе данных, он использует несколько процессов. Обычно 2 - это хорошее значение для стандартной базы данных, включенной в {{PRODUCT}}. Однако, если вы испытываете замедления при поиске в базе данных, попробуйте использовать больше процессов.",
    "advanced_settings_optimize_backend": "Бэкэнд",
    "advanced_settings_optimize_cancel": "Отмена",
    "advanced_settings_optimize_latency": "Задержка (мс)",
    "advanced_settings_optimize_nn": "Оптимизация нейронных сетей",
    "advanced_settings_optimize_ok": "Хорошо",
    "advanced_settings_optimize_results": "Результаты оптимизации",
    ...
    "anki_allow_duplicates": "Разрешить добавление дубликатов",
    "anki_allow_duplicates_explanation": "Дубликаты проверяются путем сравнения первого поля типа нот {{PRODUCT}}. Совпадением считается любая другая карточка, имеющая точно такое же содержимое в этом поле.\nПо умолчанию это поле перевода. Поэтому, если вы измените перевод, добавление той же карточки будет снова возможно. Однако вы можете изменить порядок полей в Anki. Каждая словарная статья идентифицируется однозначно, если в качестве первого поля используется поле \"Ссылка на дакандзи\".",
    ...
    "anki_include_example_translations": "Включите примеры переводов",
    ...
    "anki_number_of_examples": "Количество примеров для добавления",
    ...
    "dict_add_to_anki_from_search_results": "Добавить в anki из результатов поиска",
    "dict_add_to_list_from_search_results": "Добавить в список из результатов поиска",
    "dict_base_form": "Форма основания термина",
    "dict_base_form_description": "Этот параметр включает 'деконъюгацию' глаголов, прилагательных и копул. Когда она включена, {{PRODUCT}} пытается преобразовать поисковый термин в его базовую форму. Например, 食べます、食べられる、食べない все преобразуется в 食べる.\nДля учащихся среднего уровня рекомендуется отключить эту настройку.",
    "dict_convert_to_kana": "Термин, преобразованный в кану",
    "dict_convert_to_kana_description": "При включении этой настройки {{PRODUCT}} преобразует любой поисковый запрос в унифицированное представление каны, прежде чем искать его. Это означает, что запрос 'taberu' будет преобразован в たべる и будет найден 食べる, но это также может привести к непреднамеренным совпадениям.\n\nНапример, запрос 'man' будет преобразован в まん и, следовательно, найдет 万 и английское слово 'man'.\n\nПримечание: это глобальная настройка, которая применяется везде, где используется словарь",
    ...
    "dict_custom_query_format_title": "Пользовательский формат запроса изображения",
    ...
    "dict_matrix_word_speed": "Скорость матричного слова",
    ...
    "dict_search_sorting_information": "Как сортируются результаты поиска?",
    "dict_search_sorting_information_description_1": "Эта настройка позволяет настроить сортировку результатов поиска по словарям, изменив приоритет сортировки (перетащите, чтобы изменить порядок) или отключив модификацию поисковых терминов (нажмите, чтобы отключить)\\.\nЧтобы полностью понять эту настройку, давайте посмотрим, как {{PRODUCT}} сортирует результаты поиска, используя пример поискового запроса \"shikunshi\" (обратите внимание, что он написан на ромадзи). {{PRODUCT}} отображает результаты поиска на основе следующих критериев, где более глубокие вложенные критерии менее важны, чем более высокие.",
    "dict_search_sorting_information_description_2": "1. @:SettingsScreen.dict_term: все словарные статьи, которые соответствуют \"Термину поиска\", как есть, т.е.: \"shikunshi\"\n    1. словарная статья и поисковый запрос полностью совпадают\n        1. кандзи словарной статьи совпадают\n        2. чтение совпадает\n        3. совпадает любой перевод / значение\n    2. словарная статья начинается с поискового термина\n        1. кандзи словарной статьи совпадают\n        2. совпадения для чтения\n        3. совпадает любой перевод / значение\n    3. словарная статья содержит поисковый термин (например, при поиске \"kun\" выдается \"shi*kun*shi\")\n        1. совпадение кандзи в словарной статье\n        2. совпадения чтения\n        3. совпадение перевода / значения\n2. @:SettingsScreen.dict_convert_to_kana: все записи, которые соответствуют しくんし (преобразование поискового запроса в кану, если возможно)\n    1. подкритерии те же, что и выше\n    2. ...\n3. @:SettingsScreen.dict_base_form: все записи, которые соответствуют しくむ (попытаться найти базовую форму )\n    1. подкритерии те же, что и выше\n    2. ...",
    "dict_search_sorting_information_description_3": "Этот параметр позволяет установить приоритет сортировки для критериев сортировки верхнего уровня.\nДля подробного описания их значения ознакомьтесь с определениями ниже.",
    "dict_separate_search_results": "Порядок сортировки результатов поиска (перетащите, чтобы изменить порядок, коснитесь, чтобы отключить)",
    "dict_show_wikipedia_definitions": "Показать определения из Википедии",
    "dict_show_word_freq": "Показать частоту слов",
    "dict_show_word_freq_body": "{{PRODUCT}} использует частоту слов для ранжирования своих словарных статей. Эта частота слов является оценкой употребления слова и основана на различных источниках данных:\n\n* Википедия, представляющая энциклопедический текст\n* субтитры, из OPUS OpenSubtitles 2018 и SUBTLEX\n* веб-текст, из OSCAR\n* Twitter, представляющий короткие формы социальных медиа\n* Reddit, представляющий потенциально длинные комментарии в Интернете\n\nЧисло, показанное в {{PRODUCT}}, является вариацией фактической частоты слов, называемой [Zipf frequency](https://en.wikipedia.org/wiki/Zipf%27s_law), целью которой является возвращение частоты слов в удобной для человека логарифмической шкале. Частота Zipf слова - это логарифм числа раз, которое оно встречается на миллиард слов. Например, слово со значением Zipf 6 появляется один раз на тысячу слов, а слово со значением Zipf 3 - один раз на миллион слов.\nРазумные значения Zipf находятся в диапазоне от 0 до 8, но минимальное значение Zipf, встречающееся в {{PRODUCT}}, равно 1,0. Мы используем 0 в качестве значения Zipf по умолчанию для слов, которые не встречаются в источниках данных, хотя это должно означать одно появление на миллиард слов.\n[Read more...](https://github.com/rspeer/wordfreq)",
    "dict_term": "Поисковый термин",
    "dict_term_description": "Поисковый запрос в точности соответствует тому, что набрал пользователь.",
    ...
    "misc_font_size_scale": "Коэффициент масштабирования размера шрифта",
    "misc_language": "язык (@:SettingsScreen.restarts_app)",
    "misc_settings_always_save_window_position": "Сохранение позиции окна при перемещении",
    "misc_settings_always_save_window_size": "Сохранение размера окна при изменении размера",
    "misc_settings_window_size": "Сохранить текущий размер и положение окна",
    "misc_sharing_pattern": "Схема, которую нужно использовать при совместном использовании контента.",
    ...
    "time_tracking_current_ratio_text": "Зарабатывает ~{CURRENT_RATIO} мин. перерыв / час",
    "time_tracking_enabled": "Включен учет рабочего времени",
    "time_tracking_session_legnth": "Продолжительность одного сеанса",
    "time_tracking_session_length_description": "Продолжительность одного сеанса",
    ...
    "word_lists_languages_to_include_in_export": "Языки, которые необходимо включить при экспорте",
    ...
    "word_lists_quick_add_lists": "Быстро добавьте список слов:",
    "word_lists_readd_defaults": "Добавьте папку по умолчанию",
    "word_lists_screensaver_auto_show": "Скринсейвер: Автоматический запуск заставки",
  ...
  "TimeTrackingScreen": {
    ...
    "add_category_hint": "Введите название категории (например, Kanji).",
    "add_tag": "Добавить метку",
    "add_tag_hint": "Введите имя метки (например, N2).",
    "break_caps": "BREAK",
    "cancel": "Отмена",
    "categories": "Категория",
    "end_session": "Окончание сеанса",
    "pause": "Пауза",
    "ready_caps": "ГОТОВО",
    "resume": "Резюме",
  ...
  "WordListsScreen": {
    ...
    "export_csv_progress": "Создание CSV, пожалуйста, подождите...",
    "export_images": "Экспорт изображений",
    "export_images_progress": "Рендеринг изображений, пожалуйста, подождите...",
    "export_pdf": "Экспорт PDF",
    "export_pdf_progress": "Создание PDF, пожалуйста, подождите...",
...
static const Map<String,dynamic> _fra = {
  ...
  "ClipboardScreen": {
    ...
    "tutorial_explanation": "Copiez simplement un texte et {{PRODUCT}} affichera les entrées du dictionnaire et bien plus encore !",
    "tutorial_pin_button": "Ce bouton permet d'afficher {{PRODUCT}} toujours au-dessus des autres fenêtres. De plus, la taille est réduite et le cadre et la barre d'application sont cachés. Grâce à cela, {{PRODUCT}} peut être utilisé comme aide à la lecture au-dessus de n'importe quelle autre application."
  },
  "DictionaryScreen": {
    "example_tab": "Exemple",
    ...
    "word_tab_menu_quick_add_to_list": "Ajouter rapidement à la liste",
    "word_tab_menu_quick_add_to_list_no_lists_selected": "Aucune liste n'a été sélectionnée pour l'envoi rapide. Veuillez le faire dans les paramètres.",
    "word_tab_menu_quick_send_to_anki": "Envoi rapide vers Anki",
  ...
  "HomeScreen": {
    "account_page_char_input_error": "Saisir exactement un caractère japonais.",
    "account_page_char_updated_profile": "Mise à jour du profil réussie !",
    ...
    "account_page_generic_error": "Une erreur inattendue s'est produite",
    "account_page_link_sent": "Vérifiez votre e-mail pour obtenir le lien de connexion !",
    "account_page_link_to_sponsor": "Lien avec le compte du sponsor",
    ...
    "account_page_user_name_input_error": "Le nom d'utilisateur doit comporter entre 1 et 10 caractères.",
  ...
  "InitScreen": {
    ...
    "RatePopup_text": "Est-ce que vous aimez \"{{PRODUCT}}\" ?\nSi c'est le cas, une évaluation serait géniale et cela aiderait beaucoup ce projet !",
    "complete_log": "journal complet",
    "downgrade_warning": "Vous avez dégradé {{PRODUCT}} ! Cette action n'est pas supportée et risque de détruire vos données stockées ou même de rendre {{PRODUCT}} complètement inutilisable ! Veuillez réinitialiser toutes les données dans \"Paramètres -> Paramètres avancés\" et redémarrer l'application.",
    ...
    "download_popup_permission": "Nous devons télécharger certains fichiers avant que vous puissiez commencer (~{DOWNLOAD_SIZE}MB). Cela ne se produira qu'une seule fois. Assurez-vous d'avoir une connexion internet stable et ne fermez pas l'application pendant que le téléchargement est en cours.",
    ...
    "new_versions_available_text": "Il y a {NEW_VERSIONS} nouvelles versions de {{PRODUCT}} disponibles !",
    "rate_this_app": "Taux",
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Pour commencer à utiliser {{PRODUCT}} et Anki, vous devez appuyer sur le bouton ci-dessous. Il vérifiera que votre configuration est correcte.\n\nSi vous obtenez un message de succès, {{PRODUCT}} et Anki sont connectés et vous pouvez commencer à utiliser {{PRODUCT}} avec Anki.\nSi vous obtenez un message d'erreur, veuillez suivre les instructions données dans le message et appuyez à nouveau sur le bouton par la suite.\nSans message de succès, {{PRODUCT}} ne pourra pas envoyer de cartes à Anki. Assurez-vous donc que vous appuyez sur le bouton ci-dessous et que vous obtenez un message de succès. Vous pouvez également vérifier si l'installation s'est déroulée correctement dans la rubrique Paramètres → Anki.",
    "anki_connection_test_title": "Configuration du test",
    "anki_setup_android_text": "Vous devez avoir installé [AnkidDroid](https://play.google.com/store/apps/details?id=com.ichi2.anki) et, lorsque cela vous est demandé, donner à {{PRODUCT}} la permission d'interagir avec Anki.",
    "anki_setup_android_title": "Android",
    ...
    "anki_setup_intro": "{{PRODUCT}} peut être utilisé pour envoyer des notes à Anki. Pour cela, chaque plateforme nécessite une configuration différente.",
    "anki_setup_ios_text": "La configuration sur iOS est un peu lourde car AnkiMobile ne permet pas d'ajouter des types de notes, ce qui est possible sur Android et desktop. Vous devez donc importer un jeu Anki avec le type de note {{PRODUCT}} (vous n'avez pas besoin de faire cela si vous avez exporté des cartes de {{PRODUCT}} vers Anki sur un autre appareil).\n\n1. Installez [AnkiMobile] (https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Téléchargez le jeu de cartes Anki pré-fait à partir de [ici](https://github.com/CaptainDario/{{PRODUCT}}-Dependencies/releases/download/v3.4.6/{{PRODUCT}}.apkg)\n3. Tapez sur le fichier téléchargé, cela ouvrira la boîte de dialogue d'importation d'AnkiMobile.\n4. Importez le jeu\n5. Lorsque cela vous est demandé, autorisez {{PRODUCT}} à communiquer avec AnkiMobile et à lire votre presse-papiers.",
    "anki_setup_ios_title": "iOS",
    ...
    "anki_test_connection_note_type_not_available": "Le type de note {{PRODUCT}} n'est pas disponible dans Anki ! Vous pouvez l'ajouter manuellement en important le jeu de notes pré-fabriqué mentionné dans le guide d'installation iOS.",
    "anki_test_connection_success": "Vous êtes connecté à Anki ! 🎉",
    "anki_title": "Anki",
    "deep_links_text": "Les liens profonds sont un moyen d'accéder directement au contenu d'une application. {{PRODUCT}} propose deux schémas pour cela : {{PRODUCT}}:// et http(s)://{{PRODUCT}}.app/app. En utilisant cette fonctionnalité, vous pouvez par exemple ouvrir la recherche dans le dictionnaire en tapant sur ce lien {{PRODUCT}}://dictionary?search=食べる. Pour tous les liens supportés, voir [{{PRODUCT}}.app/deep-links](https://{{PRODUCT}}.app/deep-links)",
    "deep_links_title": "Deep Links",
    "dict_examples_title": "Exemples",
    "dict_kanji_animation_text": "{{PRODUCT}} peut afficher des diagrammes animés de l'ordre des traits de la plupart des Kanji / Kana inclus. Ces animations peuvent être contrôlées de différentes manières.\nLe double tapotement a des résultats différents en fonction de l'état actuel de l'animation. Si l'animation est en cours de lecture, elle sera mise en pause. De même, lorsque l'animation est en cours de pause, la lecture se poursuit. Enfin, si l'animation est terminée, le double tapotement redémarre l'animation depuis le début.\nIl est possible de contrôler la progression de l'animation en balayant le kanji. Un glissement vers la gauche permet de rembobiner l'animation, tandis qu'un glissement vers la droite permet d'avancer l'animation.",
    ...
    "misc_drawer_reorder_text": "Pour s'adapter au mieux à chaque utilisateur, {{PRODUCT}} vous permet de réorganiser les éléments du menu de navigation principal. Il suffit d'appuyer sur n'importe quel élément du menu pour le faire glisser à l'endroit désiré.",
    "misc_title": "Divers",
    "text_paste_button_text": "En appuyant sur ce bouton, vous collez le contenu du presse-papiers.\nUne pression prolongée sur ce bouton permet de passer au collage automatique et de toujours coller le contenu du presse-papiers lorsqu'il est modifié.",
    "text_paste_button_title": "Bouton coller",
  ...
  "OcrScreen": {
    "title": "OCR",
    "tutorial_begin_text": "Nous allons vous montrer un tutoriel rapide pour vous aider à démarrer.",
    "tutorial_begin_title": "Bienvenue sur l'écran de table de l'OCR !"
  },
  "OnBoarding": {
    "Onboarding_1_text": "Il suffit de le dessiner et \"{{PRODUCT}}\" affichera le caractère dont vous avez besoin.",
    "Onboarding_1_title": "Vous ne connaissez pas un Kanji ?",
    "Onboarding_2_text": "Avec \"{{PRODUCT}}\", vous pouvez rapidement rechercher des mots en utilisant le dictionnaire intégré ou sur Internet.",
    "Onboarding_2_title": "Recherche de caractères et de mots",
    "Onboarding_3_text": "Utilisez les outils d'analyse de texte de {{PRODUCT}} pour ajouter des furigana, des espaces et autres ou pour traduire la phrase entière.",
    "Onboarding_3_title": "Vous ne savez pas comment lire une phrase ?",
    "Onboarding_4_text": "{{PRODUCT}} contient des tableaux de Kanji et de Kana pour vous permettre de les étudier efficacement.",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_matrix": "Je suis dans la matrice",
    "advanced_settings_number_search_procs": "Nombre de processus de recherche (@:SettingsScreen.requires_restart)",
    "advanced_settings_number_search_procs_body": "Lorsque {{PRODUCT}} recherche dans sa base de données, il utilise plusieurs processus. Habituellement, 2 est une bonne valeur pour la base de données standard fournie avec {{PRODUCT}}. Cependant, si vous constatez des ralentissements lors des recherches dans la base de données, essayez d'utiliser plus de processus.",
    "advanced_settings_optimize_backend": "Backend",
    "advanced_settings_optimize_cancel": "Annuler",
    "advanced_settings_optimize_latency": "Temps de latence (ms)",
    "advanced_settings_optimize_nn": "Optimiser les réseaux neuronaux",
    "advanced_settings_optimize_ok": "Ok",
    "advanced_settings_optimize_results": "Résultats de l'optimisation",
    ...
    "anki_allow_duplicates": "Permettre l'ajout de doublons",
    "anki_allow_duplicates_explanation": "Les doublons sont vérifiés en comparant le premier champ du type de note {{PRODUCT}}. Une correspondance est une carte sur deux qui a exactement le même contenu dans ce champ.\nPar défaut, il s'agit du champ de traduction. Par conséquent, si vous modifiez la traduction, il sera à nouveau possible d'ajouter la même carte. Vous pouvez toutefois modifier l'ordre des champs dans Anki. Chaque entrée du dictionnaire est identifiée de manière unique en utilisant le champ \"{{PRODUCT}} link\" comme premier champ.",
    ...
    "anki_include_example_translations": "Inclure des exemples de traductions",
    ...
    "anki_number_of_examples": "Nombre d'exemples à ajouter",
    ...
    "dict_add_to_anki_from_search_results": "Ajouter à anki à partir des résultats de recherche",
    "dict_add_to_list_from_search_results": "Ajouter à la liste à partir des résultats de la recherche",
    "dict_base_form": "Forme de base du terme",
    "dict_base_form_description": "Ce paramètre active la \"déconjugaison\" des verbes, des adjectifs et des copules. Lorsqu'il est activé, {{PRODUCT}} essaie de convertir le terme de recherche dans sa forme de base. Par exemple, 食べます、食べられる、食べない all est converti en 食べる.\nPour les apprenants de niveau intermédiaire, il est recommandé de désactiver ce paramètre.",
    "dict_convert_to_kana": "Terme converti en kana",
    "dict_convert_to_kana_description": "Lorsque ce paramètre est activé, {{PRODUCT}} convertit tout terme de recherche en une représentation kana uniforme avant de le rechercher. Cela signifie que la requête 'taberu' sera convertie en たべる et trouvera 食べる, mais cela peut également conduire à des correspondances inattendues.\n\nPar exemple, la recherche \"man\" sera convertie en まん et correspondra donc à 万 et au mot anglais \"man\".\n\nRemarque : il s'agit d'un paramètre global qui s'applique partout où le dictionnaire est utilisé.",
    ...
    "dict_custom_query_format_title": "Format de requête d'image personnalisé",
    ...
    "dict_matrix_word_speed": "Vitesse des mots de la matrice",
    ...
    "dict_search_sorting_information": "Comment les résultats de la recherche sont-ils triés ?",
    "dict_search_sorting_information_description_1": "Ce paramètre vous permet de personnaliser la façon dont {{PRODUCT}} trie les résultats de recherche dans les dictionnaires en modifiant la priorité de tri (faites glisser pour réorganiser) ou en désactivant la modification des termes de recherche (touchez pour désactiver).\nPour bien comprendre ce paramètre, regardons comment {{PRODUCT}} trie les résultats de recherche en utilisant l'exemple du terme de recherche \"shikunshi\" (notez qu'il est écrit en romaji). {{PRODUCT}} affichera les résultats de la recherche en fonction des critères suivants, les critères les plus profonds étant moins importants que les plus élevés.",
    "dict_search_sorting_information_description_2": "1. @:SettingsScreen.dict_term : toutes les entrées qui correspondent au \"terme de recherche\" tel quel, c'est-à-dire : \"shikunshi\"\n    1. l'entrée du dictionnaire et le terme de recherche sont exactement les mêmes\n        1. les kanji de l'entrée correspondent\n        2. la lecture correspond\n        3. toute traduction / signification correspond\n    2. l'entrée du dictionnaire commence par le terme recherché\n        1. correspondance des kanji de l'entrée\n        2. résultats de lecture\n        3. toute traduction / correspondance de sens\n    3. l'entrée du dictionnaire contient le terme recherché quelque part (par exemple : je cherche \"kun\" et j'obtiens \"shi*kun*shi\")\n        1. les kanji de l'entrée correspondent\n        2. correspondance de la lecture\n        3. toute traduction / correspondance de sens\n2. @:SettingsScreen.dict_convert_to_kana : toutes les entrées qui correspondent à しくんし (convertir le terme de recherche en kana si possible)\n    1. sous-critères identiques aux précédents\n    2. ...\n3. @:SettingsScreen.dict_base_form : toutes les entrées qui correspondent à しくむ (essayer de trouver la forme de base de )\n    1. sous-critères identiques aux précédents\n    2. ...",
    "dict_search_sorting_information_description_3": "Ce paramètre permet de définir la priorité de tri des critères de tri de premier niveau.\nPour une description détaillée de leur signification, veuillez lire les définitions ci-dessous.",
    "dict_separate_search_results": "Ordre de tri des résultats de la recherche (faire glisser pour réorganiser, toucher pour désactiver)",
    "dict_show_wikipedia_definitions": "Afficher les définitions de wikipedia",
    "dict_show_word_freq": "Afficher la fréquence des mots",
    "dict_show_word_freq_body": "Le {{PRODUCT}} utilise la fréquence des mots pour classer les entrées de son dictionnaire. Cette fréquence de mots est une estimation de l'utilisation d'un mot et est basée sur différentes sources de données :\n\n* Wikipédia, qui représente un texte encyclopédique\n* Sous-titres, provenant d'OPUS OpenSubtitles 2018 et SUBTLEX\n* Texte Web, à partir d'OSCAR\n* Twitter, qui représente les médias sociaux de courte durée\n* Reddit, représentant des commentaires Internet potentiellement plus longs\n\nLe nombre indiqué dans {{PRODUCT}} est une variante de la fréquence réelle des mots appelée [fréquence de Zipf] (https://en.wikipedia.org/wiki/Zipf%27s_law) qui vise à restituer la fréquence des mots sur une échelle logarithmique conviviale. La fréquence de Zipf d'un mot est le logarithme en base 10 du nombre de fois qu'il apparaît par milliard de mots. Un mot ayant une valeur de Zipf de 6 apparaît une fois pour mille mots, par exemple, et un mot ayant une valeur de Zipf de 3 apparaît une fois pour un million de mots.\nLes valeurs raisonnables de Zipf se situent entre 0 et 8, mais la valeur minimale de Zipf apparaissant dans le {{PRODUCT}} est de 1,0. Nous utilisons 0 comme valeur Zipf par défaut pour les mots qui n'apparaissent pas dans les sources de données, bien que cela signifie une occurrence par milliard de mots.\n[Lire la suite...] (https://github.com/rspeer/wordfreq)",
    "dict_term": "Terme de recherche",
    "dict_term_description": "Le terme recherché est exactement celui que l'utilisateur a tapé.",
    ...
    "misc_font_size_scale": "Facteur d'échelle de la taille de la police",
    "misc_language": "langue (@:SettingsScreen.restarts_app)",
    "misc_settings_always_save_window_position": "Sauvegarde de la position de la fenêtre lors d'un déplacement",
    "misc_settings_always_save_window_size": "Sauvegarde de la taille de la fenêtre lors du redimensionnement",
    "misc_settings_window_size": "Sauvegarde de la taille et de la position actuelles de la fenêtre",
    "misc_sharing_pattern": "Schéma à utiliser lors du partage de contenu.",
    ...
    "time_tracking_current_ratio_text": "Gagne ~{CURRENT_RATIO} min break / heure",
    "time_tracking_enabled": "Suivi du temps activé",
    "time_tracking_session_legnth": "Durée d'une session",
    "time_tracking_session_length_description": "Durée d'une session",
    ...
    "word_lists_languages_to_include_in_export": "Langues à inclure dans l'exportation",
    ...
    "word_lists_quick_add_lists": "Liste(s) de mots à ajouter rapidement :",
    "word_lists_readd_defaults": "Ajouter le dossier par défaut",
    "word_lists_screensaver_auto_show": "Économiseur d'écran : Démarrage automatique de l'économiseur d'écran",
  ...
  "TimeTrackingScreen": {
    ...
    "add_category_hint": "Saisir le nom de la catégorie (par exemple Kanji)",
    "add_tag": "Ajouter une étiquette",
    "add_tag_hint": "Saisir le nom de l'étiquette (par exemple N2)",
    "break_caps": "RUPTURE",
    "cancel": "Annuler",
  ...
  "WordListsScreen": {
    ...
    "export_csv_progress": "Création du CSV, veuillez patienter...",
    "export_images": "Exporter des images",
    "export_images_progress": "Rendu des images, veuillez patienter...",
    "export_pdf": "Exporter le PDF",
    "export_pdf_progress": "Création du PDF, veuillez patienter...",
...
static const Map<String,dynamic> _jpn = {
  "AboutScreen": {
    "about_text": "「{{PRODUCT}}」は、日本語を学ぶ人、日本語を使う人を支援します。\n「{{PRODUCT}}」は、[iOS]({APPSTORE_PAGE}), [Android]({PLAYSTORE_PAGE}), [MacOS]({MACSTORE_PAGE}), [Linux (Snap)]({SNAPSTORE_PAGE}), [Linux (flatpak)]({FLATPAKSTORE_PAGE}), [Linux (portable)]({PORTABLE_DOWNLOAD}), [Windows]({MICROSOFT_STORE_PAGE}) でご利用いただけます。\nすべてのリリースは[GitHub.]({GITHUB_RELEASES_PAGE})でもご覧いただけます。\n\nまた、[他のアプリ]({DAAPPLAB_STORE_PAGE})もチェックしてみてください。\nアプリの問題や改善提案があれば、[こちら]({GITHUB_ISSUES})に報告するか、[discordサーバー]({DISCORD_SERVER})に参加するか、フィードバックメニューを使って注釈付きのスクリーンショットを送ってください。\n\nプライバシーポリシーは[こちら]({PRIVACY_POLICE})をご覧ください。",
    "credits": "クレジット",
  ...
  "ClipboardScreen": {
    ...
    "tutorial_explanation": "テキストをコピーすると、{{PRODUCT}}上で辞書の項目等を表示します！",
    "tutorial_pin_button": "このボタンを押すと、{{PRODUCT}}が他のウィンドウの上に常に表示されるようになります。また、アプリのサイズが小さくなり、他のアプリケーション上で読書補助として使用できます。"
  },
  "DictionaryScreen": {
    "example_tab": "例",
    "examples_more": "その他の例",
    ...
    "word_tab_menu_quick_add_to_list": "リストにクイック追加",
    "word_tab_menu_quick_add_to_list_no_lists_selected": "クイック追加用のリストが選択されていません。設定で選択してください。",
    "word_tab_menu_quick_send_to_anki": "Ankiへクイック送信",
    "word_tab_menu_send_to_anki": "Ankiに送信",
    "word_tab_menu_share": "シェア",
    "word_tab_menu_share_as_image": "共有（イメージ）",
  ...
  "DrawScreen": {
    ...
    "tutorial_clear": "全て消去",
    "tutorial_dictionary_settings": "設定から辞書の種類を選択することができます",
    "tutorial_double_tap_prediction": "ダブルタップで文字を検索ボックスに追加",
    "tutorial_drawing": "探したい文字を手書きしてください",
    "tutorial_long_press_prediction": "長押しで予測文字を辞書で閲覧",
    "tutorial_multi_search": "複数の文字を一度に検索することもできます",
    "tutorial_multi_search_double_tap": "ダブルタップで検索ボックスを空にする",
    "tutorial_multi_search_long_press": "長押しで辞書を開く",
    "tutorial_multi_search_short_press": "タップで文字をクリップボードにコピー",
    "tutorial_multi_search_swipe_left": "左スワイプで最後の文字を削除",
    "tutorial_predictions": "予測文字が表示",
    "tutorial_short_press_prediction": "タップで予測文字をコピー",
    "tutorial_skip": "スキップ",
    "tutorial_undo": "一画前に戻る"
  },
  "FeedbackScreen": {
    "draw": "注釈",
    "feedback_description_email": "返信を希望される方は、Eメールアドレスも明記してください。",
    "feedback_description_text": "問題がありますか？\n以下に詳細をご入力ください。",
    "navigate": "操作",
    "submit": "送信",
    "title": "フィードバック"
  },
  ...
  "HomeScreen": {
    "account_page_char_input_error": "日本語を正確に1文字入力してください。",
    "account_page_char_updated_profile": "プロフィールの更新に成功しました！",
    "account_page_error_loading": "プロフィールの読み込み中にエラーが発生しました。インターネット接続をご確認の上、再度お試しください。",
    "account_page_generic_error": "予期せぬエラーが発生",
    "account_page_link_sent": "メールでログインリンクをご確認ください！",
    "account_page_link_to_sponsor": "スポンサーアカウントとのリンク",
    ...
    "account_page_user_name_input_error": "ユーザー名は1文字以上10文字以内で入力してください。",
  ...
  "InitScreen": {
    ...
    "RatePopup_text": "「{{PRODUCT}}」が好きですか？\n評価をいただけると大変助かります！",
    "complete_log": "全てのログ",
    "downgrade_warning": "旧バージョンの{{PRODUCT}}を使用しています！保存されているデータが破損する可能性があります！「設定」→「詳細設定」で全てのデータをリセットし、アプリを再起動してください",
    "download_failed_popup_retry": "再試行",
    "download_failed_popup_text": "ダウンロードに失敗した場合は、安定したインターネット接続環境があるかご確認ください。",
    "download_popup_permission": "始める前にいくつかのファイルをダウンロードする必要があります（~{DOWNLOAD_SIZE}MB）。ダウンロードは一度だけ行われます。ダウンロード中はアプリを閉じないでください。",
    "new_version_available_heading": "新バージョンを公開しました！",
    "new_version_available_text": "{{PRODUCT}}の新バージョンを公開しました！",
    "new_version_comparison": "現在{VERSION_NUMBER}をお使いですが、最新バージョンは{NEW_VERSION_NUMBER}です。",
    "new_versions_available_text": "{{PRODUCT}}の{NEW_VERSIONS}新バージョンを公開しました！",
    "rate_this_app": "評価",
    "whats_new": "最新情報"
  },
  "KanaTableScreen": {
    ...
    "tutorial_kana_table": "かなをタップして、かなの詳細と発音を確認",
    "tutorial_speed_dial": "表示する「かな」を変更",
    "tutorial_speed_dial_dakuten": "濁点のオン／オフの切り替え",
    "tutorial_speed_dial_kana": "ひらがなとカタカナの切り替え",
    "tutorial_speed_dial_romaji": "ローマ字入力のオン・オフの切り替え",
    "tutorial_speed_dial_yoon": "拗音のオン／オフの切り替え",
  ...
  "KanjiTableScreen": {
    ...
    "tutorial_filter": "ドロップダウンで、表示する漢字のカテゴリーを選択",
    "tutorial_filter_sub_group": "左のメニューの選択項目に対応するサブフィルターを選択",
    "tutorial_kanji_amount": "現在の表示漢字数を表示",
    "tutorial_kanjis": "ここでは、設定にマッチした漢字の表が表示されます。漢字をタップすると、その漢字の詳細を確認できます",
    "tutorial_sort": "表示漢字の順序を選択"
  },
  "KanjiTrainerScreen": {
    "title": "漢字トレーナー"
  },
  ...
  "ManualScreen": {
    "anki_connection_test_text": "{{PRODUCT}}とAnkiを使い始めるには、下のボタンを押してください。設定が正しいかどうかチェックできます。\n\n成功のメッセージが表示された場合、{{PRODUCT}}とAnkiは正しく接続され、使い始めることができます。\nエラーメッセージが表示された場合、メッセージの指示に従って、再度ボタンを押してください。\n成功メッセージが表示されないと、{{PRODUCT}}からAnkiにカードを送信できません。以下のボタンを押して、成功メッセージが表示されることを確認してください。設定が成功したかどうかは、設定→Ankiでも確認できます。",
    "anki_connection_test_title": "テスト設定",
    "anki_setup_android_text": "[AnkidDroid](https://play.google.com/store/apps/details?id=com.ichi2.anki)をインストールし、{{PRODUCT}}にAnkiとの同期を求めるメッセージが表示されましたら、許可してください。",
    "anki_setup_android_title": "Android",
    ...
    "anki_setup_intro": "{{PRODUCT}}からAnkiに単語を送信するできます。これには、プラットフォームごとに異なる設定が必要です。",
    "anki_setup_ios_text": "iOSでの設定は少し手間がかかります。AnkiMobileではノートタイプの追加ができないため、Androidやデスクトップとは異なります。そのため、{{PRODUCT}}ノートタイプを含むAnkiデッキをインポートする必要があります（他のデバイスで{{PRODUCT}}からAnkiにエクスポートしたカードがある場合は、この手順は不要です）。\n\n1.AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)をインストールする\n2.[こちら](https://github.com/CaptainDario/{{PRODUCT}}-Dependencies/releases/download/v3.4.6/{{PRODUCT}}.apkg)から、既成のAnkiデッキをダウンロードする\n3.ダウンロードしたファイルをタップすると、AnkiMobileのインポートダイアログが開きます\n4.デッキをインポートします\n5.{{PRODUCT}}がAnkiMobileと通信し、クリップボードを読み取ることを許可してください",
    "anki_setup_ios_title": "iOS",
    ...
    "anki_test_connection_note_type_not_available": "{{PRODUCT}}のノートタイプがAnkiに存在しません！iOSの設定ガイドで記載されている既成デッキをインポートして手動で追加できます。",
    "anki_test_connection_success": "Ankiに接続されました！🎉",
    "anki_title": "Anki",
    "deep_links_text": "Deep links は、アプリ内のコンテンツに直接リンクする方法です。{{PRODUCT}}では{{PRODUCT}}://とhttp(s)://{{PRODUCT}}.app/app. 例えば、{{PRODUCT}}://dictionary?search=食べるというリンクをタップすると、辞書検索を開くことができます。すべてのリンクについては[{{PRODUCT}}.app/deep-links](https://{{PRODUCT}}.app/deep-links)をご覧ください。",
    "deep_links_title": "Deep Links",
    "dict_examples_title": "例",
    "dict_kanji_animation_text": "{{PRODUCT}}は、収録されているほとんどの漢字・かなの筆順をアニメーションで表示することができ、様々な方法でそれらをコントロールすることが可能です。\nダブルタップは現在のアニメーションの状態によって結果が異なります。アニメーションが再生中の場合は一時停止、一時停止中の場合は再生します。最後に、アニメーションが終了している場合は最初から表示します。\nまたスワイプによってアニメーションの進行をコントロールでき、左にスワイプするとアニメーションが巻き戻り、右にスワイプすると進みます。",
    ...
    "dict_title": "辞書",
    "misc_drawer_heading": "メインメニュー",
    "misc_drawer_reorder_heading": "カスタマイズ",
    "misc_drawer_reorder_text": "{{PRODUCT}}では、すべてのユーザーに最適な方法でご利用いただけるよう、メインメニューの順番の変更が可能です。メニュー項目をドラッグして好きな場所に移動できます。",
    "misc_title": "その他",
    "text_paste_button_text": "このボタンを押すとクリップボードの内容がペーストされます。\nこのボタンを長押しすると自動貼り付けに切り替わり、クリップボードの内容が変更されると常に貼り付けられます。",
    "text_paste_button_title": "貼り付けボタン",
  ...
  "OcrScreen": {
    "title": "OCR",
    "tutorial_begin_text": "簡単なチュートリアルをお見せします",
    "tutorial_begin_title": "OCR表画面へようこそ！"
  },
  "OnBoarding": {
    "Onboarding_1_text": "漢字を書くだけで「{{PRODUCT}}」があなたの知りたい文字を探します",
    "Onboarding_1_title": "漢字がわからない？",
    "Onboarding_2_text": "オンライン上や{{PRODUCT}}内の辞書を使って、素早く言葉を調べることができます",
    ...
    "Onboarding_4_text": "{{PRODUCT}}には漢字表と仮名表があり、効率よく学習することができます。",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_delete_word_lists": "全単語リストを削除",
    "advanced_settings_draw_backend": "推論バックエンド（再起動します）",
    "advanced_settings_matrix": "マトリックスの中にいる",
    "advanced_settings_number_search_procs": "検索プロセス数 (@:SettingsScreen.requires_restart)",
    "advanced_settings_number_search_procs_body": "{{PRODUCT}}は、データベースを検索する際、複数のプロセスを使用します。{{PRODUCT}}に標準で付属しているデータベースでは、通常2プロセスで十分ですが、データベースで検索したときに動作が重くなるようであれば、プロセス数を増やしてください。\n\n\n{{PRODUCT}}がデータベースを検索する際には、複数のプロセスを使用します。通常、{{PRODUCT}}に含まれる標準データベースには2つのプロセスが適していますが、データベース検索時に速度が遅く感じる場合は、プロセス数を増やしてみてください。",
    "advanced_settings_optimize_backend": "バックエンド",
    "advanced_settings_optimize_cancel": "キャンセル",
    "advanced_settings_optimize_latency": "応答時間 (ms)",
    "advanced_settings_optimize_nn": "ニューラルネットの最適化",
    "advanced_settings_optimize_ok": "OK",
    "advanced_settings_optimize_results": "最適化結果",
    ...
    "advanced_settings_reset_settings": "設定をリセット",
    "advanced_settings_snap": "私は絶対なのだ・・・",
    "advanced_settings_title": "詳細設定",
    "anki_allow_duplicates": "重複の追加を許可する",
    "anki_allow_duplicates_explanation": "重複は、大漢字ノートタイプの最初のフィールドを比較することによってチェックされます。一致するのは、そのフィールドに全く同じ内容を持つ他のすべてのカードです。\nデフォルトでは、これは翻訳フィールドです。したがって、訳語を修正すれば、同じカードを追加することが再び可能になります。ただし、Ankiではフィールドの順序を変更することができます。大漢字リンク」フィールドを最初のフィールドとして使用する場合、すべての辞書項目は一意に識別されます。",
    "anki_default_deck": "デッキの追加",
    "anki_default_no_translations": "ノートの翻訳数",
    "anki_desktop_url": "Anki接続URL",
    "anki_get_decks_fail": "Ankiに接続されていないため、デッキを更新できませんでした！😢",
    "anki_get_decks_success": "デッキが更新されました🎉",
    "anki_include_audio": "ノートに音声を追加",
    "anki_include_example_translations": "翻訳例を含む",
    "anki_include_google_image": "ノートにgoogleの画像を追加",
    "anki_include_screenshot": "スクリーンショットを追加",
    "anki_languages_to_include": "ノートに記載する言語",
    "anki_number_of_examples": "追加する例の数",
    "anki_setup": "Ankiの設定が完了しました",
    "anki_show_settings_before_adding": "ノート追加前に設定ダイアログを表示する",
    "anki_title": "Anki",
    ...
    "dict_add_to_anki_from_search_results": "検索結果から杏樹に追加",
    "dict_add_to_list_from_search_results": "検索結果からリストに追加",
    "dict_base_form": "用語のベースフォーム",
    "dict_base_form_description": "この設定は、動詞、形容詞、助動詞の「非活用」を有効にします。これが有効になると、{{PRODUCT}}は検索語を基本形に変換しようとします。例えば、「食べます」、「食べられる」、「食べない」はすべて「食べる」に変換されます。\n\n中級者には、この設定をオフにすることをお勧めします。",
    "dict_convert_to_kana": "かな変換された用語",
    "dict_convert_to_kana_description": "この設定を有効にすると、{{PRODUCT}}は検索語を統一された仮名表記に変換してから検索を行います。たとえば、検索語「taberu」は「たべる」に変換され、「食べる」を見つけることができますが、意図しないマッチを引き起こす可能性もあります。\n\n例えば、「man」を検索すると「まん」に変換されるため、「万」や英単語「man」などにマッチすることがあります。\n\n注意: この設定はグローバル設定であり、辞書が使用されるすべての場所に適用されます。",
    "dict_custom_query_format_body": "{{PRODUCT}}は、辞書の画像検索の検索語を現在の辞書項目に置き換えます。このプレースホルダーは「{kanjiPlaceholder}」です。\n\n例：\n現在の単語が「口」で、「口 意味」という検索語で画像を検索したい場合、このフィールドに「{kanjiPlaceholder}意味」と入力してください。",
    "dict_custom_query_format_title": "カスタム画像検索語フォーマット",
    ...
    "dict_matrix_word_speed": "マトリックスのワードスピード",
    "dict_play_kanji_animation_when_opened": "アニメーションを自動開始",
    "dict_resume_animation_after_stop_swipe": "スワイプ後にアニメーションを再開",
    "dict_search_sorting_information": "検索結果はどのようにソートされますか？",
    "dict_search_sorting_information_description_1": "この設定では、辞書検索結果の並べ替えの優先順位を変更したり(ドラッグで並べ替え)、検索語の変更を無効にしたり(タップで無効)することができます。\nこの設定を理解するために、「四君子」(ローマ字表記)を例に、大漢字が検索結果をどのようにソートするかを見てみましょう。大漢字は、以下の条件に基づいて検索結果を表示します。",
    "dict_search_sorting_information_description_2": "1.@:SettingsScreen.dict_term: \"検索語 \"にマッチするすべてのエントリ。\n    1. 辞書項目と検索語が完全に一致する。\n        1. エントリーの漢字が一致する。\n        2. 読み方が一致\n        3. 訳語・意味が一致する。\n    2. 辞書の項目が検索語で始まっている。\n        1. 項目の漢字が一致\n        2. 読みの一致\n        3. 訳語・意味が一致する\n    3. 辞書項目が検索語をどこかに含んでいる (例: \"kun \"と検索すると \"shi*kun*shi \"と表示される)\n        1. 項目の漢字が一致\n        2. 読み方が一致\n        3. 翻訳／意味の一致\n2.@:SettingsScreen.dict_convert_to_kana:しくんし(可能であれば検索語をかなに変換)にマッチするすべてのエントリー\n    1. サブ基準は上記と同じ\n    2. ...\n3.@:SettingsScreen.dict_base_form:しくむにマッチするすべてのエントリ (の基本形を見つけようとする)\n    1. 副基準は上記と同じ\n    2. ...",
    "dict_search_sorting_information_description_3": "この設定では、最上位のソート基準の優先順位を設定することができます。\nこれらの意味の詳細については、以下の定義をお読みください。",
    "dict_separate_search_results": "検索結果の並び替え（ドラッグで並び替え、タップで並び替え不可）",
    "dict_show_wikipedia_definitions": "wikipediaの定義を表示",
    "dict_show_word_freq": "単語の使用頻度を表示",
    "dict_show_word_freq_body": "{{PRODUCT}}は、単語の使用頻度を利用して、辞書項目のランク付けを行います。これは単語の使用頻度を推定したもので、さまざまなデータソースに基づくものです：\n\n* ウィキペディア\n* OPUS OpenSubtitles 2018およびSUBTLEXの字幕\n* ウェブテキスト、OSCAR\n* Twitter\n* Reddit\n\n{{PRODUCT}}で表示される数字は、実際の単語頻度のバリエーションである[Zipf frequency](https://en.wikipedia.org/wiki/Zipf%27s_law)に基づいています。Zipf頻度は、人間にとって理解しやすい対数スケールで単語の頻度を表すためのものです。Zipf頻度は、単語が1億語あたりに出現する回数の常用対数です。例えば、Zipf値が6の単語は1千語ごとに1回出現し、Zipf値が3の単語は1百万語ごとに1回出現します。\n\n合理的なZipf値は0から8の範囲ですが、{{PRODUCT}}に表示される最低のZipf値は1.0です。データソースに存在しない単語には0がデフォルトのZipf値として使用されますが、これは1億語あたりに1回の出現を意味します。\n[もっと読む...](https://github.com/rspeer/wordfreq)",
    "dict_term": "検索用語",
    "dict_term_description": "ユーザーが入力したとおりの検索語。",
    ...
    "draw_title": "漢字を探す",
    "kana_table_play_audio": "かなをタップで音声を再生",
    "kana_table_play_kana_animation_when_opened": "アニメーションを自動開始",
    "misc_default_screen": "アプリ起動時の初期画面",
    "misc_font_size_scale": "フォント・サイズの倍率",
    "misc_language": "言語 (@:SettingsScreen.restarts_app)",
    "misc_settings_always_save_window_position": "移動時のウィンドウ位置の保存",
    "misc_settings_always_save_window_size": "リサイズ時にウィンドウサイズを保存",
    "misc_settings_window_size": "現在のウィンドウのサイズと位置を保存する",
    "misc_sharing_pattern": "コンテンツを共有する際に使用するスキーマ。",
    ...
    "time_tracking_current_ratio_text": "時給～{CURRENT_RATIO}分の休憩時間を稼ぐ",
    "time_tracking_enabled": "タイムトラッキングが可能",
    "time_tracking_session_legnth": "1セッションの長さ",
    "time_tracking_session_length_description": "1セッションの長さ",
    ...
    "word_lists_import_warning_description": "全ての単語リストが上書きされます。実行しますか？",
    "word_lists_languages_to_include_in_export": "エクスポート時に含める言語",
    "word_lists_pdf_include_kana": "PDF：かなを含む",
    "word_lists_pdf_max_lines_per_meaning": "PDF：意味毎の最大行数",
    "word_lists_pdf_max_meanings_per_vocabulary": "PDF語彙毎の意味",
    "word_lists_pdf_max_words_per_meaning": "PDF：意味毎の最大単語数",
    "word_lists_quick_add_lists": "単語リストへクイック追加",
    "word_lists_readd_defaults": "デフォルトフォルダの追加",
    "word_lists_screensaver_auto_show": "スクリーンセーバー：自動起動スクリーンセーバー",
  ...
  "TimeTrackingScreen": {
    "add": "追加",
    "add_category": "カテゴリーを追加する",
    "add_category_hint": "カテゴリー名を入力（例：漢字）",
    "add_tag": "タグの追加",
    "add_tag_hint": "タグ名を入力（例：N2）",
    "break_caps": "BREAK",
    "cancel": "キャンセル",
    "categories": "カテゴリー",
    "end_session": "セッション終了",
  ...
  "WordListScreen": {
    "word_list_copy_other_list": "他リストからすべての項目をコピー",
    "word_list_sort_date_asc": "日付 ↑",
    "word_list_sort_date_desc": "日付 ↓",
    "word_list_sort_freq_asc": "頻度 ↑",
    "word_list_sort_freq_desc": "頻度 ↓"
  },
  "WordListsScreen": {
    "add": "追加",
    "defaults": "デフォルト",
    ...
    "divider": "/",
    "drag_to_scroll": "ドラッグしてスクロール",
    "export_csv": "CSVエクスポート",
    "export_csv_progress": "CSVを作成中...",
    "export_images": "画像をエクスポート",
    "export_images_progress": "画像を生成中...",
    "export_pdf": "PDFエクスポート",
    "export_pdf_progress": "PDFを作成中...",
    "new_folder": "新規フォルダ",
    "new_list": "新規リスト",
    ...
    "tutorial_list": "単語リストです。タップして内容を見ることができます"
  },
  "YoutubeScreen": {
    "title": "ユーチューブ",
    "tutorial_begin_text": "簡単なチュートリアルをお見せします",
...
static const Map<String,dynamic> _deu = {
  ...
  "ClipboardScreen": {
    ...
    "tutorial_explanation": "Kopieren Sie einfach einen Text und {{PRODUCT}} zeigt Wörterbucheinträge und mehr!",
    "tutorial_pin_button": "Diese Schaltfläche bewirkt, dass {{PRODUCT}} immer über anderen Fenstern angezeigt wird. Zusätzlich wird die Größe reduziert und der Rahmen und die Anwendungsleiste werden ausgeblendet. Damit kann {{PRODUCT}} als Lesehilfe über jeder anderen Anwendung verwendet werden."
  },
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list": "Schnell zur Liste hinzufügen",
    "word_tab_menu_quick_add_to_list_no_lists_selected": "Es wurden keine Listen für das schnell Hinzufügen ausgewählt. Bitte tun Sie dies in den Einstellungen.",
    "word_tab_menu_quick_send_to_anki": "Schnelles Senden an Anki",
  ...
  "HomeScreen": {
    "account_page_char_input_error": "Geben Sie genau ein japanisches Zeichen ein.",
    "account_page_char_updated_profile": "Erfolgreich aktualisiertes Profil!",
    ...
    "account_page_generic_error": "Unerwarteter Fehler aufgetreten",
    "account_page_link_sent": "Prüfen Sie Ihre E-Mail auf den Login-Link!",
    "account_page_link_to_sponsor": "Verknüpfung mit dem Sponsorenkonto",
    ...
    "account_page_user_name_input_error": "Der Benutzername muss zwischen 1 und 10 Zeichen lang sein.",
  ...
  "InitScreen": {
    ...
    "RatePopup_text": "Es sieht so aus als würde dir {{PRODUCT}} gefallen.\nFalls das stimmt würde eine Bewertung dem Projekt extrem weiter helfen!",
    "complete_log": "vollständiges Log",
    "downgrade_warning": "Sie haben {{PRODUCT}} gedowngraded! Dies ist eine nicht unterstützte Aktion und wird mit hoher Wahrscheinlichkeit Ihre gespeicherten Daten zerstören oder {{PRODUCT}} sogar komplett unbrauchbar machen! Bitte setzen Sie alle Daten unter \"Einstellungen -> Erweiterte Einstellungen\" zurück und starten Sie die App neu.",
    ...
    "download_popup_permission": "Bevor Sie loslegen können, müssen wir einige Dateien herunterladen (~{DOWNLOAD_SIZE}MB). Dies wird nur einmal geschehen. Bitte stellen Sie sicher, dass Sie eine stabile Internetverbindung haben und schließen Sie die App nicht, während der Download läuft.",
    "new_version_available_heading": "Neue Version verfügbar!",
    "new_version_available_text": "Es ist eine neue Version von {{PRODUCT}} verfügbar!",
    "new_version_comparison": "Sie verwenden {VERSION_NUMBER}, die neueste Version ist {NEW_VERSION_NUMBER}",
    "new_versions_available_text": "Es sind {NEW_VERSIONS} neue Versionen von {{PRODUCT}} verfügbar!",
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Um {{PRODUCT}} und Anki zu verwenden, müssen Sie auf die Schaltfläche unten klicken. Es wird geprüft, ob Ihre Einstellungen korrekt sind.\n\nWenn Sie eine Erfolgsmeldung erhalten, sind {{PRODUCT}} und Anki verbunden und Sie können {{PRODUCT}} mit Anki verwenden.\nWenn Sie eine Fehlermeldung erhalten, folgen Sie bitte den Anweisungen in der Meldung und drücken Sie danach erneut den Button.\nOhne eine Erfolgsmeldung ist {{PRODUCT}} nicht in der Lage, Karten an Anki zu senden. Stellen Sie daher sicher, dass Sie den Knopf unten drücken und eine Erfolgsmeldung erhalten. Sie können auch unter Einstellungen → Anki überprüfen, ob die Einrichtung erfolgreich war.",
    "anki_connection_test_title": "Test setup",
    "anki_setup_android_text": "Du musst [AnkidDroid](https://play.google.com/store/apps/details?id=com.ichi2.anki) installiert haben und {{PRODUCT}} auf Nachfrage die Erlaubnis erteilen, mit Anki zu interagieren.",
    "anki_setup_android_title": "Android",
    ...
    "anki_setup_intro": "{{PRODUCT}} kann verwendet werden, um Notizen an Anki zu senden. Dafür benötigt jede Plattform eine andere Einrichtung.",
    "anki_setup_ios_text": "Die Einrichtung auf iOS ist etwas umständlich, da AnkiMobile das Hinzufügen von Notiztypen nicht erlaubt, was auf Android und Desktop möglich ist. Daher müssen Sie ein Anki-Deck mit dem {{PRODUCT}}-Notiztyp importieren (Sie müssen dies nicht tun, wenn Sie Karten von {{PRODUCT}} zu Anki auf einem anderen Gerät exportiert haben)\n\n1. Installiere [AnkiMobile] (https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Lade das vorgefertigte Anki Deck [hier](https://github.com/CaptainDario/{{PRODUCT}}-Dependencies/releases/download/v3.4.6/{{PRODUCT}}.apkg) herunter\n3. Tippe auf die heruntergeladene Datei, dies öffnet den Importdialog von AnkiMobile\n4. Importiere das Deck\n5. Wenn du gefragt wirst, erlaube {{PRODUCT}}, mit AnkiMobile zu kommunizieren und deine Zwischenablage zu lesen",
    "anki_setup_ios_title": "iOS",
    ...
    "anki_test_connection_note_type_not_available": "Der {{PRODUCT}}-Notiztyp ist in Anki nicht verfügbar! Sie können ihn manuell hinzufügen, indem Sie das vorgefertigte Deck importieren, das in der iOS-Einrichtungsanleitung erwähnt wird.",
    "anki_test_connection_success": "Du bist mit Anki verbunden! 🎉",
    "anki_title": "Anki",
    "deep_links_text": "Deep Links sind eine Möglichkeit, Inhalte in einer App direkt zu verlinken. {{PRODUCT}} bietet dafür zwei Schemata: {{PRODUCT}}:// und http(s)://{{PRODUCT}}.app/app. Mit dieser Funktion können Sie zum Beispiel die Wörterbuchsuche öffnen, wenn Sie auf diesen Link tippen {{PRODUCT}}://dictionary?search=食べる. Für alle unterstützten Links siehe [{{PRODUCT}}.app/deep-links](https://{{PRODUCT}}.app/deep-links)",
    "deep_links_title": "Deep Links",
    "dict_examples_title": "Beispiele",
    "dict_kanji_animation_text": "{{PRODUCT}} kann für die meisten der enthaltenen Kanji animierte Strichfolge-Diagramme anzeigen. Diese Animationen können auf verschiedene Weise gesteuert werden.\nDoppeltes Antippen hat je nach dem aktuellen Zustand der Animation unterschiedliche Ergebnisse. Wenn die Animation gerade abgespielt wird, wird sie angehalten. Wenn die Animation angehalten ist, wird sie weiter abgespielt. Passend wird die Animation wenn sie beendet ist, durch doppeltes Antippen wieder von vorne gestartet.\nDurch Swipen über ein Kanji kann der Fortschritt dessen Animation gesteuert werden. Wenn Sie nach links wischen, wird die Animation zurückgespult, während nach rechts wischen, die Animation vorspult.",
    ...
    "misc_drawer_reorder_text": "Um jedem Benutzer die bestmögliche Anpassung zu ermöglichen, erlaubt {{PRODUCT}} die Neuanordnung der Elemente im Hauptnavigationsmenü. Drücken Sie einfach auf einen beliebigen Menüeintrag, bis Sie ihn an die gewünschte Stelle ziehen können.",
    "misc_title": "Sonstiges",
    "text_paste_button_text": "Durch Drücken dieser Taste wird der Inhalt der Zwischenablage eingefügt.\nLanges Drücken dieser Taste schaltet auf automatisches Einfügen um und fügt den Inhalt der Zwischenablage immer dann ein, wenn er sich ändert.",
    "text_paste_button_title": "Einfügen",
  ...
  "OcrScreen": {
    "title": "OCR",
    "tutorial_begin_text": "Wir zeigen dir ein kurzes Tutorial damit du loslegen kannst.",
    "tutorial_begin_title": "Willkommen auf dem Bildschirm der OCR-Tabelle!"
  },
  "OnBoarding": {
    "Onboarding_1_text": "Male es mit deinem Finger und {{PRODUCT}} zeigt dir das Zeichen",
    "Onboarding_1_title": "Du kennst ein Kanji nicht?",
    "Onboarding_2_text": "Mit {{PRODUCT}} kannst du schnell Wörter in Web- und App-Wörterbüchern nachschlagen",
    "Onboarding_2_title": "Schlage Zeichen und Wörter nach",
    "Onboarding_3_text": "Verwende die Textanalysetools von {{PRODUCT}}, um Furigana, Leerzeichen und mehr hinzuzufügen oder den ganzen Satz zu übersetzen.",
    "Onboarding_3_title": "Du weißt nicht wie man einen Satz liest?",
    "Onboarding_4_text": "{{PRODUCT}} verfügt über Kanji- und Kana-Tabellen, damit Sie sie effizient lernen können.",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_number_search_procs_body": "Wenn {{PRODUCT}} seine Datenbank durchsucht, verwendet es mehrere Prozesse. Normalerweise ist 2 ein guter Wert für die in {{PRODUCT}} enthaltene Standarddatenbank. Wenn Sie jedoch bei der Suche in der Datenbank slow-downs feststellen, versuchen Sie, mehr Prozesse zu verwenden.",
    "advanced_settings_optimize_backend": "Backend",
    "advanced_settings_optimize_cancel": "Abbrechen",
    "advanced_settings_optimize_latency": "Latenzzeit (ms)",
    "advanced_settings_optimize_nn": "Neuronale Netze optimieren",
    "advanced_settings_optimize_ok": "Ok",
    "advanced_settings_optimize_results": "Optimierungsergebnisse",
    ...
    "anki_allow_duplicates": "Hinzufügen von Duplikaten zulassen",
    "anki_allow_duplicates_explanation": "Duplikate werden geprüft, indem das erste Feld des {{PRODUCT}}-Notiztyps verglichen wird. Eine Übereinstimmung ist jede andere Karte, die genau den gleichen Inhalt in diesem Feld hat.\nStandardmäßig ist dies das Übersetzungsfeld. Wenn Sie also die Übersetzung ändern, können Sie die gleiche Karte wieder hinzufügen. Sie können jedoch die Reihenfolge der Felder in Anki ändern. Jeder Wörterbucheintrag wird eindeutig identifiziert, wenn das Feld \"{{PRODUCT}} link\" als erstes Feld verwendet wird.",
    ...
    "anki_include_example_translations": "Beispielübersetzungen einbeziehen",
    ...
    "anki_number_of_examples": "Anzahl der hinzuzufügenden Beispiele",
    ...
    "dict_add_to_anki_from_search_results": "Aus Suchergebnissen zu anki hinzufügen",
    "dict_add_to_list_from_search_results": "Zu Liste aus Suchergebnissen hinzufügen",
    "dict_base_form": "Grundform des Terms",
    "dict_base_form_description": "Diese Einstellung aktiviert die \"Dekonjugation\" von Verben, Adjektiven und Kopula. Wenn sie aktiviert ist, versucht {{PRODUCT}}, den Suchbegriff in seine Grundform umzuwandeln. Zum Beispiel werden 食べます、食べられる、食べない alle in 食べる umgewandelt.\nFür fortgeschrittene Lernende wird empfohlen, diese Einstellung zu deaktivieren.",
    "dict_convert_to_kana": "In Kana umgewandelter Term",
    "dict_convert_to_kana_description": "Wenn Sie diese Einstellung aktivieren, wandelt {{PRODUCT}} jeden Suchbegriff in eine einheitliche Kana-Darstellung um, bevor er gesucht wird. Das bedeutet, dass die Anfrage \"taberu\" in たべる umgewandelt wird und 食べる findet, aber es kann auch zu unbeabsichtigten Übereinstimmungen führen.\n\nZum Beispiel wird die Suche nach \"man\" in まん umgewandelt und findet somit 万 und das englische Wort \"man\".\n\nHinweis: Dies ist eine globale Einstellung und wird überall angewendet, wo das Wörterbuch verwendet wird.",
    ...
    "dict_custom_query_format_title": "Benutzerdefiniertes Bildabfrageformat",
    ...
    "dict_matrix_word_speed": "Matrix-Wortgeschwindigkeit",
    ...
    "dict_search_sorting_information": "Wie werden die Suchergebnisse sortiert?",
    "dict_search_sorting_information_description_1": "Mit dieser Einstellung können Sie festlegen, wie {{PRODUCT}} die Suchergebnisse von Wörterbüchern sortiert, indem Sie die Sortierpriorität ändern (ziehen, um neu zu sortieren) oder die Änderung von Suchbegriffen deaktivieren (tippen, um sie zu deaktivieren).\\\nUm diese Einstellung vollständig zu verstehen, schauen wir uns an, wie {{PRODUCT}} die Suchergebnisse sortiert, indem wir den Beispielsuchbegriff \"shikunshi\" verwenden (beachten Sie, dass er in romaji geschrieben ist). {{PRODUCT}} zeigt die Suchergebnisse anhand der folgenden Kriterien an, wobei tiefer verschachtelte Kriterien weniger wichtig sind als höhere.",
    "dict_search_sorting_information_description_2": "1. @:SettingsScreen.dict_term: alle Einträge, die mit dem \"Suchbegriff\" übereinstimmen, z.B.: \"shikunshi\"\n    1. der Wörterbucheintrag und der Suchbegriff stimmen genau überein\n        1. Kanji des Eintrags stimmen überein\n        2. die Lesung stimmt überein\n        3. jede Übersetzung/Bedeutung stimmt überein\n    2. der Wörterbucheintrag beginnt mit dem Suchbegriff\n        1. Kanji des Eintrags stimmen überein\n        2. Lesetreffer\n        3. beliebige Übersetzung/Bedeutung stimmt überein\n    3. der Wörterbucheintrag enthält irgendwo den Suchbegriff (z.B.: Suche nach \"kun\" und es wird mir \"shi*kun*shi\" angezeigt)\n        1. Kanji des Eintrags stimmen überein\n        2. die Lesung stimmt überein\n        3. beliebige Übersetzungen/Bedeutungstreffer\n2. @:SettingsScreen.dict_convert_to_kana: alle Einträge, die mit しくんし übereinstimmen (wandelt den Suchbegriff in Kana um, wenn möglich)\n    1. Unterkriterien wie oben\n    2. ...\n3. @:SettingsScreen.dict_base_form: alle Einträge, die mit しくむ übereinstimmen (versuchen, die Grundform von zu finden)\n    1. Unterkriterium wie oben\n    2. ...",
    "dict_search_sorting_information_description_3": "Mit dieser Einstellung können Sie die Sortierpriorität der obersten Sortierkriterien festlegen.\nFür eine detaillierte Beschreibung ihrer Bedeutung lesen Sie bitte die nachstehenden Definitionen.",
    "dict_separate_search_results": "Sortierreihenfolge der Suchergebnisse (Ziehen zum Neuordnen, Tippen zum Deaktivieren)",
    "dict_show_wikipedia_definitions": "Definitionen von wikipedia anzeigen",
    "dict_show_word_freq": "Zeige Wordfrequenz",
    "dict_show_word_freq_body": "{{PRODUCT}} verwendet ein Maß für die Worthäufigkeit, um seine Wörterbucheinträge zu bewerten. Diese Worthäufigkeit ist eine Schätzung der Verwendung eines Wortes. Diese Schätzung basiert auf verschiedenen Datenquellen:\nWikipedia, die enzyklopädischen Text darstellt\nUntertitel, aus OPUS OpenSubtitles 2018 und SUBTLEX\nWebtext, aus OSCAR\nTwitter, stellvertretend für soziale Medien in Kurzform\nReddit, repräsentiert potenziell längere Internetkommentare\nDie angezeigte Zahl ist eine Variante der eigentlichen Worthäufigkeit, die Zipf-Häufigkeit, die darauf abzielt, die Worthäufigkeit auf einer menschenfreundlichen logarithmischen Skala wiederzugeben. Die Zipf-Häufigkeit eines Wortes ist der Logarithmus zur Basis 10, der angibt, wie oft das Wort pro Milliarde Wörter vorkommt. Ein Wort mit dem Zipf-Wert 6 kommt beispielsweise einmal pro tausend Wörter vor, und ein Wort mit dem Zipf-Wert 3 kommt einmal pro Million Wörter vor.\nAngemessene Zipf-Werte liegen zwischen 0 und 8, aber der minimale Zipf-Wert in {{PRODUCT}} ist 1,0. Wir verwenden 0 als Standard-Zipf-Wert für Wörter, die in der gegebenen Wortliste nicht vorkommen, obwohl dies ein Vorkommen pro Milliarde Wörter bedeuten sollte.",
    "dict_term": "Suchbegriff",
    "dict_term_description": "Der Suchbegriff genau so wie der Benutzer ihn eingegeben hat.",
    ...
    "misc_font_size_scale": "Skalierungsfaktor für die Schriftgröße",
    "misc_language": "Sprache (@:SettingsScreen.restarts_app)",
    "misc_settings_always_save_window_position": "Fensterposition beim Verschieben speichern",
    "misc_settings_always_save_window_size": "Fenstergröße bei Größenänderung speichern",
    "misc_settings_window_size": "Aktuelle Fenstergröße und -position speichern",
    "misc_sharing_pattern": "Schema wenn Inhalten geteilt werden.",
    ...
    "time_tracking_current_ratio_text": "Verdient ~{CURRENT_RATIO} min Pause / Stunde",
    "time_tracking_enabled": "Zeiterfassung aktiviert",
    "time_tracking_session_legnth": "Dauer einer Sitzung",
    "time_tracking_session_length_description": "Dauer einer Sitzung",
    "time_tracking_tags": "Tags",
    "title": "Einstellungen",
    ...
    "word_lists_languages_to_include_in_export": "Beim Export inkludierte Sprachen",
    ...
    "word_lists_quick_add_lists": "Schnelles hinzufügen Wortliste(n):",
    "word_lists_readd_defaults": "Hinzufügen des Standardordners",
    "word_lists_screensaver_auto_show": "Bildschirmschoner: Automatisch Starten",
  ...
  "TimeTrackingScreen": {
    ...
    "add_category_hint": "Kategoriename eingeben (z. B. Kanji)",
    "add_tag": "Tag hinzufügen",
    "add_tag_hint": "Tag-Name eingeben (z. B. N2)",
    "break_caps": "UNTERBRECHUNG",
    "cancel": "Abbrechen",
  ...
  "WordListsScreen": {
    ...
    "export_csv_progress": "Erstelle CSV, bitte warten...",
    "export_images": "Bilder exportieren",
    "export_images_progress": "Bilder werden gerendert, bitte warten...",
    "export_pdf": "PDF exportieren",
    "export_pdf_progress": "Erstelle PDF, bitte warten...",
...
static const Map<String,dynamic> _zho = {
  "AboutScreen": {
    "about_text": "\"{{PRODUCT}}\" 为日语学生和日语使用者提供帮助。\n\"{{PRODUCT}} \"适用于[iOS]({APPSTORE_PAGE})、[Android]({PLAYSTORE_PAGE})、[MacOS]({MACSTORE_PAGE})、[Linux (Snap)]({SNAPSTORE_PAGE})、[Linux（flatpak）]({FLATPAKSTORE_PAGE})、[Linux（便携式）]({PORTABLE_DOWNLOAD})、[Windows]({MICROSOFT_STORE_PAGE})。\n您还可以在 [GitHub.]({GITHUB_RELEASES_PAGE}) 上找到所有版本。\n\n还可以查看 [我的其他应用程序]({DAAPPLAB_STORE_PAGE})\n如果您在使用本程序时遇到问题或有改进建议，请在[此处]({GITHUB_ISSUES})报告，或加入[discord 服务器]({DISCORD_SERVER})，或使用反馈菜单发送带注释的截图。\n\n隐私政策请见 [此处]({PRIVACY_POLICE})",
    "credits": "贷方",
  ...
  "ClipboardScreen": {
    "title": "剪贴板",
    "tutorial_android_limitation": "在安卓系统中，该屏幕无法在后台自动读取剪贴板。您需要将应用程序置于前台。在 iOS 上，你可以在设置中允许 {{PRODUCT}} 读取剪贴板。这样，它就不会总是要求您允许粘贴。很抱歉给您带来不便。",
    "tutorial_begin_text": "我们将向你展示一个快速教程，让你开始。",
    "tutorial_begin_title": "欢迎来到剪贴板屏幕!",
    "tutorial_explanation": "只要复制一些文字，{{PRODUCT}}就会显示字典条目和更多的内容!",
    "tutorial_pin_button": "这个按钮使{{PRODUCT}}总是显示在其他窗口的上面。此外，尺寸被缩小，框架和应用栏被隐藏。有了这个按钮，《大汉字》就可以在任何其他应用程序上作为阅读辅助工具。"
  },
  "DictionaryScreen": {
    "example_tab": "例子",
    ...
    "word_tab_menu_quick_add_to_list": "快速添加到清单",
    "word_tab_menu_quick_add_to_list_no_lists_selected": "未选择快速发送列表。请在设置中进行选择。",
    "word_tab_menu_quick_send_to_anki": "快速发送到 Anki",
  ...
  "HomeScreen": {
    "account_page_char_input_error": "准确输入一个日语字符。",
    "account_page_char_updated_profile": "成功更新个人资料！",
    "account_page_error_loading": "加载您的个人资料时发生错误。请检查网络连接并重试。",
    "account_page_generic_error": "发生意外错误",
    "account_page_link_sent": "查看电子邮件中的登录链接！",
    "account_page_link_to_sponsor": "与赞助商账户链接",
    ...
    "account_page_user_name_input_error": "用户名必须在 1 到 10 个字符之间。",
  ...
  "InitScreen": {
    ...
    "RatePopup_text": "你喜欢 \"{{PRODUCT}} \"吗？\n如果是这样的话，评分将是非常棒的，它将对这个项目有很大的帮助!",
    "complete_log": "完整日志",
    "downgrade_warning": "您降级了 {{PRODUCT}}！这不是一个受支持的操作，很可能会破坏您存储的数据，甚至使 {{PRODUCT}} 完全无法使用！请在 \"设置 -> 高级设置 \"中重置所有数据并重新启动应用程序。",
    "download_failed_popup_retry": "重试",
    "download_failed_popup_text": "下载失败，请确保你有一个稳定的网络连接。",
    "download_popup_permission": "在开始之前，我们需要下载一些文件（~{DOWNLOAD_SIZE}MB）。这只会发生一次。请确保您有稳定的网络连接，并且在下载过程中不要关闭应用程序。",
    ...
    "new_versions_available_text": "有{NEW_VERSIONS}新版本的{{PRODUCT}}可以使用!",
    "rate_this_app": "速率",
    "whats_new": "最新信息"
  },
  "KanaTableScreen": {
  ...
  "ManualScreen": {
    "anki_connection_test_text": "要开始使用 {{PRODUCT}} 和 Anki，您需要按下面的按钮。它将检查您的设置是否正确。\n\n如果收到成功信息，说明 {{PRODUCT}} 和 Anki 已经连接，您可以开始使用 {{PRODUCT}} 和 Anki。\n如果收到错误信息，请按照信息中的说明操作，然后再按一次按钮。\n如果没有成功信息，{{PRODUCT}} 将无法向 Anki 发送卡片。因此，请确保按下下面的按钮并收到成功信息。您也可以在设置 → Anki 中检查设置是否成功。",
    "anki_connection_test_title": "测试设置",
    "anki_setup_android_text": "你需要安装[AnkidDroid](https://play.google.com/store/apps/details?id=com.ichi2.anki)，并在被要求时授予{{PRODUCT}}与Anki互动的权限。",
    ...
    "anki_setup_intro": "{{PRODUCT}} 可用于将笔记发送到 Anki。为此，每个平台需要不同的设置。",
    "anki_setup_ios_text": "iOS 上的设置有点麻烦，因为 AnkiMobile 不允许添加注释类型，而在 Android 和桌面上却可以。因此，你需要导入带有 {{PRODUCT}} 笔记类型的 Anki 卡组（如果你已经在其他设备上把卡片从 {{PRODUCT}} 导出到了 anki，就不需要这样做了）\n\n1.安装 [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2.从[这里](https://github.com/CaptainDario/{{PRODUCT}}-Dependencies/releases/download/v3.4.6/{{PRODUCT}}.apkg)下载预制的安基卡组\n3.点击下载的文件，打开 AnkiMobile 的导入对话框。\n4.导入卡组\n5.当要求允许 {{PRODUCT}} 与 AnkiMobile 通信并读取你的剪贴板时",
    ...
    "anki_test_connection_note_type_not_available": "Anki 中没有大关字注音类型！您可以通过导入 iOS 安装指南中提到的预制卡组来手动添加。",
    "anki_test_connection_success": "你已连接到Anki!🎉",
    "anki_title": "Anki",
    "deep_links_text": "深度链接是直接链接到应用程序中内容的一种方式。{{PRODUCT}} 为此提供了两种方案 {{PRODUCT}}:// 和 http(s)://{{PRODUCT}}.app/app。使用此功能，您可以在点击此链接{{PRODUCT}}://dictionary?search=食べる时打开字典搜索。所有支持的链接见 [{{PRODUCT}}.app/deep-links](https://{{PRODUCT}}.app/deep-links)",
    "deep_links_title": "Deep Links",
    "dict_examples_title": "实例",
    "dict_kanji_animation_text": "{{PRODUCT}} 可以显示大多数汉字/假名的笔顺动画图。这些动画可以不同的方式控制。\n双击会根据动画的当前状态产生不同的结果。如果动画正在播放，则会暂停。同样，当动画处于暂停状态时，它将继续播放动画。最后，如果动画已经结束，双击将从头开始重启动画。\n通过轻扫汉字可以控制动画进度。向左轻扫可使动画倒退，向右轻扫可使动画前进。",
    ...
    "misc_drawer_reorder_text": "为了以最佳方式满足每位用户的需求，{{PRODUCT}} 允许您对主导航菜单中的元素重新排序。只需按下任何菜单条目，即可将其拖动到您想要的位置。",
    "misc_title": "杂项",
    "text_paste_button_text": "按下此按钮可粘贴剪贴板的内容。\n长按此按钮可切换到自动粘贴，并在剪贴板内容发生变化时始终进行粘贴。",
    "text_paste_button_title": "粘贴按钮",
  ...
  "OcrScreen": {
    "title": "OCR",
    "tutorial_begin_text": "我们将向你展示一个快速教程，让你开始。",
    "tutorial_begin_title": "欢迎来到 OCR 表格屏幕！"
  },
  "OnBoarding": {
    "Onboarding_1_text": "只要画出来，\"{{PRODUCT}} \"就会显示出你需要的字符。",
    "Onboarding_1_title": "你不知道一个汉字吗？",
    "Onboarding_2_text": "有了 \"大汉字\"，你可以使用内置的字典或在互联网上快速查询单词。",
    "Onboarding_2_title": "查询字符和单词",
    "Onboarding_3_text": "使用{{PRODUCT}}的文本分析工具来添加假名、空格等，或翻译整个句子。",
    "Onboarding_3_title": "不知道如何读懂一个句子？",
    "Onboarding_4_text": "{{PRODUCT}} 有汉字和假名表，可让您高效地学习汉字和假名。",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_matrix": "我在矩阵中",
    "advanced_settings_number_search_procs": "搜索进程的数量（@:SettingsScreen.required_restart）。",
    "advanced_settings_number_search_procs_body": "当{{PRODUCT}}搜索它的数据库时，它会使用多个进程。通常情况下，对于大勘察院所包含的标准数据库来说，2个是一个很好的值。然而，如果你在数据库中搜索时遇到速度减慢的情况，请尝试使用更多进程。",
    "advanced_settings_optimize_backend": "后台",
    "advanced_settings_optimize_cancel": "取消",
    "advanced_settings_optimize_latency": "延迟（毫秒）",
    "advanced_settings_optimize_nn": "优化神经网络",
    "advanced_settings_optimize_ok": "好的",
    "advanced_settings_optimize_results": "优化结果",
    ...
    "anki_allow_duplicates": "允许添加重复内容",
    "anki_allow_duplicates_explanation": "通过比较 {{PRODUCT}} 注释类型的第一个字段来检查重复。在该字段中具有完全相同内容的所有其他卡片都是匹配的。\n默认情况下，这是翻译字段。因此，如果您修改了翻译，就可以再次添加相同的卡片。不过，您可以在 Anki 中更改字段的顺序。当使用 \"{{PRODUCT}} link（大汉字链接）\"字段作为第一个字段时，每个字典条目都是唯一标识的。",
    ...
    "dict_add_to_anki_from_search_results": "从搜索结果中添加到 anki",
    "dict_add_to_list_from_search_results": "从搜索结果添加到列表",
    "dict_base_form": "术语的基本形式",
    "dict_base_form_description": "这个设置使动词、形容词和副词的 \"去伪存真 \"成为可能。当它被启用时，{{PRODUCT}}会尝试将搜索词转换成其基本形式。例如，食べます、食べられる、食べない都被转换为食べる。\n对于中等水平的学习者，建议关闭这个设置。",
    "dict_convert_to_kana": "转换为假名的术语",
    "dict_convert_to_kana_description": "当启用此设置时，{{PRODUCT}}会在查找前将任何搜索词转换为统一的假名表示。这意味着查询 \"taberu \"将被转换为たべる，并能找到食べる，但这也可能导致非预期的匹配。\n\n例如，搜索'man'会被转换为まん，因此会匹配到万和英文单词'man'。\n\n注意：这是一个全局设置，在使用词典的任何地方都适用",
    ...
    "dict_custom_query_format_title": "自定义图像查询格式",
    ...
    "dict_matrix_word_speed": "矩阵字速",
    "dict_play_kanji_animation_when_opened": "自动启动汉字动画",
    "dict_resume_animation_after_stop_swipe": "轻扫后恢复动画",
    "dict_search_sorting_information": "搜索结果如何排序？",
    "dict_search_sorting_information_description_1": "该设置允许你通过改变排序优先级（拖动以重新排序）或禁用搜索词修改（轻点以禁用）来自定义达坎吉如何对词典搜索结果进行排序。\n为了充分理解这一设置，让我们以搜索词 \"shikunshi\"（注意，它是用罗马字书写的）为例，看看 {{PRODUCT}} 如何对搜索结果进行排序。{{PRODUCT}} 将根据以下标准显示搜索结果，其中较深的嵌套标准的重要性低于较高的标准。",
    "dict_search_sorting_information_description_2": "1.@:SettingsScreen.dict_term：所有与 \"搜索词 \"匹配的词条，如：\"shikunshi\"。\n    1. 词条和搜索词完全相同\n        1. 词条的汉字匹配\n        2. 读音匹配\n        3. 任何翻译/含义匹配\n    2. 词典条目以检索词开头\n        1. 词条的汉字匹配\n        2. 阅读匹配\n        3. 任何翻译/含义匹配\n    3. 词条中包含搜索词（例如：搜索 \"kun\"，结果显示 \"shi*kun*shi\"） 1.\n        1. 词条的汉字匹配\n        2. 读音匹配\n        3. 任何翻译/含义匹配\n2.@:SettingsScreen.dict_convert_to_kana：与 しくんし匹配的所有条目（尽可能将搜索词转换为假名）\n    1. 次级标准同上\n    2. ...\n3.@:SettingsScreen.dict_base_form：所有匹配 しくむ的条目（尝试查找 しくむ的基本形式） 1.\n    1. 子标准同上\n    2. ...",
    "dict_search_sorting_information_description_3": "该设置允许设置顶层排序标准的排序优先级。\n有关其含义的详细说明，请阅读下面的定义。",
    "dict_separate_search_results": "搜索结果的排序顺序（拖动可重新排序，轻点可禁用）",
    "dict_show_wikipedia_definitions": "显示来自维基百科的定义",
    "dict_show_word_freq": "显示词频",
    "dict_show_word_freq_body": "大汉字》使用词频对其词典条目进行排名。这个词频是对一个词的用法的估计，是基于不同的数据来源：\n\n* 维基百科，代表百科全书式的文本\n* 字幕，来自OPUS OpenSubtitles 2018和SUBTLEX\n* 网络文本，来自OSCAR\n* 推特，代表短篇的社交媒体\n* Reddit，代表潜在的较长的互联网评论\n\n{{PRODUCT}}中显示的数字是实际词频的一种变体，称为[Zipf频率](https://en.wikipedia.org/wiki/Zipf%27s_law)，旨在以人类友好的对数尺度来返回词频。一个词的Zipf频率是它在每十亿个词中出现次数的基数-10的对数。例如，Zipf值为6的词每千字出现一次，而Zipf值为3的词每百万字出现一次。\n合理的Zipf值在0到8之间，但在《大汉字》中出现的最小Zipf值是1.0。对于没有出现在数据源中的词，我们使用0作为默认的Zipf值，尽管它应该意味着每十亿字中出现一次。\n[阅读全文...](https://github.com/rspeer/wordfreq)",
    "dict_term": "搜索词",
    "dict_term_description": "搜索词与用户输入的完全一致。",
    ...
    "misc_font_size_scale": "字体大小缩放系数",
    "misc_language": "语言 (@:SettingsScreen.restarts_app)",
    "misc_settings_always_save_window_position": "移动时保存窗口位置",
    "misc_settings_always_save_window_size": "调整大小时保存窗口大小",
    "misc_settings_window_size": "保存当前窗口大小和位置",
    "misc_sharing_pattern": "共享内容时使用的模式。",
    ...
    "time_tracking_current_ratio_text": "赚取 ~{CURRENT_RATIO} 分钟/小时的休息时间",
    "time_tracking_enabled": "启用时间跟踪",
    "time_tracking_session_legnth": "一节课的时间",
    "time_tracking_session_length_description": "一节课的时间",
    ...
    "word_lists_languages_to_include_in_export": "导出时应包含的语言",
    ...
    "word_lists_quick_add_lists": "快速添加单词表：",
    "word_lists_readd_defaults": "添加默认文件夹",
    "word_lists_screensaver_auto_show": "屏幕保护程序自动启动屏幕保护程序",
  ...
  "TimeTrackingScreen": {
    "add": "添加",
    "add_category": "添加类别",
    "add_category_hint": "输入类别名称（如汉字）",
    "add_tag": "添加标签",
    "add_tag_hint": "输入标签名称（如 N2）",
    "break_caps": "中断",
    "cancel": "取消",
    "categories": "类别",
    "end_session": "会议结束",
  ...
  "WordListsScreen": {
    ...
    "export_csv": "导出 CSV",
    "export_csv_progress": "创建 CSV，请稍候...",
    "export_images": "导出图像",
    "export_images_progress": "正在渲染图像，请稍候...",
    "export_pdf": "导出 PDF",
    "export_pdf_progress": "创建 PDF，请稍候...",
    "new_folder": "新文件夹",
    "new_list": "新名单",
    "no_entries": "该词表中没有条目",
    "node_hint_text": "命名",
...
static const Map<String,dynamic> _ita = {
  ...
  "ClipboardScreen": {
    "title": "Appunti",
    "tutorial_android_limitation": "Su Android, questa schermata non può leggere automaticamente gli appunti in background. È necessario che l'app sia in primo piano. Su iOS, è possibile consentire a {{PRODUCT}} di leggere gli appunti nelle impostazioni. In questo modo non vi chiederà sempre di autorizzare l'incollaggio. Ci scusiamo per l'inconveniente.",
    ...
    "tutorial_explanation": "Basta copiare un testo e {{PRODUCT}} mostrerà le voci del dizionario e molto altro!",
    "tutorial_pin_button": "Questo pulsante fa sì che {{PRODUCT}} venga visualizzato sempre sopra le altre finestre. Inoltre, le dimensioni sono ridotte e la cornice e la barra delle applicazioni sono nascoste. In questo modo {{PRODUCT}} può essere utilizzato come ausilio per la lettura sopra qualsiasi altra applicazione."
  },
  "DictionaryScreen": {
    "example_tab": "Esempio",
    ...
    "word_tab_menu_quick_add_to_list": "Aggiunta rapida all'elenco",
    "word_tab_menu_quick_add_to_list_no_lists_selected": "Non sono state selezionate liste per l'invio rapido. Si prega di farlo nelle impostazioni.",
    "word_tab_menu_quick_send_to_anki": "Invio rapido ad Anki",
  ...
  "HomeScreen": {
    "account_page_char_input_error": "Immettere esattamente un carattere giapponese.",
    "account_page_char_updated_profile": "Profilo aggiornato con successo!",
    ...
    "account_page_generic_error": "Si è verificato un errore inatteso",
    "account_page_link_sent": "Controlla la tua e-mail per il link di accesso!",
    "account_page_link_to_sponsor": "Collegamento con l'account dello Sponsor",
    ...
    "account_page_user_name_input_error": "Il nome utente deve essere compreso tra 1 e 10 caratteri.",
  ...
  "InitScreen": {
    ...
    "RatePopup_text": "Ti piace \"{{PRODUCT}}\"?\nSe è così, una valutazione sarebbe fantastica e aiuterebbe molto questo progetto!",
    "complete_log": "registro completo",
    "downgrade_warning": "Avete declassato {{PRODUCT}}! Questa non è un'azione supportata ed è molto probabile che possa danneggiare i dati memorizzati o addirittura rendere {{PRODUCT}} completamente inutilizzabile! Si prega di ripristinare tutti i dati in \"impostazioni -> impostazioni avanzate\" e di riavviare l'applicazione.",
    ...
    "download_popup_permission": "Prima di iniziare, è necessario scaricare alcuni file (~{DOWNLOAD_SIZE}MB). Questa operazione verrà eseguita una sola volta. Assicuratevi di avere una connessione Internet stabile e non chiudete l'applicazione mentre il download è in corso.",
    "new_version_available_heading": "Nuova versione disponibile!",
    "new_version_available_text": "È disponibile una nuova versione di {{PRODUCT}}!",
    "new_version_comparison": "Si sta eseguendo {NUMERO_VERSIONE}, la versione più recente è {NUMERO_NEW_VERSION}.",
    "new_versions_available_text": "Sono disponibili {NEW_VERSIONS} nuove versioni di {{PRODUCT}}!",
    "rate_this_app": "Tasso",
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Per iniziare a utilizzare {{PRODUCT}} e Anki è necessario premere il pulsante sottostante. Verrà controllato se la configurazione è corretta.\n\nSe il messaggio è di successo, {{PRODUCT}} e Anki sono collegati e si può iniziare a usare {{PRODUCT}} con Anki.\nSe viene visualizzato un messaggio di errore, seguire le istruzioni fornite nel messaggio e premere nuovamente il pulsante.\nSenza un messaggio di successo, {{PRODUCT}} non sarà in grado di inviare le schede ad Anki. Assicurarsi quindi di aver premuto il pulsante sottostante e di aver ricevuto un messaggio di successo. È anche possibile verificare se l'impostazione è avvenuta con successo in Impostazioni → Anki.",
    "anki_connection_test_title": "Configurazione del test",
    "anki_setup_android_text": "È necessario aver installato [AnkidDroid](https://play.google.com/store/apps/details?id=com.ichi2.anki) e, quando viene richiesto, concedere a {{PRODUCT}} il permesso di interagire con Anki.",
    "anki_setup_android_title": "Android",
    ...
    "anki_setup_intro": "{{PRODUCT}} può essere utilizzato per inviare note ad Anki. Per questo, ogni piattaforma richiede una configurazione diversa.",
    "anki_setup_ios_text": "L'installazione su iOS è un po' complicata perché AnkiMobile non consente di aggiungere tipi di note, cosa che invece è possibile su Android e desktop. Pertanto, è necessario importare un mazzo Anki con il tipo di nota {{PRODUCT}} (non è necessario farlo se si sono esportate le carte da {{PRODUCT}} ad Anki su un altro dispositivo).\n\n1. Installare [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Scaricare il mazzo Anki preconfezionato da [qui](https://github.com/CaptainDario/{{PRODUCT}}-Dependencies/releases/download/v3.4.6/{{PRODUCT}}.apkg)\n3. Toccare il file scaricato per aprire la finestra di dialogo di importazione di AnkiMobile.\n4. Importare il mazzo\n5. Quando viene richiesto, permettete a {{PRODUCT}} di comunicare con AnkiMobile e di leggere gli appunti.",
    "anki_setup_ios_title": "iOS",
    ...
    "anki_test_connection_note_type_not_available": "Il tipo di nota {{PRODUCT}} non è disponibile in Anki! È possibile aggiungerlo manualmente importando il mazzo preconfezionato menzionato nella guida alla configurazione di iOS.",
    "anki_test_connection_success": "Sei connesso ad Anki! 🎉",
    "anki_title": "Anki",
    "deep_links_text": "I collegamenti profondi sono un modo per collegarsi direttamente ai contenuti di un'applicazione. {{PRODUCT}} fornisce due schemi per questo tipo di link {{PRODUCT}}:// e http(s)://{{PRODUCT}}.app/app. Utilizzando questa funzione è possibile, ad esempio, aprire la ricerca del dizionario toccando questo link [{{PRODUCT}}://dictionary?search=食べる] ({{PRODUCT}}://dictionary?search=食べる). Per tutti i collegamenti supportati, vedere [{{PRODUCT}}.app/deep-links](https://{{PRODUCT}}.app/deep-links).",
    "deep_links_title": "Deep Links",
    "dict_examples_title": "Esempi",
    "dict_kanji_animation_text": "{{PRODUCT}} può mostrare diagrammi animati dell'ordine dei tratti della maggior parte dei Kanji / Kana inclusi. Queste animazioni possono essere controllate in diversi modi.\nToccando due volte si ottengono risultati diversi a seconda dello stato attuale dell'animazione. Se l'animazione è in corso di riproduzione, viene messa in pausa. Allo stesso modo, se l'animazione è in pausa, continuerà a essere riprodotta. Infine, se l'animazione è terminata, il doppio tocco la farà ripartire dall'inizio.\nPassando il dito sul kanji si può controllare l'avanzamento dell'animazione. Passando il dito a sinistra si riavvolge l'animazione, mentre passando il dito a destra la si fa avanzare.",
    ...
    "misc_drawer_reorder_text": "Per soddisfare al meglio ogni utente, {{PRODUCT}} consente di riordinare gli elementi del menu di navigazione principale. È sufficiente premere su qualsiasi voce di menu per trascinarla nel punto desiderato.",
    "misc_title": "Varie",
    "text_paste_button_text": "Premendo questo pulsante si incolla il contenuto degli appunti.\nPremendo a lungo questo pulsante si passa all'incollamento automatico e si incolla sempre il contenuto degli appunti quando cambia.",
    "text_paste_button_title": "Pulsante Incolla",
  ...
  "OcrScreen": {
    "title": "OCR",
    "tutorial_begin_text": "Vi mostreremo una rapida esercitazione per iniziare.",
    "tutorial_begin_title": "Benvenuti nella schermata della tabella OCR!"
  },
  "OnBoarding": {
    "Onboarding_1_text": "Basta disegnarlo e \"{{PRODUCT}}\" mostrerà il carattere desiderato.",
    "Onboarding_1_title": "Non conosci un kanji?",
    "Onboarding_2_text": "Con \"{{PRODUCT}}\" è possibile cercare rapidamente le parole utilizzando il dizionario incorporato o su Internet.",
    "Onboarding_2_title": "Ricerca di caratteri e parole",
    "Onboarding_3_text": "Utilizzate gli strumenti di analisi del testo di {{PRODUCT}} per aggiungere furigana, spazi e altro o per tradurre l'intera frase.",
    "Onboarding_3_title": "Non sapete leggere una frase?",
    "Onboarding_4_text": "{{PRODUCT}} ha tabelle di Kanji e Kana per consentirvi di studiarli in modo efficiente.",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_matrix": "Sono nella matrice",
    "advanced_settings_number_search_procs": "Numero di processi di ricerca (@:SettingsScreen.requires_restart)",
    "advanced_settings_number_search_procs_body": "Quando {{PRODUCT}} cerca nel suo database, utilizza più processi. Di solito, 2 è un buon valore per il database standard incluso in {{PRODUCT}}. Tuttavia, se si verificano rallentamenti durante la ricerca nel database, provare a utilizzare più processi.",
    "advanced_settings_optimize_backend": "Backend",
    "advanced_settings_optimize_cancel": "Annullamento",
    "advanced_settings_optimize_latency": "Latenza (ms)",
    "advanced_settings_optimize_nn": "Ottimizzare le reti neurali",
    "advanced_settings_optimize_ok": "Ok",
    "advanced_settings_optimize_results": "Risultati dell'ottimizzazione",
    ...
    "anki_allow_duplicates": "Consentire l'aggiunta di duplicati",
    "anki_allow_duplicates_explanation": "I duplicati vengono controllati confrontando il primo campo del tipo di nota {{PRODUCT}}. Una corrispondenza è ogni altra scheda che ha lo stesso identico contenuto in quel campo.\nPer impostazione predefinita, questo campo è quello della traduzione. Pertanto, se si modifica la traduzione, sarà possibile aggiungere nuovamente la stessa scheda. Tuttavia, è possibile modificare l'ordine dei campi in Anki. Ogni voce del dizionario è identificata in modo univoco quando si utilizza il campo \"{{PRODUCT}} link\" come primo campo.",
    ...
    "anki_include_example_translations": "Includere traduzioni di esempio",
    ...
    "anki_number_of_examples": "Numero di esempi da aggiungere",
    ...
    "dict_add_to_anki_from_search_results": "Aggiungere ad anki dai risultati della ricerca",
    "dict_add_to_list_from_search_results": "Aggiungi all'elenco dai risultati della ricerca",
    "dict_base_form": "Forma base del termine",
    "dict_base_form_description": "Questa impostazione abilita la \"deconiugazione\" di verbi, aggettivi e copule. Quando è abilitata, {{PRODUCT}} cerca di convertire il termine di ricerca nella sua forma base. Ad esempio, 食べます、食べられる、食べない tutti sono convertiti in 食べる.\nPer gli studenti di livello intermedio, si consiglia di disattivare questa impostazione.",
    "dict_convert_to_kana": "Termine convertito in kana",
    "dict_convert_to_kana_description": "Se si attiva questa impostazione, {{PRODUCT}} converte qualsiasi termine di ricerca in una rappresentazione kana uniforme prima di cercarlo. Ciò significa che la query \"taberu\" sarà convertita in たべる e troverà 食べる, ma può anche portare a corrispondenze non volute.\n\nAd esempio, la ricerca di \"man\" verrà convertita in まん e quindi corrisponderà a 万 e alla parola inglese \"man\".\n\nNota: questa è un'impostazione globale e viene applicata ovunque venga utilizzato il dizionario.",
    ...
    "dict_custom_query_format_title": "Formato di interrogazione delle immagini personalizzato",
    ...
    "dict_matrix_word_speed": "Velocità di parola della matrice",
    ...
    "dict_search_sorting_information": "Come vengono ordinati i risultati della ricerca?",
    "dict_search_sorting_information_description_1": "Questa impostazione consente di personalizzare il modo in cui {{PRODUCT}} ordina i risultati della ricerca nei dizionari, cambiando la priorità dell'ordinamento (trascinare per riordinare) o disabilitando la modifica dei termini di ricerca (toccare per disabilitare).\nPer comprendere appieno questa impostazione, vediamo come {{PRODUCT}} ordina i risultati della ricerca utilizzando il termine di esempio \"shikunshi\" (notare che è scritto in romaji). {{PRODUCT}} visualizza i risultati della ricerca in base ai seguenti criteri, dove i criteri più profondi sono meno importanti di quelli più alti.",
    "dict_search_sorting_information_description_2": "1. @:SettingsScreen.dict_term: tutte le voci che corrispondono al \"termine di ricerca\" così com'è, ovvero: \"shikunshi\".\n    1. la voce del dizionario e il termine di ricerca sono esattamente uguali\n        1. i kanji della voce corrispondono\n        2. la lettura corrisponde\n        3. qualsiasi traduzione/significato corrisponde\n    2. la voce del dizionario inizia con il termine di ricerca\n        1. i kanji della voce corrispondono\n        2. corrispondenza di lettura\n        3. qualsiasi traduzione/significato corrisponde\n    3. la voce del dizionario contiene il termine di ricerca da qualche parte (ad esempio: cercando \"kun\" mi mostra \"shi*kun*shi\")\n        1. i kanji della voce corrispondono\n        2. Corrispondenza della lettura\n        3. qualsiasi traduzione/significato corrispondente\n2. @:SettingsScreen.dict_convert_to_kana: tutte le voci che corrispondono a しくんし (convertire il termine di ricerca in kana se possibile)\n    1. sottocriteri come sopra\n    2. ...\n3. @:SettingsScreen.dict_base_form: tutte le voci che corrispondono a しくむ (cerca di trovare la forma base di )\n    1. sottocriteri come sopra\n    2. ...",
    "dict_search_sorting_information_description_3": "Questa impostazione consente di impostare la priorità di ordinamento dei criteri di ordinamento di primo livello.\nPer una descrizione dettagliata del loro significato, leggere le definizioni riportate di seguito.",
    "dict_separate_search_results": "Ordinamento dei risultati della ricerca (trascinare per riordinare, toccare per disabilitare)",
    "dict_show_wikipedia_definitions": "Mostra le definizioni da wikipedia",
    "dict_show_word_freq": "Mostra la frequenza delle parole",
    "dict_show_word_freq_body": "{{PRODUCT}} utilizza la frequenza delle parole per classificare le voci del suo dizionario. La frequenza delle parole è una stima dell'uso di una parola e si basa su diverse fonti di dati:\n\n* Wikipedia, che rappresenta un testo enciclopedico\n* Sottotitoli, da OPUS OpenSubtitles 2018 e SUBTLEX\n* Testo web, da OSCAR\n* Twitter, che rappresenta i social media in forma breve\n* Reddit, che rappresenta i commenti potenzialmente più lunghi su Internet\n\nIl numero mostrato in {{PRODUCT}} è una variante della frequenza effettiva delle parole, chiamata [frequenza Zipf] (https://en.wikipedia.org/wiki/Zipf%27s_law), che mira a restituire la frequenza delle parole su una scala logaritmica di facile comprensione. La frequenza Zipf di una parola è il logaritmo in base 10 del numero di volte in cui appare su un miliardo di parole. Ad esempio, una parola con valore Zipf 6 appare una volta ogni mille parole, mentre una parola con valore Zipf 3 appare una volta ogni milione di parole.\nI valori Zipf ragionevoli sono compresi tra 0 e 8, ma il valore Zipf minimo che appare in {{PRODUCT}} è 1,0. Utilizziamo 0 come valore Zipf predefinito per le parole che non compaiono nelle fonti di dati, anche se dovrebbe significare un'occorrenza ogni miliardo di parole.\n[Per saperne di più...](https://github.com/rspeer/wordfreq)",
    "dict_term": "Termine di ricerca",
    "dict_term_description": "Il termine di ricerca è esattamente quello digitato dall'utente.",
    ...
    "misc_font_size_scale": "Fattore di scala della dimensione del carattere",
    "misc_language": "lingua (@:SettingsScreen.restarts_app)",
    "misc_settings_always_save_window_position": "Salva la posizione della finestra durante lo spostamento",
    "misc_settings_always_save_window_size": "Salvataggio delle dimensioni della finestra in caso di ridimensionamento",
    "misc_settings_window_size": "Salva la dimensione e la posizione della finestra corrente",
    "misc_sharing_pattern": "Schema da utilizzare per la condivisione dei contenuti.",
    ...
    "time_tracking_current_ratio_text": "Guadagna ~{CURRENT_RATIO} min break / ora",
    "time_tracking_enabled": "Tracciamento del tempo abilitato",
    "time_tracking_session_legnth": "Durata di una sessione",
    "time_tracking_session_length_description": "Durata di una sessione",
    ...
    "word_lists_languages_to_include_in_export": "Lingue da includere nell'esportazione",
    ...
    "word_lists_quick_add_lists": "Elenco di parole da aggiungere rapidamente:",
    "word_lists_readd_defaults": "Aggiungere la cartella predefinita",
    "word_lists_screensaver_auto_show": "Screensaver: Avvio automatico dello screensaver",
  ...
  "TimeTrackingScreen": {
    ...
    "add_category_hint": "Inserire il nome della categoria (ad es. Kanji)",
    "add_tag": "Aggiungi tag",
    "add_tag_hint": "Inserire il nome del tag (ad es. N2)",
    "break_caps": "BREAK",
    "cancel": "Annullamento",
  ...
  "WordListsScreen": {
    ...
    "export_csv_progress": "Creare CSV, attendere...",
    "export_images": "Esportazione di immagini",
    "export_images_progress": "Rendering delle immagini, attendere...",
    "export_pdf": "Esportazione PDF",
    "export_pdf_progress": "Creazione del PDF, attendere...",
...
static const Map<String,dynamic> _spa = {
  ...
  "ClipboardScreen": {
    "title": "Portapapeles",
    "tutorial_android_limitation": "En Android, esta pantalla no puede leer automáticamente el portapapeles en segundo plano. Necesitas tener la aplicación en primer plano. En iOS, puedes permitir que {{PRODUCT}} lea tu portapapeles en los ajustes. De esta forma no te pedirá siempre que permitas pegar. Disculpa las molestias.",
    ...
    "tutorial_explanation": "Sólo tienes que copiar un texto y {{PRODUCT}} te mostrará las entradas del diccionario y mucho más.",
    "tutorial_pin_button": "Este botón hace que {{PRODUCT}} se muestre siempre encima de otras ventanas. Además, se reduce el tamaño y se ocultan el marco y la barra de aplicaciones. Con esto {{PRODUCT}} puede ser utilizado como ayuda a la lectura sobre cualquier otra aplicación."
  },
  "DictionaryScreen": {
    "example_tab": "Ejemplo",
    ...
    "word_tab_menu_quick_add_to_list": "Añadir rápidamente a la lista",
    "word_tab_menu_quick_add_to_list_no_lists_selected": "No se han seleccionado listas para el envío rápido. Por favor, hágalo en los ajustes.",
    "word_tab_menu_quick_send_to_anki": "Envío rápido a Anki",
  ...
  "HomeScreen": {
    "account_page_char_input_error": "Introduzca exactamente un carácter japonés.",
    "account_page_char_updated_profile": "¡Perfil actualizado con éxito!",
    ...
    "account_page_generic_error": "Se ha producido un error inesperado",
    "account_page_link_sent": "Consulta tu correo electrónico para ver el enlace de acceso.",
    "account_page_link_to_sponsor": "Enlace con la cuenta del patrocinador",
    ...
    "account_page_user_name_input_error": "El nombre de usuario debe tener entre 1 y 10 caracteres.",
  ...
  "InitScreen": {
    ...
    "RatePopup_text": "Te gusta {{PRODUCT}}?\nSi ese es el caso, dejarnos una calificación sería genial y ayudaría mucho al proyecto!",
    "complete_log": "registro completo",
    "downgrade_warning": "¡Has degradado {{PRODUCT}}! Esta acción no está permitida y es muy probable que se rompan tus datos almacenados o incluso que {{PRODUCT}} quede completamente inutilizable. Por favor, restablece todos los datos en \"ajustes -> ajustes avanzados\" y reinicia la aplicación.",
    ...
    "download_popup_permission": "Tenemos que descargar algunos archivos antes de que pueda empezar (~{DOWNLOAD_SIZE}MB). Esto solo ocurrirá una vez. Asegúrate de tener una conexión a Internet estable y no cierres la aplicación mientras se realiza la descarga.",
    "new_version_available_heading": "Nueva versión disponible",
    "new_version_available_text": "¡Hay una nueva versión de {{PRODUCT}} disponible!",
  ...
  "ManualScreen": {
    "anki_connection_test_text": "Para empezar a utilizar {{PRODUCT}} y Anki tienes que pulsar el botón de abajo. Comprobará si tu configuración es correcta.\n\nSi recibes un mensaje de éxito, {{PRODUCT}} y Anki están conectados y puedes empezar a usar {{PRODUCT}} con Anki.\nSi recibes un mensaje de error, por favor sigue las instrucciones dadas en el mensaje y pulsa el botón de nuevo después.\nSin un mensaje de éxito, {{PRODUCT}} no podrá enviar tarjetas a Anki. Por lo tanto, asegúrate de que pulsas el botón de abajo y de que recibes un mensaje de éxito. También puedes comprobar si la configuración se ha realizado correctamente en ajustes → Anki.",
    "anki_connection_test_title": "Configuración de la prueba",
    "anki_setup_android_text": "Necesitas tener instalado [AnkidDroid](https://play.google.com/store/apps/details?id=com.ichi2.anki) y cuando te lo pida, conceder permiso a {{PRODUCT}} para interactuar con Anki.",
    "anki_setup_android_title": "Android",
    ...
    "anki_setup_intro": "{{PRODUCT}} puede utilizarse para enviar notas a Anki. Para ello, cada plataforma requiere una configuración diferente.",
    "anki_setup_ios_text": "La configuración en iOS es un poco engorrosa ya que AnkiMobile no permite añadir tipos de notas, lo que sí es posible en Android y escritorio. Por lo tanto, necesitas importar un mazo de Anki con el tipo de nota {{PRODUCT}} (no necesitas hacer esto si has exportado tarjetas de {{PRODUCT}} a anki en otro dispositivo).\n\n1. Instala [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Descarga la baraja pre-hecha de Anki desde [aquí](https://github.com/CaptainDario/{{PRODUCT}}-Dependencies/releases/download/v3.4.6/{{PRODUCT}}.apkg)\n3. Pulsa sobre el archivo descargado, esto abrirá el diálogo de importación de AnkiMobile\n4. Importa el mazo\n5. Cuando se te pida permite que {{PRODUCT}} se comunique con AnkiMobile y lea tu portapapeles",
    "anki_setup_ios_title": "iOS",
    ...
    "anki_test_connection_note_type_not_available": "¡El tipo de nota {{PRODUCT}} no está disponible en Anki! Puedes añadirlo manualmente importando el mazo prefabricado mencionado en la guía de configuración de iOS.",
    "anki_test_connection_success": "¡Estás conectado a Anki! 🎉",
    "anki_title": "Anki",
    "deep_links_text": "Los enlaces profundos son una forma de enlazar directamente al contenido de una aplicación. {{PRODUCT}} ofrece dos esquemas para ello {{PRODUCT}}:// y http(s)://{{PRODUCT}}.app/app. Usando esta función puedes, por ejemplo, abrir la búsqueda del diccionario al tocar este enlace [{{PRODUCT}}://diccionario?buscar=食べる]({{PRODUCT}}://diccionario?buscar=食べる). Para ver todos los enlaces compatibles, consulta [{{PRODUCT}}.app/deep-links](https://{{PRODUCT}}.app/deep-links)",
    "deep_links_title": "Deep Links",
    "dict_examples_title": "Ejemplos",
    "dict_kanji_animation_text": "{{PRODUCT}} puede mostrar diagramas animados del orden de los trazos de la mayoría de los Kanji / Kana incluidos. Estas animaciones se pueden controlar de diferentes maneras.\nPulsando dos veces, se obtienen diferentes resultados dependiendo del estado actual de la animación. Si la animación se está reproduciendo, la pausará. Del mismo modo, si la animación está en pausa, continuará reproduciéndose. Por último, si la animación ha terminado, el doble toque reiniciará la animación desde el principio.\nDeslizando el dedo sobre el kanji se puede controlar el progreso de la animación. Deslizar a la izquierda rebobinará la animación mientras que deslizar a la derecha la hará avanzar.",
    ...
    "misc_drawer_reorder_text": "Para adaptarse a cada usuario de la mejor manera posible, {{PRODUCT}} te permite reordenar los elementos del menú de navegación principal. Solo tienes que pulsar sobre cualquier entrada del menú hasta que puedas arrastrarla al lugar que desees.",
    "misc_title": "Varios",
    "text_paste_button_text": "Pulsando este botón se pega el contenido del portapapeles.\nPulsando prolongadamente este botón se cambia a pegado automático y siempre se pega el contenido del portapapeles cuando cambia.",
    "text_paste_button_title": "Botón Pegar",
  ...
  "OcrScreen": {
    "title": "OCR",
    "tutorial_begin_text": "Vamos a mostrarte un corto tutorial para que empieces.",
    "tutorial_begin_title": "Bienvenido a la pantalla de la tabla OCR"
  },
  "OnBoarding": {
    "Onboarding_1_text": "Solo dibújalo y {{PRODUCT}} te mostrará el caracter que necesitas.",
    "Onboarding_1_title": "No sabes un Kanji?",
    "Onboarding_2_text": "Con \"{{PRODUCT}}\" puedes buscar palabras rápidamente utilizando el diccionario incorporado o en Internet.",
    "Onboarding_2_title": "Busca caracteres y palabras",
    "Onboarding_3_text": "Utiliza las herramientas de análisis de texto de {{PRODUCT}} para añadir furiganas, espacios y mucho más, o traduce la frase entera.",
    "Onboarding_3_title": "¿No sabe leer una frase?",
    "Onboarding_4_text": "{{PRODUCT}} dispone de tablas de Kanji y Kana para que puedas estudiarlos de forma eficaz.",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_matrix": "Estoy en la matriz",
    "advanced_settings_number_search_procs": "Número de procesos de búsqueda (@:SettingsScreen.requires_restart)",
    "advanced_settings_number_search_procs_body": "Cuando {{PRODUCT}} busca en su base de datos utiliza múltiples procesos. Normalmente, 2 es un buen valor para la base de datos estándar incluida con {{PRODUCT}}. Sin embargo, si experimentas ralentizaciones al buscar en la base de datos, prueba a utilizar más procesos.",
    "advanced_settings_optimize_backend": "Backend",
    "advanced_settings_optimize_cancel": "Cancelar",
    "advanced_settings_optimize_latency": "Latencia (ms)",
    "advanced_settings_optimize_nn": "Optimizar las redes neuronales",
    "advanced_settings_optimize_ok": "Ok",
    "advanced_settings_optimize_results": "Resultados de la optimización",
    ...
    "anki_allow_duplicates": "Permitir añadir duplicados",
    "anki_allow_duplicates_explanation": "Los duplicados se comprueban comparando el primer campo del tipo de nota {{PRODUCT}}. Una coincidencia es cualquier otra tarjeta que tenga exactamente el mismo contenido en ese campo.\nPor defecto, este es el campo de traducción. Por lo tanto, si modifica la traducción, será posible volver a añadir la misma ficha. Sin embargo, puedes cambiar el orden de los campos en Anki. Cada entrada del diccionario se identifica de forma única cuando se utiliza el campo \"Enlace {{PRODUCT}}\" como primer campo.",
    ...
    "anki_include_example_translations": "Incluir ejemplos de traducciones",
    ...
    "anki_number_of_examples": "Número de ejemplos a añadir",
    ...
    "dict_add_to_anki_from_search_results": "Añadir a anki desde los resultados de búsqueda",
    "dict_add_to_list_from_search_results": "Añadir a la lista desde los resultados de búsqueda",
    "dict_base_form": "Forma base del término",
    "dict_base_form_description": "Esta opción activa la \"desconjugación\" de verbos, adjetivos y cópulas. Cuando está activada, {{PRODUCT}} intenta convertir el término buscado en su forma base. Por ejemplo, 食べます、食べられる、食べない se convierte en 食べる.\nPara los alumnos de nivel intermedio, la recomendación es desactivar este ajuste.",
    "dict_convert_to_kana": "Término convertido a kana",
    "dict_convert_to_kana_description": "Al activar esta opción, {{PRODUCT}} convierte cualquier término de búsqueda a una representación kana uniforme antes de buscarlo. Esto significa que la consulta \"taberu\" se convertirá a たべる y encontrará 食べる, pero también puede dar lugar a coincidencias no deseadas.\n\nPor ejemplo, al buscar \"man\" se convertirá en まん y, por lo tanto, coincidirá con 万 y la palabra inglesa \"man\".\n\nNota: esta configuración es global y se aplica en todos los lugares en los que se utiliza el diccionario.",
    ...
    "dict_custom_query_format_title": "Formato personalizado de consulta de imágenes",
    ...
    "dict_matrix_word_speed": "Velocidad de palabra de la matriz",
    ...
    "dict_search_sorting_information": "¿Cómo se ordenan los resultados de la búsqueda?",
    "dict_search_sorting_information_description_1": "Este ajuste te permite personalizar la forma en que {{PRODUCT}} ordena los resultados de la búsqueda en el diccionario cambiando la prioridad de ordenación (arrastra para reordenar) o desactivando la modificación del término de búsqueda (toca para desactivar).\\\nPara entender completamente esta opción, veamos cómo {{PRODUCT}} ordena los resultados de búsqueda utilizando el término de búsqueda de ejemplo \"shikunshi\" (ten en cuenta que está escrito en romaji). {{PRODUCT}} mostrará los resultados de la búsqueda basándose en los siguientes criterios, en los que los criterios anidados más profundos son menos importantes que los superiores.",
    "dict_search_sorting_information_description_2": "1. @:SettingsScreen.dict_term: todas las entradas que coinciden con el \"Término de búsqueda\" tal cual, es decir: \"shikunshi\"\n    1. la entrada del diccionario y el término de búsqueda coinciden exactamente\n        1. los kanji de la entrada coinciden\n        2. la lectura coincide\n        3. cualquier traducción / significado coincide\n    2. la entrada del diccionario comienza con el término buscado\n        1. los kanji de la entrada coinciden\n        2. coincidencias de lectura\n        3. cualquier coincidencia de traducción / significado\n    3. la entrada del diccionario contiene el término buscado en alguna parte (por ejemplo: busco \"kun\" y me muestra \"shi*kun*shi\")\n        1. los kanji de la entrada coinciden\n        2. coincidencias de lectura\n        3. cualquier coincidencia de traducción / significado\n2. @:SettingsScreen.dict_convert_to_kana: todas las entradas que coincidan con しくんし (convertir el término de búsqueda a kana si es posible)\n    1. subcriterios iguales a los anteriores\n    2. ...\n3. @:SettingsScreen.dict_base_form: todas las entradas que coincidan con しくむ (intentar encontrar la forma base de )\n    1. subcriterios igual que arriba\n    2. ...",
    "dict_search_sorting_information_description_3": "Este ajuste permite establecer la prioridad de ordenación de los criterios de ordenación de nivel superior.\nPara obtener una descripción detallada de su significado, lea las definiciones que figuran a continuación.",
    "dict_separate_search_results": "Ordenación de los resultados de búsqueda (arrastre para reordenar, pulse para desactivar)",
    "dict_show_wikipedia_definitions": "Mostrar definiciones de wikipedia",
    "dict_show_word_freq": "Mostrar frecuencia de palabras",
    "dict_show_word_freq_body": "{{PRODUCT}} utiliza la frecuencia de palabras para clasificar las entradas de su diccionario. Esta frecuencia de palabras es una estimación del uso de una palabra y se basa en diferentes fuentes de datos:\n\n* Wikipedia, que representa el texto enciclopédico.\n* Subtítulos, de OPUS OpenSubtitles 2018 y SUBTLEX\n* Texto web, de OSCAR\n* Twitter, que representa medios sociales breves\n* Reddit, que representa comentarios de Internet potencialmente más largos\n\nEl número que se muestra en {{PRODUCT}} es una variación de la frecuencia real de las palabras denominada [frecuencia Zipf](https://en.wikipedia.org/wiki/Zipf%27s_law), cuyo objetivo es obtener la frecuencia de las palabras en una escala logarítmica de fácil comprensión. La frecuencia Zipf de una palabra es el logaritmo en base 10 del número de veces que aparece por cada mil millones de palabras. Una palabra con valor Zipf 6 aparece una vez por cada mil palabras, por ejemplo, y una palabra con valor Zipf 3 aparece una vez por cada millón de palabras.\nLos valores Zipf razonables están entre 0 y 8, pero el valor Zipf mínimo que aparece en {{PRODUCT}} es 1,0. Utilizamos 0 como valor Zipf por defecto para las palabras que no aparecen en las fuentes de datos, aunque debería significar una aparición por cada mil millones de palabras.\n[Leer más...](https://github.com/rspeer/wordfreq)",
    "dict_term": "Término de búsqueda",
    "dict_term_description": "El término de búsqueda exactamente como lo escribió el usuario.",
    ...
    "misc_font_size_scale": "Factor de escala del tamaño de fuente",
    "misc_language": "idioma (@:SettingsScreen.restarts_app)",
    "misc_settings_always_save_window_position": "Guardar la posición de la ventana al moverla",
    "misc_settings_always_save_window_size": "Guardar el tamaño de la ventana al cambiar el tamaño",
    "misc_settings_window_size": "Guardar el tamaño y la posición actuales de la ventana",
    "misc_sharing_pattern": "Esquema a utilizar al compartir contenidos.",
    "misc_theme": "tema (@:SettingsScreen.restarts_app)",
    ...
    "time_tracking_current_ratio_text": "Gana ~{CURRENT_RATIO} min descanso / hora",
    "time_tracking_enabled": "Seguimiento horario activado",
    "time_tracking_session_legnth": "Duración de una sesión",
    "time_tracking_session_length_description": "Duración de una sesión",
    ...
    "word_lists_languages_to_include_in_export": "Lenguas que deben incluirse al exportar",
    ...
    "word_lists_quick_add_lists": "Lista(s) de palabras de adición rápida:",
    "word_lists_readd_defaults": "Añadir la carpeta por defecto",
    "word_lists_screensaver_auto_show": "Salvapantallas: Salvapantallas de inicio automático",
  ...
  "TimeTrackingScreen": {
    ...
    "add_category_hint": "Introduzca el nombre de la categoría (por ejemplo, Kanji)",
    "add_tag": "Añadir etiqueta",
    "add_tag_hint": "Introduzca el nombre de la etiqueta (por ejemplo, N2)",
    "break_caps": "DESCANSO",
    "cancel": "Cancelar",
    "categories": "Categoría",
    "end_session": "Fin de la sesión",
    "pause": "Pausa",
    "ready_caps": "LISTO",
    "resume": "Currículum",
  ...
  "WordListsScreen": {
    ...
    "export_csv_progress": "Creando CSV, por favor espere...",
    "export_images": "Exportar imágenes",
    "export_images_progress": "Renderizando imágenes, por favor espere...",
    "export_pdf": "Exportar PDF",
    "export_pdf_progress": "Creando PDF, por favor espere...",
...
static const Map<String,dynamic> _eng = {
  ...
  "ClipboardScreen": {
    "title": "Clipboard",
    "tutorial_android_limitation": "On Android, this screen cannot automatically read your clipboard in the background. You need to have the app in the foreground. On iOS, you can allow {{PRODUCT}} to read your clipboard in the settings. This way it will not always ask you to allow pasting. Sorry for the inconvenience.",
    ...
    "tutorial_explanation": "Just copy some text and {{PRODUCT}} will show dictionary entries and more!",
    "tutorial_pin_button": "This button makes {{PRODUCT}} show always on top of other windows. Additionally, the size is reduced and the frame and appbar are hidden. With this {{PRODUCT}} can be used as a reading aid over any other application."
  },
  "DictionaryScreen": {
    ...
    "word_tab_menu_quick_add_to_list": "Quick add to list",
    "word_tab_menu_quick_add_to_list_no_lists_selected": "No lists for quick send have been selected. Please do so in the settings.",
    "word_tab_menu_quick_send_to_anki": "Quick send to Anki",
  ...
  "HomeScreen": {
    "account_page_char_input_error": "Input exactly one Japanese character.",
    "account_page_char_updated_profile": "Successfully updated profile!",
    ...
    "account_page_generic_error": "Unexpected error occurred",
    "account_page_link_sent": "Check your email for the login link!",
    "account_page_link_to_sponsor": "Link with Sponsor account",
    ...
    "account_page_user_name_input_error": "Username must be between 1 and 10 characters.",
  ...
  "InitScreen": {
    ...
    "RatePopup_text": "Do you like \"{{PRODUCT}}\"?\nIf that is the case a rating would be awesome and it would help this project a lot!",
    "complete_log": "complete log",
    "downgrade_warning": "You downgraded {{PRODUCT}}! This is not a supported action and is very likely to break your stored data or even make {{PRODUCT}} completely unusable! Please reset all data in \"settings -> advanved settings\" and restart the app.",
    ...
    "download_popup_permission": "We need to download some files before you can get started (~{DOWNLOAD_SIZE}MB). This will only happen once. Please make sure you have a stable internet connection and do not close the app while the download is in progress.",
    "new_version_available_heading": "New version Available!",
    "new_version_available_text": "There is a new version of {{PRODUCT}} available!",
    "new_version_comparison": "You are running {VERSION_NUMBER}, the newest version is {NEW_VERSION_NUMBER}",
    "new_versions_available_text": "There are {NEW_VERSIONS} new versions of {{PRODUCT}} available!",
    "rate_this_app": "Rate",
  ...
  "ManualScreen": {
    "anki_connection_test_text": "To start using {{PRODUCT}} and Anki you need to press the button below. It will check if your setup is correct.\n\nIf you get a success message, {{PRODUCT}} and Anki are connected and you can start using {{PRODUCT}} with Anki.\nIf you get an error message, please follow the instructions given in the message and press the button again afterward.\nWithout a success message, {{PRODUCT}} will not be able to send cards to Anki. Therefore, ensure that you press the button below and that you get a success message. You can also check if the setup was successful in settings → Anki.",
    "anki_connection_test_title": "Test setup",
    "anki_setup_android_text": "You need to have [AnkidDroid](https://play.google.com/store/apps/details?id=com.ichi2.anki) installed and when asked grant {{PRODUCT}} permission to interact with Anki.",
    "anki_setup_android_title": "Android",
    ...
    "anki_setup_intro": "{{PRODUCT}} can be used to send notes to Anki. For this, each platform requires a different setup.",
    "anki_setup_ios_text": "Setup on iOS is a bit cumbersome as AnkiMobile does not allow adding note types, which is possible on Android and desktop. Therefore you need to import an Anki deck with the {{PRODUCT}} note type (you do not need to do this if you have exported cards from {{PRODUCT}} to anki on another device)\n\n1. Install [AnkiMobile](https://apps.apple.com/us/app/ankimobile-flashcards/id373493387)\n2. Download the pre-made Anki deck from [here](https://github.com/CaptainDario/{{PRODUCT}}-Dependencies/releases/download/v3.4.6/{{PRODUCT}}.apkg)\n3. Tap on the downloaded file, this will open the import dialog of AnkiMobile\n4. Import the deck\n5. When asked permit {{PRODUCT}} to communicate with AnkiMobile and read your clipboard",
    "anki_setup_ios_title": "iOS",
    "anki_setup_title": "Setup",
    "anki_test_connection": "Test {{PRODUCT}} and Anki setup",
    ...
    "anki_test_connection_note_type_not_available": "The {{PRODUCT}} note type is not available in Anki! You can add it manually by importing the premade deck mentioned in the iOS setup guide.",
    "anki_test_connection_success": "You are connected to Anki! 🎉",
    "anki_title": "Anki",
    "deep_links_text": "Deep links are a way to directly link to content in an app. {{PRODUCT}} provides two schemes for this {{PRODUCT}}:// and http(s)://{{PRODUCT}}.app/app. Using this feature you can for example open the dictionary search when tapping this link {{PRODUCT}}://dictionary?search=食べる. For all supported links see [{{PRODUCT}}.app/deep-links](https://{{PRODUCT}}.app/deep-links)",
    "deep_links_title": "Deep Links",
    "dict_examples_title": "Examples",
    "dict_kanji_animation_text": "{{PRODUCT}} can show animated stroke order diagrams of most of the included Kanji / Kana. These animations can be controlled in different ways. \nDouble tapping, has different results depending on the current state of the animation. If the animation is currently playing, it will pause it. Similarly, when the animation is currently paused, it will continue playing the animation. Lastly, if the animation has finished, double tapping will restart the animation from the beginning.\nBy Swiping on the kanji the animation progress can be controlled. Swiping left will rewind the animation while swiping right will advance the animation.",
    "dict_kanji_animation_title": "Animations",
    ...
    "misc_drawer_reorder_text": "To suit every user in the best way possible, {{PRODUCT}} allows you to reorder the elements in the main navigation menu. Simply press on any menu entry until you can drag it to your desired spot.",
    "misc_title": "Miscellaneous",
    "text_paste_button_text": "Pressing this button pastes the content of the clipboard.\nLong-pressing this button switches to auto-paste and always pastes your clipboards content when it changes.",
    "text_paste_button_title": "Paste button",
  ...
  "OcrScreen": {
    "title": "OCR",
    "tutorial_begin_text": "We will show you a quick tutorial to get you started.",
    "tutorial_begin_title": "Welcome to the OCR table screen!"
  },
  "OnBoarding": {
    "Onboarding_1_text": "Just draw it and \"{{PRODUCT}}\" will show the character you need.",
    "Onboarding_1_title": "You do not know a Kanji?",
    "Onboarding_2_text": "With \"{{PRODUCT}}\" you can quickly lookup words using the built-in dictionary or check them on the internet.",
    "Onboarding_2_title": "Lookup characters and words",
    "Onboarding_3_text": "Use {{PRODUCT}}'s text analysis tools to add furigana, spaces and more, or translate the whole sentence.",
    "Onboarding_3_title": "Do not know how to read a sentence?",
    "Onboarding_4_text": "{{PRODUCT}} has Kanji and Kana tables to let you study them efficiently.",
  ...
  "SettingsScreen": {
    ...
    "advanced_settings_matrix": "I am in the matrix",
    "advanced_settings_number_search_procs": "Number of search processes  (@:SettingsScreen.requires_restart)",
    "advanced_settings_number_search_procs_body": "When {{PRODUCT}} searches in its database it uses multiple processes. Usually, 2 is a good value for the standard database included with {{PRODUCT}}. However, if you experience slow-downs when searching in the database, try using more processes.",
    "advanced_settings_optimize_backend": "Backend",
    "advanced_settings_optimize_cancel": "Cancel",
    "advanced_settings_optimize_latency": "Latency (ms)",
    "advanced_settings_optimize_nn": "Optimize Neural Networks",
    "advanced_settings_optimize_ok": "Ok",
    "advanced_settings_optimize_results": "Optimization results",
    ...
    "anki_allow_duplicates": "Allow adding duplicates",
    "anki_allow_duplicates_explanation": "Duplicates are checked by comparing the first field of the {{PRODUCT}} note type. A match is every other card that has the exact same content in that field.\nBy default, this is the translation field. Therefore, if you modify the translation, adding the same card will be possible again. However, you can change the order of the fields in Anki. Every dictionary entry is uniquely identified when using the \"{{PRODUCT}} link\" field as the first field.",
    ...
    "anki_include_example_translations": "Include example translations",
    ...
    "anki_number_of_examples": "Number of examples to add",
    ...
    "dict_add_to_anki_from_search_results": "Add to anki from search results",
    "dict_add_to_list_from_search_results": "Add to list from search results",
    "dict_base_form": "Term's baseform",
    "dict_base_form_description": "This setting enables the 'deconjugation' of verbs, adjectives, and copula. When it is enabled, {{PRODUCT}} tries to convert the search term into its base form. For example, 食べます、食べられる、食べない all are converted into 食べる.\n\nFor intermediate learners, the recommendation is to turn off this setting.",
    "dict_convert_to_kana": "Term converted to kana",
    "dict_convert_to_kana_description": "When enabling this setting, {{PRODUCT}} converts any search term to a uniform kana representation before looking it up. This means that the query 'taberu' will be converted to たべる and will find 食べる, but it can also lead to unintended matches.\n\nFor example searching 'man' will be converted to まん and therfore, matches 万 and the english word 'man'.\n\nNote: this is a global setting and is applied everywhere the dictionary is used",
    ...
    "dict_custom_query_format_title": "Custom image query format",
    ...
    "dict_matrix_word_speed": "Matrix word speed",
    ...
    "dict_search_sorting_information": "How are search results sorted?",
    "dict_search_sorting_information_description_1": "This setting allows you to customize how {{PRODUCT}} sorts dictionary search results by changing the sort priority (drag to reorder) or disabling search term modification (tap to disable).\\\nTo fully understand this setting, let us look at how {{PRODUCT}} sorts search results using the example search term \"shikunshi\" (note that it is written in romaji). {{PRODUCT}} will display search results based on the following criteria where deeper nested criteria are less important than higher ones.",
    "dict_search_sorting_information_description_2": "1. @:SettingsScreen.dict_term: all entries that match the \"Search term\" as is ie.: \"shikunshi\"\n    1. the dictionary entry and the search term are the exact same\n        1. kanji of the entry match\n        2. reading matches\n        3. any translation / meaning matches\n    2. the dictionary entry starts with the search term\n        1. kanji of the entry match\n        2. reading matches\n        3. any translation / meaning matches\n    3. the dictionary entry contains the search term somewhere (for example: searching \"kun\" and it shows me \"shi*kun*shi\")\n        1. kanji of the entry match\n        2. reading matches\n        3. any translation / meaning matches\n2. @:SettingsScreen.dict_convert_to_kana: all entries that match しくんし (convert search term to kana if possible)\n    1. sub-criteria same as above\n    2. ...\n3. @:SettingsScreen.dict_base_form: all entries that match しくむ (try to find the base form of )\n    1. sub-criteria same as above\n    2. ...",
    "dict_search_sorting_information_description_3": "This setting allows to set the sort priority of the top-level sort criteria.\nFor a detailed description of their meaning please read the definitions below.",
    "dict_separate_search_results": "Sort order of search results (drag to reorder, tap to disable)",
    "dict_show_wikipedia_definitions": "Show definitions from wikipedia",
    "dict_show_word_freq": "Show word frequency",
    "dict_show_word_freq_body": "{{PRODUCT}} uses word frequency to rank its dictionary entries. This word frequency is an estimation of a word's usage and is based on different data sources:\n\n* Wikipedia, representing encyclopedic text\n* Subtitles, from OPUS OpenSubtitles 2018 and SUBTLEX\n* Web text, from OSCAR\n* Twitter, representing short-form social media\n* Reddit, representing potentially longer Internet comments\n\nThe number shown in {{PRODUCT}} is a variation on the actual word frequency called [Zipf frequency](https://en.wikipedia.org/wiki/Zipf%27s_law) that aims to return the word frequency on a human-friendly logarithmic scale. The Zipf frequency of a word is the base-10 logarithm of the number of times it appears per billion words. A word with Zipf value 6 appears once per thousand words, for example, and a word with Zipf value 3 appears once per million words.\nReasonable Zipf values are between 0 and 8, but the minimum Zipf value appearing in {{PRODUCT}} is 1.0. We use 0 as the default Zipf value for words that do not appear in the data sources, although it should mean one occurrence per billion words.\n[Read more...](https://github.com/rspeer/wordfreq)",
    "dict_term": "Search term",
    "dict_term_description": "The search term exactly as the user typed it.",
    ...
    "misc_font_size_scale": "Font size scaling factor",
    "misc_language": "language",
    "misc_settings_always_save_window_position": "Save window position on move",
    "misc_settings_always_save_window_size": "Save window size on resize",
    "misc_settings_window_size": "Save current window size and position",
    "misc_sharing_pattern": "Schema to use when sharing content.",
    ...
    "time_tracking_break_length_description": "Earns you a break of",
    "time_tracking_break_length_unit": "min.",
    "time_tracking_break_minutes": "Minutes of break per session",
    "time_tracking_categories": "Categories",
    "time_tracking_current_ratio_text": "Earns ~{CURRENT_RATIO}  min break / hour",
    "time_tracking_enabled": "Time tracking enabled",
    "time_tracking_session_legnth": "Length of one session",
    "time_tracking_session_length_description": "Every session of",
    "time_tracking_session_length_unit": "min.",
    "time_tracking_tags": "Tags",
    "title": "Settings",
    ...
    "word_lists_languages_to_include_in_export": "Languages to include when exporting",
    ...
    "word_lists_quick_add_lists": "Quick add word list(s):",
    "word_lists_readd_defaults": "Add the default folder",
    "word_lists_screensaver_auto_show": "Screensaver: Auto start screen saver",
  ...
  "TextScreen": {
    ...
    "tutorial_processed_text_text": "You can select parts of the text to look it up in the dictionary.",
  ...
  "TimeTrackingScreen": {
    ...
    "session_caps": "SESSION",
    "session_editor_break_time": "Break (min.):",
    "session_editor_break_time_must_be_shorter_than_session": "The break time must be shorter than the session time!",
    "session_editor_category": "Category",
    "session_editor_delete_message": "{CATEGORY} ({TIME} min.) session deleted",
    "session_editor_delete_undo": "Undo",
    "session_editor_edit_session": "Edit Session",
    "session_editor_end": "End",
    "session_editor_new_session": "New Session",
    "session_editor_no_sessions": "No sessions",
    "session_editor_save": "Save",
    "session_editor_selection_overlaps_with_session": "The time you set overlaps with another session!",
    "session_editor_session_start_is_after_end": "The end of the session is before the beginning of the session!",
    "session_editor_start": "Start",
    "session_editor_study_time": "Study Time: {STUDY_TIME}m",
    "session_editor_tag": "Tag",
    "session_editor_timeline": "Timeline",
    "start": "Start",
    "tags": "Tags",
    "title": "Time Tracking"
  },
  ...
  "WordListsScreen": {
    ...
    "export_csv_progress": "Creating CSV, please wait...",
    "export_images": "Export images",
    "export_images_progress": "Rendering images, please wait...",
    "export_pdf": "Export PDF",
    "export_pdf_progress": "Creating PDF, please wait...",
...
static const Map<String, Map<String,dynamic>> mapLocales = {"pol": _pol, "rus": _rus, "fra": _fra, "jpn": _jpn, "deu": _deu, "zho": _zho, "ita": _ita, "spa": _spa, "eng": _eng};
}