...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(firstSortOrder),const DeepCollectionEquality().hash(secondSortOrder),normalizeSearchConvertsRomajiToHiragana,const DeepCollectionEquality().hash(groupingRules),showSearchResultSeparationHeaders,showKanjiEntriesInSearchResults,showTags,showMetaEntries,definitionsMaxHeight,useKatakanaForFurigana,spellfixMaxResults,spellfixMaxCost,searchResultLimit);
