...
mixin _$TermBankV3Entry {
 ...
 int get termBankV3TableId; int get indexId; String get term; String get reading; List<String> get definitions; List<TagBankV3Entry> get definitionTags; List<String> get ruleIdentifiers; int get popularity; int get sequenceNumber; List<TagBankV3Entry> get tags;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TermBankV3Entry&&(identical(other.termBankV3TableId, termBankV3TableId) || other.termBankV3TableId == termBankV3TableId)&&(identical(other.indexId, indexId) || other.indexId == indexId)&&(identical(other.term, term) || other.term == term)&&(identical(other.reading, reading) || other.reading == reading)&&const DeepCollectionEquality().equals(other.definitions, definitions)&&const DeepCollectionEquality().equals(other.definitionTags, definitionTags)&&const DeepCollectionEquality().equals(other.ruleIdentifiers, ruleIdentifiers)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.sequenceNumber, sequenceNumber) || other.sequenceNumber == sequenceNumber)&&const DeepCollectionEquality().equals(other.tags, tags));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,termBankV3TableId,indexId,term,reading,const DeepCollectionEquality().hash(definitions),const DeepCollectionEquality().hash(definitionTags),const DeepCollectionEquality().hash(ruleIdentifiers),popularity,sequenceNumber,const DeepCollectionEquality().hash(tags));

@override
String toString() {
  return 'TermBankV3Entry(termBankV3TableId: $termBankV3TableId, indexId: $indexId, term: $term, reading: $reading, definitions: $definitions, definitionTags: $definitionTags, ruleIdentifiers: $ruleIdentifiers, popularity: $popularity, sequenceNumber: $sequenceNumber, tags: $tags)';
}
...
@useResult
$Res call({
 int termBankV3TableId, int indexId, String term, String reading, List<String> definitions, List<TagBankV3Entry> definitionTags, List<String> ruleIdentifiers, int popularity, int sequenceNumber, List<TagBankV3Entry> tags
});
...
/// Create a copy of TermBankV3Entry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? termBankV3TableId = null,Object? indexId = null,Object? term = null,Object? reading = null,Object? definitions = null,Object? definitionTags = null,Object? ruleIdentifiers = null,Object? popularity = null,Object? sequenceNumber = null,Object? tags = null,}) {
