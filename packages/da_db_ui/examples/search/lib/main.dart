...
import 'package:da_db_ui/da_db_ui.dart';
...
import 'package:da_db_ui/widgets/settings/search_profile_selector.dart';
import 'package:da_db_ui/widgets/settings/search_profile_settings_dialog.dart';
import 'package:da_db_ui_search_example/settings_localization.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  void dispose() {
    ...
    if (GetIt.I.isRegistered<DaDbSearchManager>()) {
      GetIt.I<DaDbSearchManager>().dispose();
    }
    super.dispose();
  }
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final searchManager = GetIt.I<DaDbSearchManager>();
